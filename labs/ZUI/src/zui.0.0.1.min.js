...
b.min)*a;return a=a.toFixed(2)};this.getValue=function(){return this.value};this.setValue=function(a){this.dragger.css("left",(a-this.min)/(this.max-this.min)*100+"%");this.value=a};this.setValue(this.value)};ZUI.Slider.UPDATE="ZUI_Slider_Update";ZUI.Slider.CHANGE="ZUI_Slider_Change";
