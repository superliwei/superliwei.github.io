...
q.outerHeight());p.outerHeight(a);r.outerHeight(a);u.outerHeight(a);s.outerHeight(a);m.outerHeight(a)}this.view=$(a);var c=this.view.find("#leftBox"),e=this.view.find("#centerBox"),d=this.view.find("#rightBox"),a=this.view.find(".vDivide"),f=a.eq(0),g=a.eq(1),h=f.find(".handle"),j=g.find(".handle"),i=322,k=320;h.click(function(){i=i==322?0:322;b()});j.click(function(){k=k==320?0:320;b()});c.css("position","absolute");c.css("overflow","auto");e.css("position","absolute");d.css("position","absolute");
this.view.find(".menu.tabular .item").tab();var l=this.view.find("#propertiesPanel .segment");l.css("overflow","auto");var q=this.view.find("#propertiesPanel #header"),p=this.view.find("#historyPanel .segment");p.css("padding",5);p.css("overflow","auto");var r=this.view.find("#dataSourcePanel .segment");r.css("padding",5);r.css("overflow","auto");var u=this.view.find("#terrainPanel .segment");u.css("overflow","auto");var s=this.view.find("#imageLayerPanel .segment");s.eq(0).css("padding",5);s.css("overflow",
...
function(){f.hasClass("red")&&e.get(0).play()};this.stopMusic=function(){e.get(0).pause();e.get(0).currentTime=0};a.children().eq(2).text("GlobalEditor "+GlobalEditor.Settings.version);var p='<div style="color:#999999;text-align: center;">'+Base64.decode("Qmxhbms=")+"</div>";p+='<div style="color:#999999;text-align: center;">'+Base64.decode("aGVyb2JsYW5rQGdtYWlsLmNvbQ==")+"</div>";$(p).appendTo(a)}(a.eq(2),d.eq(2))],g=-1;e.each(function(a){$(this).click(function(){c.selectTabIdx(a)})});this.view.modal({onHide:function(){f[2].stopMusic()}});
...
GlobalEditor.ColorPicker=function(a,b){var c=this;this.view=b;this.view.val(a);this.view.colorPicker({animationSpeed:0,renderCallback:function(a,b){var f;if(b==!0)a.val();else if(b==!1){if(c.onSubmit!=void 0)c.onSubmit(f)}else if(b==void 0&&(f=a.val(),c.onChange!=void 0))c.onChange(f)}});this.setColor=function(a){this.view.val(a);this.view.css("background-color",a)}};
...
GlobalEditor.EditDataSourceWin=function(a){function b(a){a=l.indexOf(a);h.eq(a).checkbox("set checked")}function c(a){a=q.indexOf(a);j.eq(a).checkbox("set checked");$.each([p,r,u],function(){this.hide()});a<q.length-1&&[p,r,u][a].show();a==2&&e();g.modal("refresh")}function e(){n==void 0&&(n=CodeMirror.fromTextArea(t.get(0),{mode:"javascript",lineNumbers:!0,textWrapping:!0,theme:"tomorrow-night-bright"}),n.on("change",function(){t.val(n.doc.getValue())}));n.doc.setValue(t.val())}function d(){k.removeClass("disabled");
s.val("");m.val("");o.val("");t.val("")}var f=this,g=$(a),a=g.find(".content .form").children(),h=a.eq(1).find(".ui.radio.checkbox").checkbox(),j=a.eq(2).find(".ui.radio.checkbox").checkbox(),i=g.find(".header label"),k=g.find(".actions button").eq(0),l=["CZML","GeoJSON","TopoJSON","KML","Custom"],q=["string","url","js","blank"],p=a.eq(3),r=a.eq(4),u=a.eq(5),s=a.eq(0).find("input"),m=p.find("textarea"),o=r.find("input"),t=u.find("textarea"),n;g.modal({onVisible:function(){n!=void 0&&n.refresh()}});
h.checkbox({onChange:function(){var a=$(this).data("class");b(a)}});j.checkbox({onChange:function(){var a=$(this).data("type");c(a)}});k.click(function(){k.addClass("disabled");var a={};a.name=s.val();a["class"]=h.closest(".checked").find("input").eq(0).data("class");a.type=j.closest(".checked").find("input").eq(0).data("type");var b=q.indexOf(a.type);b<q.length-1&&(a[a.type]=[m,o,t][b].val());f.handler.onSubmit(a);g.modal("hide")});this.openForNew=function(a){this.handler=a;i.text("\u6dfb\u52a0\u6570\u636e\u6e90");
b("CZML");c("string");d();g.modal("show")};this.openForEdit=function(a,f){this.handler=f;i.text("\u7f16\u8f91\u6570\u636e\u6e90 - "+a.name);b(a["class"]);c(a.type);d();s.val(a.name);var h=q.indexOf(a.type);h<q.length-1&&[m,o,t][h].val(a[a.type]);g.modal("show");h==2&&e()}};
