...
GlobalEditor.Clipboard.cut=function(){var a=GlobalEditor.leftPanel.getComponentContainer(),b=a.getSelectedItem();if(b!=null){var c=this.targets.concat(),e=[b],d=this.isCut,f=-1;GlobalEditor.HistoryManager.add("cut",function(){a.addItemAt(GlobalEditor.Clipboard.targets[0],f);GlobalEditor.Clipboard.targets=c;a.selectItem(e[0]);GlobalEditor.propertiesPanel.update();GlobalEditor.Clipboard.isCut=d},function(){GlobalEditor.Clipboard.targets=[b];f=a.getItems().indexOf(b);a.removeItem(b);a.selectItem(null);
GlobalEditor.propertiesPanel.update();GlobalEditor.Clipboard.isCut=!0})}};
GlobalEditor.Clipboard.paste=function(){var a=GlobalEditor.leftPanel.getComponentContainer(),b=a.getSelectedItem();if(this.targets.length>0&&this.isCut){var c=GlobalEditor.Clipboard.targets.concat(),e=[b];GlobalEditor.HistoryManager.add("paste",function(){a.removeItem(c[0]);a.selectItem(e[0]);GlobalEditor.propertiesPanel.update();GlobalEditor.Clipboard.targets=c;GlobalEditor.Clipboard.isCut=!0},function(){a.addItem(GlobalEditor.Clipboard.targets[0]);a.selectItem(GlobalEditor.Clipboard.targets[0]);
GlobalEditor.propertiesPanel.update();GlobalEditor.Clipboard.targets=[];GlobalEditor.Clipboard.isCut=!1})}else if(this.targets.length>0&&!this.isCut){var d=this.pasteUtil.getCurrentGps();if(d!=void 0){var f,e=[b];GlobalEditor.HistoryManager.add("paste",function(){a.removeItem(f);a.selectItem(e[0]);GlobalEditor.propertiesPanel.update()},function(){f==void 0&&(f=GlobalEditor.Clipboard.targets[0].clone(function(a){a.gps=d;return a}));a.addItem(f);a.selectItem(f);GlobalEditor.propertiesPanel.update()})}}};
...
GlobalEditor.MainLayout=function(a){function b(){c.outerWidth(i);d.outerWidth(k);var a=$(window).width()-i-k-f.outerWidth()-g.outerWidth();e.outerWidth(a);var b=$(window).height()-$("#topMenu").outerHeight();c.outerHeight(b);d.outerHeight(b);e.outerHeight(b);e.css("left",i+f.outerWidth());d.css("left",i+a+f.outerWidth()+g.outerWidth());f.outerHeight(b);g.outerHeight(b);f.css("left",i);g.css("left",i+a+f.outerWidth());$(document).trigger(GlobalEditor.MainLayout.Event.RESIZE);a=b-o-10;l.outerHeight(a-
p.outerHeight());q.outerHeight(a);r.outerHeight(a);u.outerHeight(a);s.outerHeight(a);m.outerHeight(a)}this.view=$(a);var c=this.view.find("#leftBox"),e=this.view.find("#centerBox"),d=this.view.find("#rightBox"),a=this.view.find(".vDivide"),f=a.eq(0),g=a.eq(1),h=f.find(".handle"),j=g.find(".handle"),i=322,k=320;h.click(function(){i=i==322?0:322;b()});j.click(function(){k=k==320?0:320;b()});c.css("position","absolute");c.css("overflow","auto");e.css("position","absolute");d.css("position","absolute");
this.view.find(".menu.tabular .item").tab();var l=this.view.find("#propertiesPanel .segment");l.css("overflow","auto");var p=this.view.find("#propertiesPanel #header"),q=this.view.find("#historyPanel .segment");q.css("padding",5);q.css("overflow","auto");var r=this.view.find("#dataSourcePanel .segment");r.css("padding",5);r.css("overflow","auto");var u=this.view.find("#terrainPanel .segment");u.css("overflow","auto");var s=this.view.find("#imageLayerPanel .segment");s.eq(0).css("padding",5);s.css("overflow",
"auto");var m=this.view.find("#cameraPanel .segment");m.css("overflow","auto");var o=this.view.find(".menu.tabular").outerHeight();$(window).resize(b);b();this.toggleLeft=function(){h.trigger("click")};this.toggleRight=function(){j.trigger("click")}};GlobalEditor.MainLayout.Event={RESIZE:"mainLayoutResizeEvent"};
...
break;case "\u5220\u9664\u6570\u636e\u6e90":GlobalEditor.KeyboardManager.execute("delDataSource");break;case "\u7f16\u8f91\u56fe\u5c42":GlobalEditor.KeyboardManager.execute("editImageLayer");break;case "\u5220\u9664\u56fe\u5c42":GlobalEditor.KeyboardManager.execute("delImageLayer");break;case "\u5173\u4e8eGlobalEditor":GlobalEditor.KeyboardManager.execute("about")}}var c=a.find("span.text").eq(0).text();a.find(".item").length==0&&a.click(b);var d=a.find("span.description").text();this.update=function(){var b=
!0;switch(c){case "\u64a4\u6d88":b=GlobalEditor.historyPanel.getUndoAble();break;case "\u91cd\u505a":b=GlobalEditor.historyPanel.getRedoAble();break;case "\u5220\u9664":b=GlobalEditor.leftPanel.getComponentContainer().getSelectedItem()!=null;break;case "\u590d\u5236":b=GlobalEditor.leftPanel.getComponentContainer().getSelectedItem()!=null;break;case "\u526a\u5207":b=GlobalEditor.leftPanel.getComponentContainer().getSelectedItem()!=null;break;case "\u7c98\u8d34":b=GlobalEditor.Clipboard.targets.length>
0;break;case "\u7f16\u8f91\u6570\u636e\u6e90":b=GlobalEditor.dataSourcePanel.getSelectedItem()!=null;break;case "\u5220\u9664\u6570\u636e\u6e90":b=GlobalEditor.dataSourcePanel.getSelectedItem()!=null;break;case "\u7f16\u8f91\u56fe\u5c42":b=GlobalEditor.imageLayerPanel.getSelectedItem()!=null;break;case "\u5220\u9664\u56fe\u5c42":b=GlobalEditor.imageLayerPanel.getSelectedItem()!=null;break;case "\u98de\u5230\u9009\u62e9\u7684\u76ee\u6807":b=GlobalEditor.editorContainer.viewer.selectedEntity!=null;
break;case "\u5c5e\u6027\u9762\u677f":b=GlobalEditor.topMenu.panelMenuController.getSelectedValue()!="properties";break;case "\u5386\u53f2\u8bb0\u5f55":b=GlobalEditor.topMenu.panelMenuController.getSelectedValue()!="history";break;case "\u6570\u636e\u6e90":a.find(".menu").length==0&&(b=GlobalEditor.topMenu.panelMenuController.getSelectedValue()!="dataSource");break;case "\u5730\u5f62":b=GlobalEditor.topMenu.panelMenuController.getSelectedValue()!="terrain";break;case "\u56fe\u5c42":a.find(".menu").length==
0&&(b=GlobalEditor.topMenu.panelMenuController.getSelectedValue()!="imageLayer");break;case "\u6444\u76f8\u673a":b=GlobalEditor.topMenu.panelMenuController.getSelectedValue()!="camera"}this.setEnabled(b)};this.setEnabled=function(b){b?a.removeClass("disabled"):a.addClass("disabled")}}this.view=$(a);a=this.view.find(".ui.dropdown:not(.right.menu .ui.dropdown)");a.dropdown({on:"hover",onShow:function(){b()}});var e=a.find(".item"),d=[];e.each(function(){d.push(new c($(this)))});this.panelMenuController=
new function(a){var b,c={properties:$("#propertiesPanel"),history:$("#historyPanel"),dataSource:$("#dataSourcePanel"),terrain:$("#terrainPanel"),imageLayer:$("#imageLayerPanel"),camera:$("#cameraPanel")};$.each(c,function(){$(this).css("display","none")});this.selectValue=function(b){a.dropdown("set selected",b)};this.getSelectedValue=function(){return b};this.getMenu=function(){return a};a.dropdown({onChange:function(a){b!=void 0&&c[b].css("display","none");b=a;c[b].css("display","block")}});this.selectValue("properties")}(this.view.find(".right.menu .ui.dropdown").eq(0));
...
GlobalEditor.DataSourcePanel=function(){var a=this,b=$("#dataSourcePanel");b.find(".ui.tab.segment .ui.menu .ui.dropdown").dropdown({onChange:function(b){switch(b){case "add":a.newItem();break;case "import":a.importItem()}}});var c=b.find(".ui.tab.segment .ui.menu").children().eq(1),e=b.find("#itemContainer"),d=[],f=null,g=!1;c.click(function(){a.setEditMode(!g)});this.newItem=function(){GlobalEditor.editDataSourceWin.openForNew({onSubmit:function(a){GlobalEditor.GeneralManager.addDataSource(a)}})};
this.importItem=function(){var a=["CZML","GeoJSON","TopoJSON","KML"],b=$.map(a,function(a){return a.toLowerCase()});GlobalEditor.File.browser(function(c){var d=c.name,e=d.split(".")[1].toLowerCase(),f=b.indexOf(e);f==-1?GlobalEditor.Alert.show("\u4e0d\u652f\u6301\u7684\u6587\u4ef6\u683c\u5f0f!"):GlobalEditor.File.readText(c,function(b){GlobalEditor.GeneralManager.addDataSource({name:d,"class":a[f],type:"string",string:b})})})};this.addItem=function(a){a.view.appendTo(e);d.push(a);g&&a.closeBt.show()};
this.addItemAt=function(a,b){b<=d.length-1?(a.view.insertBefore(d[b].view),d.splice(b,0,a),g&&a.closeBt.show()):this.addItem(a)};this.removeItem=function(a){var b=d.indexOf(a);d.splice(b,1);a.view.detach()};this.getSelectedItem=function(){return f};this.getItems=function(){return d};this.selectItem=function(a){f!=null&&f.setSelected(!1);f=a;f!=null&&f.setSelected(!0)};this.setEditMode=function(a){d.length==0&&a||($.each(d,function(){this.closeBt[a?"show":"hide"]()}),g=a)};this.editItem=function(a){GlobalEditor.editDataSourceWin.openForEdit(a.info,
{onSubmit:function(b){GlobalEditor.GeneralManager.updateDataSource(a,b)}})};this.editSelectedItem=function(){this.editItem(f)};this.delSelectedItem=function(){GlobalEditor.GeneralManager.removeDataSource(f)};this.getSettings=function(){var a={selectedIdx:-1,items:[]};a.selectedIdx=d.indexOf(f);$.each(d,function(){a.items.push(this.getSettings())});return a};this.setSettings=function(b){$.each(b.items,function(){var b=this.info,c=new GlobalEditor.DataSource(b),b=new GlobalEditor.DataSourceEditItem(b,
c);GlobalEditor.DataSourceManager.add(c);a.addItem(b);this.isActive||b.setActive(this.isActive)});b.selectedIdx>-1&&this.selectItem(d[b.selectedIdx])};this.clear=function(){for(;d.length>0;){var b=d[0];a.removeItem(b);GlobalEditor.DataSourceManager.remove(b.dataSource)}this.selectItem(null);g=null}};
...
function(){f.hasClass("red")&&e.get(0).play()};this.stopMusic=function(){e.get(0).pause();e.get(0).currentTime=0};a.children().eq(2).text("GlobalEditor "+GlobalEditor.Settings.version);a.children().eq(3).text("Cesium "+Cesium.VERSION);var q='<div style="color:#999999;text-align: center;">'+Base64.decode("Qmxhbms=")+"</div>";q+='<div style="color:#999999;text-align: center;">'+Base64.decode("aGVyb2JsYW5rQGdtYWlsLmNvbQ==")+"</div>";$(q).appendTo(a)}(a.eq(2),d.eq(2))],g=-1;e.each(function(a){$(this).click(function(){c.selectTabIdx(a)})});
this.view.modal({onHide:function(){f[2].stopMusic()}});this.show=function(a){f[0].initValues();this.selectTabIdx(a);this.view.modal("show")};this.selectTabIdx=function(a){g>-1&&(e.eq(g).removeClass("active blue"),f[g].setDisplay(!1));e.eq(a).addClass("active blue");g=a;f[a].setDisplay(!0);this.view.modal("refresh")}};
...
GlobalEditor.ColorPicker=function(a,b){var c=this;this.view=b;this.view.val(a);var e;this.view.colorPicker({animationSpeed:0,renderCallback:function(a,b){if(b==!0)e=a.val();else if(b==!1){if(c.onSubmit!=void 0)c.onSubmit(e)}else if(b==void 0&&(e=a.val(),c.onChange!=void 0))c.onChange(e)}});this.setColor=function(a){this.view.val(a);this.view.css("background-color",a)}};
...
GlobalEditor.EditDataSourceWin=function(a){function b(a){a=l.indexOf(a);h.eq(a).checkbox("set checked")}function c(a){a=p.indexOf(a);j.eq(a).checkbox("set checked");$.each([q,r,u],function(){this.hide()});a<p.length-1&&[q,r,u][a].show();a==2&&e();g.modal("refresh")}function e(){n==void 0&&(n=CodeMirror.fromTextArea(t.get(0),{mode:"javascript",lineNumbers:!0,textWrapping:!0,styleActiveLine:!0,matchBrackets:!0,theme:"tomorrow-night-bright"}),n.on("change",function(){t.val(n.doc.getValue())}));n.doc.setValue(t.val())}
function d(){k.removeClass("disabled");s.val("");m.val("");o.val("");t.val("")}var f=this,g=$(a),a=g.find(".content .form").children(),h=a.eq(1).find(".ui.radio.checkbox").checkbox(),j=a.eq(2).find(".ui.radio.checkbox").checkbox(),i=g.find(".header label"),k=g.find(".actions button").eq(0),l=["CZML","GeoJSON","TopoJSON","KML","Custom"],p=["string","url","js","blank"],q=a.eq(3),r=a.eq(4),u=a.eq(5),s=a.eq(0).find("input"),m=q.find("textarea"),o=r.find("input"),t=u.find("textarea"),n;g.modal({onVisible:function(){n!=
void 0&&n.refresh()}});h.checkbox({onChange:function(){var a=$(this).data("class");b(a)}});j.checkbox({onChange:function(){var a=$(this).data("type");c(a)}});k.click(function(){k.addClass("disabled");var a={};a.name=s.val();a["class"]=h.closest(".checked").find("input").eq(0).data("class");a.type=j.closest(".checked").find("input").eq(0).data("type");var b=p.indexOf(a.type);b<p.length-1&&(a[a.type]=[m,o,t][b].val());f.handler.onSubmit(a);g.modal("hide")});this.openForNew=function(a){this.handler=
a;i.text("\u6dfb\u52a0\u6570\u636e\u6e90");b("CZML");c("string");d();g.modal("show")};this.openForEdit=function(a,f){this.handler=f;i.text("\u7f16\u8f91\u6570\u636e\u6e90 - "+a.name);b(a["class"]);c(a.type);d();s.val(a.name);var h=p.indexOf(a.type);h<p.length-1&&[m,o,t][h].val(a[a.type]);g.modal("show");h==2&&e()}};
...
GlobalEditor.EditImageLayerWin=function(a){function b(){i==void 0&&(i=CodeMirror.fromTextArea(j.get(0),{mode:"javascript",lineNumbers:!0,textWrapping:!0,styleActiveLine:!0,matchBrackets:!0,theme:"tomorrow-night-bright"}),d.modal("refresh"),i.on("change",function(){j.val(i.doc.getValue())}));i.doc.setValue(j.val())}function c(){g.removeClass("disabled");h.val("");j.val("")}var e=this,d=$(a),f=d.find(".header label"),g=d.find(".actions button").eq(0),h=d.find("input"),j=d.find("textarea"),i;d.modal({onVisible:function(){i!=
void 0&&i.refresh()}});g.click(function(){g.addClass("disabled");var a={};a.name=h.val();a.js=j.val();e.handler.onSubmit(a);d.modal("hide")});this.openForNew=function(a){this.handler=a;f.text("\u6dfb\u52a0\u56fe\u5c42");c();d.modal("show");b()};this.openForEdit=function(a,e){this.handler=e;f.text("\u7f16\u8f91\u56fe\u5c42 - "+a.name);c();h.val(a.name);j.val(a.js);d.modal("show");b()}};
...
k=a.children().eq(4),n=new e(g,d.lineCount),l=new e(i,d.lineThickness),v=new e(k,d.lineOffset);n.onChange=function(a){d.lineCount=a};l.onChange=function(a){d.lineThickness=a};v.onChange=function(a){d.lineOffset=a};this.reset=function(){d.color=b.color;d.cellAlpha=b.cellAlpha;d.lineCount=b.lineCount;d.lineThickness=b.lineThickness;d.lineOffset=b.lineOffset;h.setColor(d.color);j.setValue(d.cellAlpha);n.setPosition(d.lineCount);l.setPosition(d.lineThickness);v.setPosition(d.lineOffset)};this.setValue=
function(a){a=this.encode(a);c(d,a);h.setColor(d.color);j.setValue(d.cellAlpha);n.setPosition(d.lineCount);l.setPosition(d.lineThickness);v.setPosition(d.lineOffset)};this.getValue=function(){return this.decode(d)};this.show=function(){a.show()};this.encode=function(a){return{className:f[2],color:a.color==void 0?b.color:GlobalEditor.CesiumUtil.getPropertyValue(a.color).toCssColorString(),cellAlpha:a.cellAlpha==void 0?b.cellAlpha:GlobalEditor.CesiumUtil.getPropertyValue(a.cellAlpha),lineCount:a.lineCount==
...
d=Cesium.Math.toDegrees(d.latitude),o={lat:d,lng:c},m.position=b,m.show=!0,m.label.text=c.toFixed(2)+","+d.toFixed(2),m.label.pixelOffset=new Cesium.Cartesian2(0,g.outerHeight()*0.5+12),g.css("opacity",0.5)):(m.show=!1,g.css("opacity",1),o=void 0)}function f(){g!=void 0&&g.remove();i.entities.remove(m);$(document).unbind("mousemove",a);$(document).unbind("mouseup",f);if(o!=void 0)d.onSnapshotDrop({type:b,item:l,itemInfo:c,gps:o})}e(l);$(document).bind("mousemove",a);$(document).bind("mouseup",f);
var g,i=GlobalEditor.editorContainer.viewer,k=i.scene,m=i.entities.add({label:{font:"24px sans-serif",style:Cesium.LabelStyle.FILL_AND_OUTLINE,fillColor:Cesium.Color.YELLOW,outlineColor:Cesium.Color.BLACK,outlineWidth:2},point:{color:Cesium.Color.WHITE,pixelSize:5,outlineWidth:2},show:!1}),o});this.onItemCreate(b,c,l);return l};this.getImageUrlForItem=function(a){return a};this.getItemOption=function(){};this.onItemCreate=function(){};this.onItemsCreateComplete=function(){};this.detach=function(){this.classDropdown.detach();
...
GlobalEditor.BasicDescriptor=function(a){this.dataModels=[a];this.init=function(a){a.header.text(this.title);var c=a.form;this.container=c;$.each(this.dataModels,function(){this.createTo(c)})};this.update=function(){this.container!=void 0&&$.each(this.dataModels,function(){this.update()})}};
GlobalEditor.ViewerDescriptor=function(){this.title="\u89c6\u56fe";var a=new GlobalEditor.DescriptorDataModel(this);a.add({type:"slider",label:"\u89e3\u6790\u5ea6",name:"resolutionScale",min:0.01,max:1});a.add({type:"checkBox",label:"\u9634\u5f71",name:"shadows"});a.add({type:"dropdown",label:"\u5730\u5f62\u9634\u5f71",name:"terrainShadows",data:[{value:Cesium.ShadowMode.CAST_ONLY,label:"CAST_ONLY"},{value:Cesium.ShadowMode.DISABLED,label:"DISABLED"},{value:Cesium.ShadowMode.ENABLED,label:"ENABLED"},
{value:Cesium.ShadowMode.RECEIVE_ONLY,label:"RECEIVE_ONLY"}]});a.add({type:"header",label:"\u573a\u666f"});a.add({type:"checkBox",label:"\u5149\u7167",name:"enableLighting"});a.add({type:"checkBox",label:"\u96fe",name:"enableFog"});a.add({type:"checkBox",label:"\u6297\u5267\u9f7f",name:"fxaa"});a.add({type:"header",label:"\u5929\u7a7a\u76d2"});a.add({type:"checkBox",label:"\u663e\u793a",name:"showSkyBox"});a.add({type:"header",label:"\u5927\u6c14\u5c42"});var b=GlobalEditor.editorContainer.viewer,
c=new GlobalEditor.SkyAtmosphereDataModel(new GlobalEditor.SkyAtmosphereDelegate(b.scene.skyAtmosphere));c.name="skyAtmosphere";a.add(c);GlobalEditor.BasicDescriptor.call(this,a);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,b,"resolutionScale");GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,b,"shadows");GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,b,"terrainShadows",void 0,GlobalEditor.DescriptorDataModelHandle.numberValue);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,
b.scene,"fxaa");GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,b.scene.globe,"enableLighting");this.getEnableFog=function(){return GlobalEditor.editorContainer.viewer.scene.fog.enabled};this.setEnableFog=function(a){GlobalEditor.editorContainer.viewer.scene.fog.enabled=a};this.getShowSkyBox=function(){return GlobalEditor.editorContainer.viewer.scene.skyBox.show};this.setShowSkyBox=function(a){GlobalEditor.editorContainer.viewer.scene.skyBox.show=a};this.getSettings=function(){return a.getSettings()};
this.setSettings=function(b){a.setSettings(b)};this.clear=function(){a.setSettings(this.defaultSettings)};this.defaultSettings=this.getSettings()};
...
GlobalEditor.EntityDescriptor=function(a){this.title="Entity";this.delegate=new GlobalEditor.EntityDelegate(a);this.dataModel=new GlobalEditor.EntityDataModel(this.delegate);GlobalEditor.BasicDescriptor.call(this,this.dataModel)};GlobalEditor.DescriptorDataModel=function(a){var b=this;this.delegate=a;this.items=[];this.itemControllers=[];this.add=function(a){this.items.push(a)};this.remove=function(a){a=this.items.indexOf(a);a>-1&&(this.items.splice(a,1),this.itemControllers.splice(a,1))};this.createTo=function(a){function e(d){if(d!=b.items.length){var f=b.items[d];b.isDataModel(f)?(f.createTo(a),b.itemControllers.push(f.itemControllers)):(f=GlobalEditor.DescItemMap.create(f,b,a),b.itemControllers.push(f));d++;e(d)}}if(this.items.length!=
0)this.itemControllers=[],e(0)};this.getAndSetFuncForName=function(a){var a=GlobalEditor.DescriptorDataModel.getFuncName(a),e=this.delegate[a.getStr],d=this.delegate[a.setStr];return[e!=void 0?function(){return e.call(b.delegate)}:void 0,d!=void 0?function(a){d.call(b.delegate,a)}:void 0]};this.update=function(){function a(b){for(var d=0;d<b.length;d++){var f=b[d];f instanceof Array?a(f):f.update!=void 0&&f.update()}}a(this.itemControllers)};this.isDataModel=function(a){return a.type==void 0&&a.createTo!=
void 0};this.getSettings=function(){function a(d){if(d!=b.items.length){var f=b.items[d];if(b.isDataModel(f))e[f.name]=f.getSettings();else if(f.name!=void 0){var g=b.getAndSetFuncForName(f.name)[0];e[f.name]=g()}d++;a(d)}}var e={};a(0);return e=this.encodeSettings(e)};this.setSettings=function(a){a=this.decodeSettings(a);for(key in a){var b=this.getAndSetFuncForName(key)[1];b!=void 0?a[key]!=void 0&&b(a[key]):(b=this.getSubDataModelByName(key),b!=void 0&&b.setSettings(a[key]))}};this.encodeSettings=
function(a){var b={};for(key in a){var d=a[key];if(typeof d=="object")if(this.getAndSetFuncForName(key)[1]!=void 0)b[key]=GlobalEditor.DescriptorDataModel.Encoder.encode(d);else{var f=this.getSubDataModelByName(key);f!=void 0&&(b[key]=f.encodeSettings(d))}else b[key]=d}return b};this.decodeSettings=function(a){var b={};for(key in a){var d=a[key];if(typeof d=="object")if(this.getAndSetFuncForName(key)[1]!=void 0)b[key]=GlobalEditor.DescriptorDataModel.Encoder.decode(d);else{var f=this.getSubDataModelByName(key);
f!=void 0&&(b[key]=f.decodeSettings(d))}else b[key]=d}return b};this.getSubDataModelByName=function(a){for(var b=this.items.length,d=0;d<b;d++){var f=this.items[d];if(this.isDataModel(f)&&f.name==a)return f}}};
...
label:"alignedAxis",name:"alignedAxis"});this.add({type:"size",name:"size"});this.add({type:"color",label:"\u989c\u8272",name:"color"});this.add({type:"input",label:"scale By Distance",name:"scaleByDistance"});this.add({type:"input",label:"translucency By Distance",name:"translucencyByDistance"});this.add({type:"input",label:"pixelOffset Scale By Distance",name:"pixelOffsetScaleByDistance"});this.add({type:"checkBox",label:"sizeInMeters",name:"sizeInMeters"});this.add({type:"dropdown",label:"height Reference",
name:"heightReference",data:[{label:"CLAMP_TO_GROUND",value:Cesium.HeightReference.CLAMP_TO_GROUND},{label:"NONE",value:Cesium.HeightReference.NONE},{label:"RELATIVE_TO_GROUND",value:Cesium.HeightReference.RELATIVE_TO_GROUND}]})};
...
GlobalEditor.DescriptorDataModelHandle.cesiumNearFarScalarValue);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"sizeInMeters",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,void 0,!1);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"heightReference",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,Cesium.HeightReference.NONE)};
...
label:"outlineWidth"});this.add({type:"dropdown",label:"\u9634\u5f71",name:"shadows",data:[{value:Cesium.ShadowMode.CAST_ONLY,label:"CAST_ONLY"},{value:Cesium.ShadowMode.DISABLED,label:"DISABLED"},{value:Cesium.ShadowMode.ENABLED,label:"ENABLED"},{value:Cesium.ShadowMode.RECEIVE_ONLY,label:"RECEIVE_ONLY"}]})};
...
1);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"shadows",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,Cesium.ShadowMode.DISABLED)};
GlobalEditor.CorridorDataModel=function(a){GlobalEditor.DescriptorDataModel.call(this,a);this.add({type:"textArea",name:"positions",label:"positions"});this.add({type:"input",name:"width",label:"\u5bbd"});this.add({type:"dropdown",name:"cornerType",label:"cornerType",data:[{label:"ROUNDED",value:Cesium.CornerType.ROUNDED},{label:"BEVELED",value:Cesium.CornerType.BEVELED},{label:"MITERED",value:Cesium.CornerType.MITERED}]});this.add({type:"input",name:"height",label:"\u9ad8"});this.add({type:"input",
name:"extrudedHeight",label:"extruded height"});this.add({type:"checkBox",name:"show",label:"\u663e\u793a"});this.add({type:"checkBox",name:"fill",label:"\u586b\u5145"});this.add({type:"cesiumMaterial",name:"material",label:"\u6750\u8d28"});this.add({type:"checkBox",name:"outline",label:"outline"});this.add({type:"color",name:"outlineColor",label:"outlineColor"});this.add({type:"input",name:"outlineWidth",label:"outlineWidth"});this.add({type:"input",name:"granularity",label:"granularity"});this.add({type:"dropdown",
label:"\u9634\u5f71",name:"shadows",data:[{value:Cesium.ShadowMode.CAST_ONLY,label:"CAST_ONLY"},{value:Cesium.ShadowMode.DISABLED,label:"DISABLED"},{value:Cesium.ShadowMode.ENABLED,label:"ENABLED"},{value:Cesium.ShadowMode.RECEIVE_ONLY,label:"RECEIVE_ONLY"}]})};
...
Cesium.Color.BLACK);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"outlineWidth",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,1);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"granularity",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,Cesium.Math.RADIANS_PER_DEGREE);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"shadows",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,
GlobalEditor.DescriptorDataModelHandle.numberValue,Cesium.ShadowMode.DISABLED)};
...
label:"outline"});this.add({type:"color",name:"outlineColor",label:"outlineColor"});this.add({type:"input",name:"outlineWidth",label:"outlineWidth"});this.add({type:"input",name:"numberOfVerticalLines",label:"number Of VerticalLines"});this.add({type:"input",name:"slices",label:"slices"});this.add({type:"dropdown",label:"\u9634\u5f71",name:"shadows",data:[{value:Cesium.ShadowMode.CAST_ONLY,label:"CAST_ONLY"},{value:Cesium.ShadowMode.DISABLED,label:"DISABLED"},{value:Cesium.ShadowMode.ENABLED,label:"ENABLED"},
{value:Cesium.ShadowMode.RECEIVE_ONLY,label:"RECEIVE_ONLY"}]})};
...
GlobalEditor.DescriptorDataModelHandle.numberValue,16);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"slices",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,128);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"shadows",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,Cesium.ShadowMode.DISABLED)};
...
label:"granularity"});this.add({type:"dropdown",label:"\u9634\u5f71",name:"shadows",data:[{value:Cesium.ShadowMode.CAST_ONLY,label:"CAST_ONLY"},{value:Cesium.ShadowMode.DISABLED,label:"DISABLED"},{value:Cesium.ShadowMode.ENABLED,label:"ENABLED"},{value:Cesium.ShadowMode.RECEIVE_ONLY,label:"RECEIVE_ONLY"}]})};
...
a,"stRotation",GlobalEditor.DescriptorDataModelHandle.cesiumDegress,GlobalEditor.DescriptorDataModelHandle.cesiumRadiansValue,0);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"granularity",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,Cesium.Math.RADIANS_PER_DEGREE);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"shadows",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,
...
label:"outlineWidth"});this.add({type:"input",name:"subdivisions",label:"subdivisions"});this.add({type:"input",name:"stackPartitions",label:"stack Partitions"});this.add({type:"input",name:"slicePartitions",label:"slice Partitions"});this.add({type:"dropdown",label:"\u9634\u5f71",name:"shadows",data:[{value:Cesium.ShadowMode.CAST_ONLY,label:"CAST_ONLY"},{value:Cesium.ShadowMode.DISABLED,label:"DISABLED"},{value:Cesium.ShadowMode.ENABLED,label:"ENABLED"},{value:Cesium.ShadowMode.RECEIVE_ONLY,label:"RECEIVE_ONLY"}]})};
...
GlobalEditor.DescriptorDataModelHandle.numberValue,64);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"shadows",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,Cesium.ShadowMode.DISABLED)};
...
name:"pixelOffsetScaleByDistance"});this.add({type:"dropdown",label:"height Reference",name:"heightReference",data:[{label:"CLAMP_TO_GROUND",value:Cesium.HeightReference.CLAMP_TO_GROUND},{label:"NONE",value:Cesium.HeightReference.NONE},{label:"RELATIVE_TO_GROUND",value:Cesium.HeightReference.RELATIVE_TO_GROUND}]})};
...
GlobalEditor.DescriptorDataModelHandle.cesiumNearFarScalarValue);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"heightReference",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,Cesium.HeightReference.NONE)};
...
name:"incrementallyLoadTextures"});this.add({type:"dropdown",label:"\u9634\u5f71",name:"shadows",data:[{value:Cesium.ShadowMode.CAST_ONLY,label:"CAST_ONLY"},{value:Cesium.ShadowMode.DISABLED,label:"DISABLED"},{value:Cesium.ShadowMode.ENABLED,label:"ENABLED"},{value:Cesium.ShadowMode.RECEIVE_ONLY,label:"RECEIVE_ONLY"}]});this.add({type:"checkBox",label:"\u64ad\u653e\u52a8\u753b",name:"runAnimations"});this.add({type:"dropdown",label:"height Reference",name:"heightReference",data:[{label:"CLAMP_TO_GROUND",
value:Cesium.HeightReference.CLAMP_TO_GROUND},{label:"NONE",value:Cesium.HeightReference.NONE},{label:"RELATIVE_TO_GROUND",value:Cesium.HeightReference.RELATIVE_TO_GROUND}]})};
...
a,"shadows",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,void 0,Cesium.ShadowMode.ENABLED);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"runAnimations",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,void 0,!0);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"heightReference",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,Cesium.HeightReference.NONE)};
...
name:"translucencyByDistance"});this.add({type:"dropdown",label:"height Reference",name:"heightReference",data:[{label:"CLAMP_TO_GROUND",value:Cesium.HeightReference.CLAMP_TO_GROUND},{label:"NONE",value:Cesium.HeightReference.NONE},{label:"RELATIVE_TO_GROUND",value:Cesium.HeightReference.RELATIVE_TO_GROUND}]})};
...
a,"scaleByDistance",GlobalEditor.DescriptorDataModelHandle.cesiumNearFarScalarString,GlobalEditor.DescriptorDataModelHandle.cesiumNearFarScalarValue);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"translucencyByDistance",GlobalEditor.DescriptorDataModelHandle.cesiumNearFarScalarString,GlobalEditor.DescriptorDataModelHandle.cesiumNearFarScalarValue);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"heightReference",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,
GlobalEditor.DescriptorDataModelHandle.numberValue,Cesium.HeightReference.NONE)};
...
this.add({type:"dropdown",label:"\u9634\u5f71",name:"shadows",data:[{value:Cesium.ShadowMode.CAST_ONLY,label:"CAST_ONLY"},{value:Cesium.ShadowMode.DISABLED,label:"DISABLED"},{value:Cesium.ShadowMode.ENABLED,label:"ENABLED"},{value:Cesium.ShadowMode.RECEIVE_ONLY,label:"RECEIVE_ONLY"}]})};
...
GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"closeTop",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,void 0,!0);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"closeBottom",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,void 0,!0);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"shadows",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,Cesium.ShadowMode.DISABLED)};
GlobalEditor.PolylineDataModel=function(a){GlobalEditor.DescriptorDataModel.call(this,a);this.add({type:"textArea",name:"positions",label:"positions"});this.add({type:"checkBox",name:"followSurface",label:"follow Surface"});this.add({type:"input",name:"width",label:"\u5bbd"});this.add({type:"checkBox",name:"show",label:"\u663e\u793a"});this.add({type:"cesiumMaterial",name:"material",label:"\u6750\u8d28"});this.add({type:"input",name:"granularity",label:"granularity"});this.add({type:"dropdown",label:"\u9634\u5f71",
name:"shadows",data:[{value:Cesium.ShadowMode.CAST_ONLY,label:"CAST_ONLY"},{value:Cesium.ShadowMode.DISABLED,label:"DISABLED"},{value:Cesium.ShadowMode.ENABLED,label:"ENABLED"},{value:Cesium.ShadowMode.RECEIVE_ONLY,label:"RECEIVE_ONLY"}]})};
...
GlobalEditor.DescriptorDataModelHandle.numberValue,1);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"show",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,void 0,!0);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"material");GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"granularity",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,Cesium.Math.RADIANS_PER_DEGREE);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,
a,"shadows",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,Cesium.ShadowMode.DISABLED)};
...
name:"fill",label:"\u586b\u5145"});this.add({type:"cesiumMaterial",name:"material",label:"\u6750\u8d28"});this.add({type:"checkBox",name:"outline",label:"outline"});this.add({type:"color",name:"outlineColor",label:"outlineColor"});this.add({type:"input",name:"outlineWidth",label:"outlineWidth"});this.add({type:"input",name:"granularity",label:"granularity"});this.add({type:"dropdown",label:"\u9634\u5f71",name:"shadows",data:[{value:Cesium.ShadowMode.CAST_ONLY,label:"CAST_ONLY"},{value:Cesium.ShadowMode.DISABLED,
label:"DISABLED"},{value:Cesium.ShadowMode.ENABLED,label:"ENABLED"},{value:Cesium.ShadowMode.RECEIVE_ONLY,label:"RECEIVE_ONLY"}]})};
...
a,"granularity",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,Cesium.Math.RADIANS_PER_DEGREE);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"shadows",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,Cesium.ShadowMode.DISABLED)};
...
GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"granularity",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,Cesium.Math.RADIANS_PER_DEGREE);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"shadows",GlobalEditor.DescriptorDataModelHandle.cesiumProperty,GlobalEditor.DescriptorDataModelHandle.numberValue,Cesium.ShadowMode.DISABLED)};
...
name:"outline",label:"outline"});this.add({type:"color",name:"outlineColor",label:"outlineColor"});this.add({type:"input",name:"outlineWidth",label:"outlineWidth"});this.add({type:"input",name:"granularity",label:"granularity"});this.add({type:"dropdown",label:"\u9634\u5f71",name:"shadows",data:[{value:Cesium.ShadowMode.CAST_ONLY,label:"CAST_ONLY"},{value:Cesium.ShadowMode.DISABLED,label:"DISABLED"},{value:Cesium.ShadowMode.ENABLED,label:"ENABLED"},{value:Cesium.ShadowMode.RECEIVE_ONLY,label:"RECEIVE_ONLY"}]})};
...
GlobalEditor.EntityDelegate=function(a){this.entity=a;GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"id");GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"name");GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"show");GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"description",GlobalEditor.DescriptorDataModelHandle.cesiumProperty);this.getPosition=function(){var b=GlobalEditor.CesiumUtil.getPropertyValue(a.position);return Cesium.Cartographic.fromCartesian(b)};
this.setPosition=function(b){a.position=Cesium.Cartesian3.fromRadians(b.longitude,b.latitude,b.height)};this.orientationConfig={heading:0,pitch:0,roll:0};this.getOrientation=function(){return this.orientationConfig};this.setOrientation=function(b){this.orientationConfig=b;var c=GlobalEditor.CesiumUtil.getPropertyValue(a.position),e=Cesium.Math.toRadians(b.heading),d=Cesium.Math.toRadians(b.pitch),b=Cesium.Math.toRadians(b.roll);a.orientation=Cesium.Transforms.headingPitchRollQuaternion(c,e,d,b)}};
...
GlobalEditor.DescItemMap.checkBox=function(a,b,c){var e=GlobalEditor.FormViewManager.createCheckBoxView(a.label);e.appendTo(c);var b=b.getAndSetFuncForName(a.name),d=b[0],f=b[1],g=e.find(".ui.checkbox").eq(0);g.checkbox(d()?"set checked":"set unchecked");a.checkBox=g;g.checkbox({onChange:function(){var b=d(),c=g.checkbox("is checked");GlobalEditor.HistoryManager.addEditAction("edit",b,c,function(b){f(b);a.checkBox.checkbox(b?"set checked":"set unchecked")})}});this.view=e;this.checkBox=g};
GlobalEditor.DescItemMap.color=function(a,b,c){var e=GlobalEditor.FormViewManager.createColorPickerView(a.label);e.appendTo(c);var b=b.getAndSetFuncForName(a.name),d=b[1],f=(0,b[0])(),b=new GlobalEditor.ColorPicker(f,e.find(".colorPicker"));a.colorPicker=b;b.onChange=function(a){d(a)};b.onSubmit=function(b){f!=b&&GlobalEditor.HistoryManager.addEditAction("edit",f,b,function(b){a.colorPicker.setColor(b);d(b);f=b})};this.view=e;this.colorPicker=b};
GlobalEditor.DescItemMap.dropdown=function(a,b,c){var e=new GlobalEditor.Dropdown(a.label,a.data);e.view.appendTo(c);var b=b.getAndSetFuncForName(a.name),d=b[0],f=b[1];e.setValue(d());a.dropdown=e;e.onChange=function(b){var c=d();GlobalEditor.HistoryManager.addEditAction("edit",c,b,function(b){f(b);a.dropdown.setValue(b)})}};GlobalEditor.DescItemMap.header=function(a,b,c){GlobalEditor.FormViewManager.createHeader(a.label).appendTo(c)};GlobalEditor.DescItemMap.hline=function(a,b,c){GlobalEditor.FormViewManager.createHline().appendTo(c)};
GlobalEditor.DescItemMap.html=function(a,b,c){$(a.html).appendTo(c)};
GlobalEditor.DescItemMap.input=function(a,b,c){var e=a.rightLabel==void 0?GlobalEditor.FormViewManager.createTextInputView(a.label):GlobalEditor.FormViewManager.createTextInputWithRightLabelView(a.label,a.rightLabel);e.appendTo(c);var b=b.getAndSetFuncForName(a.name),d=b[0],f=b[1],g=e.find("input").eq(0);g.val(d());a.input=g;g.change(function(){var b=d(),c=g.val();GlobalEditor.HistoryManager.addEditAction("edit",b,c,function(b){f(b);a.input.val(b)})});this.view=e;this.input=g};
GlobalEditor.DescItemMap.position=function(a,b,c){var e=GlobalEditor.FormViewManager.createPositionView();e.appendTo(c);var b=b.getAndSetFuncForName(a.name),d=b[0],f=b[1],e=e.find("input"),g=e.eq(0),h=e.eq(1),e=d();g.val(e.x);h.val(e.y);a.xInput=g;a.yInput=h;g.change(function(){var b=d(),c=d();c.x=Number(g.val());GlobalEditor.HistoryManager.addEditAction("edit",b,c,function(b){f(b);a.xInput.val(b.x)})});h.change(function(){var b=d(),c=d();c.y=Number(h.val());GlobalEditor.HistoryManager.addEditAction("edit",
b,c,function(b){f(b);a.yInput.val(b.y)})});this.update=function(){var a=d();g.val(a.x);h.val(a.y)}};
GlobalEditor.DescItemMap.size=function(a,b,c){var e=GlobalEditor.FormViewManager.createSizeView();e.appendTo(c);var b=b.getAndSetFuncForName(a.name),d=b[0],f=b[1],b=e.find("input"),g=b.eq(0),h=b.eq(1),c=d();g.val(c.width);h.val(c.height);a.wInput=g;a.hInput=h;$.each([g,h],function(){this.change(function(){var b=d(),c=Number(g.val()),e=Number(h.val());GlobalEditor.HistoryManager.addEditAction("edit",b,{width:c,height:e},function(b){f(b);a.wInput.val(b.width);a.hInput.val(b.height)})})});this.update=
function(){var a=d();g.val(a.width);h.val(a.height)};this.view=e;this.inputs=b};GlobalEditor.DescItemMap.slider=function(a,b,c){var e=GlobalEditor.FormViewManager.createSliderView(a.label);e.appendTo(c);var c=b.getAndSetFuncForName(a.name),b=c[0],d=c[1],e=new GlobalEditor.Slider(e,a.min,a.max,b());a.slider=e;var f=b();e.onUpdate=function(a){d(a)};e.onChange=function(b){GlobalEditor.HistoryManager.addEditAction("edit",f,b,function(b){a.slider.setValue(b);d(b);f=b})}};
GlobalEditor.DescItemMap.tabs=function(a,b,c){var e=GlobalEditor.FormViewManager.createButtonGroupView(a.label,a.items);e.appendTo(c);var b=b.getAndSetFuncForName(a.name),d=b[0],f=b[1],e=new GlobalEditor.ButtonGroupSwitcher(e,d());a.switcher=e;e.onChange=function(b){var c=d();GlobalEditor.HistoryManager.addEditAction("edit",c,b,function(b){f(b);a.switcher.setValue(b)})}};
GlobalEditor.DescItemMap.textArea=function(a,b,c){var e=GlobalEditor.FormViewManager.createTextAreaView(a.label);e.appendTo(c);var b=b.getAndSetFuncForName(a.name),d=b[0],f=b[1],g=e.find("textarea").eq(0);g.val(d());a.textArea=g;g.change(function(){var b=d(),c=g.val();GlobalEditor.HistoryManager.addEditAction("edit",b,c,function(b){f(b);a.textArea.val(b)})});this.view=e;this.textArea=g};
GlobalEditor.DescItemMap.cesiumCartesian3=function(a,b,c){var e=GlobalEditor.FormViewManager.createCesiumCartesian3View(a.label);e.appendTo(c);var b=b.getAndSetFuncForName(a.name),d=b[0],f=b[1],e=e.find("input"),g=e.eq(0),h=e.eq(1),j=e.eq(2),e=d();g.val(e.x);h.val(e.y);j.val(e.z);a.xInput=g;a.yInput=h;a.zInput=j;$.each([g,h,j],function(){this.change(function(){var b=d(),c=Number(g.val()),e=Number(h.val()),p=Number(j.val()),c=new Cesium.Cartesian3(c,e,p);GlobalEditor.HistoryManager.addEditAction("edit",
b,c,function(b){f(b);a.xInput.val(b.x);a.yInput.val(b.y);a.zInput.val(b.z)})})});this.update=function(){var a=d();g.val(a.x);h.val(a.y);j.val(a.z)}};
GlobalEditor.DescItemMap.cesiumCartesian2=function(a,b,c){var e=GlobalEditor.FormViewManager.createCesiumCartesian2View(a.label);e.appendTo(c);var b=b.getAndSetFuncForName(a.name),d=b[0],f=b[1],e=e.find("input"),g=e.eq(0),h=e.eq(1),e=d();g.val(e.x);h.val(e.y);a.xInput=g;a.yInput=h;$.each([g,h],function(){this.change(function(){var b=d(),c=Number(g.val()),e=Number(h.val()),c=new Cesium.Cartesian2(c,e);GlobalEditor.HistoryManager.addEditAction("edit",b,c,function(b){f(b);a.xInput.val(b.x);a.yInput.val(b.y)})})})};
GlobalEditor.DescItemMap.cesiumCartographic=function(a,b,c){var e=GlobalEditor.FormViewManager.createCesiumCartesian3View(a.label);e.appendTo(c);var d=e.find("label");$.each(["lng","lat","\u9ad8"],function(a){d.eq(a+1).text(this)});var b=b.getAndSetFuncForName(a.name),f=b[0],g=b[1],e=e.find("input"),h=e.eq(0),j=e.eq(1),i=e.eq(2),c=f(),e=Cesium.Math.toDegrees(c.longitude),b=Cesium.Math.toDegrees(c.latitude),c=c.height;j.val(b);h.val(e);i.val(c);a.latInput=j;a.lngInput=h;a.hInput=i;$.each([j,h,i],function(){this.change(function(){var b=
f(),c=Number(h.val()),d=Number(j.val()),e=Number(i.val()),c=Cesium.Cartographic.fromDegrees(c,d,e);GlobalEditor.HistoryManager.addEditAction("edit",b,c,function(b){g(b);var c=Cesium.Math.toDegrees(b.longitude),d=Cesium.Math.toDegrees(b.latitude),b=b.height;a.latInput.val(d);a.lngInput.val(c);a.hInput.val(b)})})});this.update=function(){var a=f(),b=Cesium.Math.toDegrees(a.longitude),c=Cesium.Math.toDegrees(a.latitude),a=a.height;j.val(c);h.val(b);i.val(a)}};
GlobalEditor.DescItemMap.cesiumOrientation=function(a,b,c){var e=GlobalEditor.FormViewManager.createCesiumOrientationView(a.label);e.appendTo(c);var b=b.getAndSetFuncForName(a.name),d=b[1],f=(0,b[0])(),c=e.find(".eleven.wide").children(),g=["heading","pitch","roll"],e=new GlobalEditor.Slider(c.eq(0),-360,360,f[g[0]]),b=new GlobalEditor.Slider(c.eq(1),-360,360,f[g[1]]),c=new GlobalEditor.Slider(c.eq(2),-360,360,f[g[2]]);a.hSlider=e;a.pSlider=b;a.rSlider=c;$.each([e,b,c],function(b){this.onUpdate=function(a){var c=
GlobalEditor.ObjectUtil.clone(f);c[g[b]]=a;d(c)};this.onChange=function(c){var e=GlobalEditor.ObjectUtil.clone(f);e[g[b]]=c;GlobalEditor.HistoryManager.addEditAction("edit",f,e,function(b){a.hSlider.setValue(b[g[0]]);a.pSlider.setValue(b[g[1]]);a.rSlider.setValue(b[g[2]]);d(b);f=b})}})};
...
GlobalEditor.EditorContainer=function(a){this.container=a;Cesium.BingMapsApi.defaultKey="AknGwyGtxa9zlcMazOG8GVPwpFATmyYf5GQOSwOMqTd-JTKe8h4Qwdu0WJRgQvfi";this.viewer=new Cesium.Viewer(a.attr("id"),{contextOptions:{webgl:{preserveDrawingBuffer:!0},allowTextureFilterAnisotropic:!1},baseLayerPicker:!1});this.viewer.scene.fxaa=!1;this.flyToSelectedItem=function(){this.viewer.selectedEntity!=null&&this.viewer.flyTo(this.viewer.selectedEntity)};this.flyHome=function(){this.viewer.camera.flyHome()};this.getSettings=
function(){var a={};a.viewer=GlobalEditor.ToolManager.getTools()[0].descriptor.getSettings();return a};this.setSettings=function(a){GlobalEditor.ToolManager.getTools()[0].descriptor.setSettings(a.viewer);GlobalEditor.propertiesPanel.update()};this.clear=function(){GlobalEditor.ToolManager.getTools()[0].descriptor.clear();GlobalEditor.propertiesPanel.update()}};
