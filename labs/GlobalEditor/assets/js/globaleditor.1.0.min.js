...
GlobalEditor.EditMaterialWin=function(a){function b(){l.removeClass("disabled");$.each(k,function(){this.reset()});j.dropdown("set selected",(0).toString())}function c(a,b){for(key in a)key!="className"&&(a[key]=b[key])}function e(a,b){function c(){var a={x:Number(f.val()),y:Number(g.val())};if(e.onChange!=void 0)e.onChange(a)}var e=this,d=a.find("input"),f=d.eq(0),g=d.eq(1);f.val(b.x);g.val(b.y);f.change(function(){c()});g.change(function(){c()});this.setPosition=function(a){f.val(a.x);g.val(a.y)}}
...
glowPower:0.25},PolylineOutlineMaterialProperty:{color:"#ffffff",outlineColor:"#000000",outlineWidth:1},StripeMaterialProperty:{evenColor:"#ffffff",oddColor:"#000000",repeat:1,offset:0,orientation:0}},h=$(a),j=h.find(".ui.dropdown").eq(0),i=h.find("#tab0,#tab1,#tab2,#tab3,#tab4,#tab5,#tab6"),k=[new function(a,b){var e=GlobalEditor.ObjectUtil.clone(b),d=a.find(".colorPicker").eq(0),g=new GlobalEditor.ColorPicker(e.color,d);g.onChange=function(a){e.color=a};this.reset=function(){e.color=b.color;g.setColor(e.color)};
this.setValue=function(a){a=this.encode(a);c(e,a);g.setColor(e.color)};this.getValue=function(){return this.decode(e)};this.show=function(){a.show()};this.encode=function(a){return{className:f[0],color:GlobalEditor.CesiumUtil.getPropertyValue(a.color).toCssColorString()}};this.decode=function(a){a=Cesium.Color.fromCssColorString(a.color);return new Cesium.ColorMaterialProperty(a)}}(i.eq(0),g.ColorMaterialProperty),new function(a){this.reset=function(){};this.setValue=function(){};this.getValue=function(){return this.decode()};
