...
this.messageWin=new GlobalEditor.MessageWin("#messageWin");this.ToolManager.init()};$(function(){GlobalEditor.init();GlobalEditor.Test.start()});
...
break;case "\u5220\u9664\u6570\u636e\u6e90":GlobalEditor.KeyboardManager.execute("delDataSource");break;case "\u7f16\u8f91\u56fe\u5c42":GlobalEditor.KeyboardManager.execute("editImageLayer");break;case "\u5220\u9664\u56fe\u5c42":GlobalEditor.KeyboardManager.execute("delImageLayer");break;case "\u5173\u4e8eGlobalEditor":GlobalEditor.KeyboardManager.execute("about");break;case "\u7ec4\u4ef6\u7f16\u8f91\u5668":window.open("componentEditor.html");break;case "\u7559\u8a00":GlobalEditor.KeyboardManager.execute("message")}}
...
GlobalEditor.MessageWin=function(a){var b=$(a),c=b.find(".content").eq(0),e=!1;this.show=function(){e||($("#uyan_frame").appendTo(c),$("#uyan_frame").css("visibility","visible"),e=!0);b.modal("show")}};
