...
GlobalEditor.EditDataSourceWin=function(a){function b(a){a=l.indexOf(a);h.eq(a).checkbox("set checked")}function c(a){a=p.indexOf(a);j.eq(a).checkbox("set checked");$.each([q,r,u],function(){this.hide()});a<p.length-1&&[q,r,u][a].show();a==2&&e();g.modal("refresh")}function e(){n==void 0&&(n=CodeMirror.fromTextArea(t.get(0),{mode:"javascript",lineNumbers:!0,textWrapping:!0,theme:"tomorrow-night-bright"}),n.on("change",function(){t.val(n.doc.getValue())}));n.doc.setValue(t.val())}function d(){k.removeClass("disabled");
s.val("");m.val("");o.val("");t.val("")}var f=this,g=$(a),a=g.find(".content .form").children(),h=a.eq(1).find(".ui.radio.checkbox").checkbox(),j=a.eq(2).find(".ui.radio.checkbox").checkbox(),i=g.find(".header label"),k=g.find(".actions button").eq(0),l=["CZML","GeoJSON","TopoJSON","KML","Custom"],p=["string","url","js","blank"],q=a.eq(3),r=a.eq(4),u=a.eq(5),s=a.eq(0).find("input"),m=q.find("textarea"),o=r.find("input"),t=u.find("textarea"),n;g.modal({onVisible:function(){n!=void 0&&n.refresh()}});
h.checkbox({onChange:function(){var a=$(this).data("class");b(a)}});j.checkbox({onChange:function(){var a=$(this).data("type");c(a)}});k.click(function(){k.addClass("disabled");var a={};a.name=s.val();a["class"]=h.closest(".checked").find("input").eq(0).data("class");a.type=j.closest(".checked").find("input").eq(0).data("type");var b=p.indexOf(a.type);b<p.length-1&&(a[a.type]=[m,o,t][b].val());f.handler.onSubmit(a);g.modal("hide")});this.openForNew=function(a){this.handler=a;i.text("\u6dfb\u52a0\u6570\u636e\u6e90");
b("CZML");c("string");d();g.modal("show")};this.openForEdit=function(a,f){this.handler=f;i.text("\u7f16\u8f91\u6570\u636e\u6e90 - "+a.name);b(a["class"]);c(a.type);d();s.val(a.name);var h=p.indexOf(a.type);h<p.length-1&&[m,o,t][h].val(a[a.type]);g.modal("show");h==2&&e()}};
