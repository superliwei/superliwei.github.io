...
break;case "\u5220\u9664\u6570\u636e\u6e90":GlobalEditor.KeyboardManager.execute("delDataSource");break;case "\u7f16\u8f91\u56fe\u5c42":GlobalEditor.KeyboardManager.execute("editImageLayer");break;case "\u5220\u9664\u56fe\u5c42":GlobalEditor.KeyboardManager.execute("delImageLayer");break;case "\u5173\u4e8eGlobalEditor":GlobalEditor.KeyboardManager.execute("about");break;case "\u7ec4\u4ef6\u7f16\u8f91\u5668":window.open("componentEditor.html")}}var c=a.find("span.text").eq(0).text();a.find(".item").length==
0&&a.click(b);var d=a.find("span.description").text();this.update=function(){var b=!0;switch(c){case "\u64a4\u6d88":b=GlobalEditor.historyPanel.getUndoAble();break;case "\u91cd\u505a":b=GlobalEditor.historyPanel.getRedoAble();break;case "\u5220\u9664":b=GlobalEditor.leftPanel.getComponentContainer().getSelectedItem()!=null;break;case "\u590d\u5236":b=GlobalEditor.leftPanel.getComponentContainer().getSelectedItem()!=null;break;case "\u526a\u5207":b=GlobalEditor.leftPanel.getComponentContainer().getSelectedItem()!=
null;break;case "\u7c98\u8d34":b=GlobalEditor.Clipboard.targets.length>0;break;case "\u7f16\u8f91\u6570\u636e\u6e90":b=GlobalEditor.dataSourcePanel.getSelectedItem()!=null;break;case "\u5220\u9664\u6570\u636e\u6e90":b=GlobalEditor.dataSourcePanel.getSelectedItem()!=null;break;case "\u7f16\u8f91\u56fe\u5c42":b=GlobalEditor.imageLayerPanel.getSelectedItem()!=null;break;case "\u5220\u9664\u56fe\u5c42":b=GlobalEditor.imageLayerPanel.getSelectedItem()!=null;break;case "\u98de\u5230\u9009\u62e9\u7684\u76ee\u6807":b=
GlobalEditor.editorContainer.viewer.selectedEntity!=null;break;case "\u5c5e\u6027\u9762\u677f":b=GlobalEditor.topMenu.panelMenuController.getSelectedValue()!="properties";break;case "\u5386\u53f2\u8bb0\u5f55":b=GlobalEditor.topMenu.panelMenuController.getSelectedValue()!="history";break;case "\u6570\u636e\u6e90":a.find(".menu").length==0&&(b=GlobalEditor.topMenu.panelMenuController.getSelectedValue()!="dataSource");break;case "\u5730\u5f62":b=GlobalEditor.topMenu.panelMenuController.getSelectedValue()!=
"terrain";break;case "\u56fe\u5c42":a.find(".menu").length==0&&(b=GlobalEditor.topMenu.panelMenuController.getSelectedValue()!="imageLayer");break;case "\u6444\u76f8\u673a":b=GlobalEditor.topMenu.panelMenuController.getSelectedValue()!="camera"}this.setEnabled(b)};this.setEnabled=function(b){b?a.removeClass("disabled"):a.addClass("disabled")}}this.view=$(a);a=this.view.find(".ui.dropdown:not(.right.menu .ui.dropdown)");a.dropdown({on:"hover",onShow:function(){b()}});var e=a.find(".item"),d=[];e.each(function(){d.push(new c($(this)))});
this.panelMenuController=new function(a){var b,c={properties:$("#propertiesPanel"),history:$("#historyPanel"),dataSource:$("#dataSourcePanel"),terrain:$("#terrainPanel"),imageLayer:$("#imageLayerPanel"),camera:$("#cameraPanel")};$.each(c,function(){$(this).css("display","none")});this.selectValue=function(b){a.dropdown("set selected",b)};this.getSelectedValue=function(){return b};this.getMenu=function(){return a};a.dropdown({onChange:function(a){b!=void 0&&c[b].css("display","none");b=a;c[b].css("display",
"block")}});this.selectValue("properties")}(this.view.find(".right.menu .ui.dropdown").eq(0));this.getItems=function(){return e}};
...
l.click(function(){l.addClass("disabled");var a;a=Number(j.dropdown("get value"));a=k[a].getValue();d.onSubmit(a);h.modal("hide")});i.hide();this.openForEditMaterial=function(a,c){this.onSubmit=c;b();if(a!=void 0){var d=f.indexOf(a.constructor.name);j.dropdown("set selected",d.toString());k[d].setValue(a)}h.modal("show")};e.getPosition=function(a){return{x:a.x,y:a.y}};e.toCartesian2=function(a){return new Cesium.Cartesian2(a.x,a.y)};this.getClassNames=function(){return f};this.isMaterialProperty=
function(a){return f.indexOf(a.constructor.name)>-1};this.encode=function(a){var b=f.indexOf(a.constructor.name);return k[b].encode(a)};this.decode=function(a){var b=f.indexOf(a.className);return k[b].decode(a)}};
