...
0)this.itemControllers=[],e(0)};this.getAndSetFuncForName=function(a){var a=GlobalEditor.DescriptorDataModel.getFuncName(a),e=this.delegate[a.getStr],d=this.delegate[a.setStr];return[function(){return e.call(b.delegate)},function(a){d.call(b.delegate,a)}]};this.update=function(){function a(b){for(var d=0;d<b.length;d++){var f=b[d];f instanceof Array?a(f):f.update!=void 0&&f.update()}}a(this.itemControllers)};this.isDataModel=function(a){return a.type==void 0&&a.createTo!=void 0};this.getSettings=
function(){function a(d){if(d!=b.items.length){var f=b.items[d];if(b.isDataModel(f))e[f.name]=f.getSettings();else if(f.name!=void 0){var g=b.getAndSetFuncForName(f.name)[0];e[f.name]=g()}d++;a(d)}}var e={};a(0);return e=this.encodeSettings(e)};this.setSettings=function(a){a=this.decodeSettings(a);for(key in a){var b=this.getAndSetFuncForName(key)[1];b!=void 0?a[key]!=void 0&&b(a[key]):(b=this.getSubDataModelByName(key),b!=void 0&&b.setSettings(a[key]))}};this.encodeSettings=function(a){var b={};
for(key in a){var d=a[key];if(typeof d=="object")if(this.getAndSetFuncForName(key)[1]!=void 0)b[key]=GlobalEditor.DescriptorDataModel.Encoder.encode(d);else{var f=this.getSubDataModelByName(key);f!=void 0&&(b[key]=f.encodeSettings(d))}else b[key]=d}return b};this.decodeSettings=function(a){var b={};for(key in a){var d=a[key];if(typeof d=="object")if(this.getAndSetFuncForName(key)[1]!=void 0)b[key]=GlobalEditor.DescriptorDataModel.Encoder.decode(d);else{var f=this.getSubDataModelByName(key);f!=void 0&&
(b[key]=f.decodeSettings(d))}else b[key]=d}return b};this.getSubDataModelByName=function(a){for(var b=this.items.length,d=0;d<b;d++){var f=this.items[d];if(this.isDataModel(f)&&f.name==a)return f}}};
