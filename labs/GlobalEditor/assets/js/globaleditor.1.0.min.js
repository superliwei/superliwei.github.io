...
0)this.itemControllers=[],e(0)};this.getAndSetFuncForName=function(a){a=GlobalEditor.DescriptorDataModel.getFuncName(a);return[this.delegate[a.getStr],this.delegate[a.setStr]]};this.update=function(){function a(b){for(var d=0;d<b.length;d++){var f=b[d];f instanceof Array?a(f):f.update!=void 0&&f.update()}}a(this.itemControllers)};this.isDataModel=function(a){return a.type==void 0&&a.createTo!=void 0};this.getSettings=function(){function a(d){if(d!=b.items.length){var f=b.items[d];if(b.isDataModel(f))e[f.name]=
