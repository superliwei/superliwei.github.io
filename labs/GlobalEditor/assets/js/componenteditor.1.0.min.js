...
GlobalEditor.ColorPicker=function(a,b){var e=this;this.view=b;this.view.val(a);this.view.colorPicker({animationSpeed:0,renderCallback:function(a,b){if(b!=!0)if(b==!1){if(e.onSubmit!=void 0)e.onSubmit(a.val())}else if(b==void 0&&e.onChange!=void 0)e.onChange(a.val())}});this.setColor=function(a){this.view.val(a);this.view.css("background-color",a)}};
