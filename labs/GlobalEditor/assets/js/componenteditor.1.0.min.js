...
this.getItems=function(){return c}};ComponentEditor.TextEditor=function(){var a=$("#leftBox"),b=CodeMirror(a.get(0),{value:ComponentEditor.component.text,mode:"javascript",lineNumbers:!0,textWrapping:!0,styleActiveLine:!0,matchBrackets:!0,theme:"tomorrow-night-bright"});b.setSize("100%","100%");this.getText=function(){return b.doc.getValue()};this.setText=function(a){return b.doc.setValue(a)}};
...
this.instance=null;this.clear=function(){GlobalEditor.HistoryManager.removeAll();if(this.instance!=null)this.instance.stop(),this.instance=null,this.descriptor=new ComponentEditor.NoneDescriptor,ComponentEditor.propertiesPanel.update()};this.run=function(){var a=ComponentEditor.textEditor.getText();this.text=a;try{eval(a);var b=GlobalEditor.ComponentManager.map[this.settings.name],d=Cesium.Math.toDegrees(this.settings.gps.longitude),c=Cesium.Math.toDegrees(this.settings.gps.latitude);this.clear();
this.instance=new b({gps:{lng:d,lat:c}});this.instance.play();if(this.instance.descriptor!=void 0)this.descriptor=this.instance.descriptor;ComponentEditor.propertiesPanel.update()}catch(e){GlobalEditor.Alert.show(e)}};this.isSaveAble=function(){if(this.settings.name=="")return GlobalEditor.Alert.show("JS\u7c7b\u540d\u4e0d\u80fd\u4e3a\u7a7a!"),!1;if(this.settings.desc=="")return GlobalEditor.Alert.show("\u7ec4\u4ef6\u63cf\u8ff0\u4e0d\u80fd\u4e3a\u7a7a!"),!1;if(this.settings.gps=="")return GlobalEditor.Alert.show("gps\u4e0d\u80fd\u4e3a\u7a7a!"),
...
this.playMusic=function(){f.hasClass("red")&&e.get(0).play()};this.stopMusic=function(){e.get(0).pause();e.get(0).currentTime=0};a.children().eq(2).text("GlobalEditor\u00b7\u7ec4\u4ef6\u7f16\u8f91\u5668 "+GlobalEditor.Settings.version);a.children().eq(3).text("Cesium "+Cesium.VERSION);var n='<div style="color:#999999;text-align: center;">'+Base64.decode("Qmxhbms=")+"</div>";n+='<div style="color:#999999;text-align: center;">'+Base64.decode("aGVyb2JsYW5rQGdtYWlsLmNvbQ==")+"</div>";$(n).appendTo(a)}(a.eq(2),
e.eq(2))],g=-1;c.each(function(a){$(this).click(function(){d.selectTabIdx(a)})});this.view.modal({onHide:function(){f[2].stopMusic()}});this.show=function(a){f[0].initValues();this.selectTabIdx(a);this.view.modal("show")};this.selectTabIdx=function(a){g>-1&&(c.eq(g).removeClass("active blue"),f[g].setDisplay(!1));c.eq(a).addClass("active blue");g=a;f[a].setDisplay(!0);this.view.modal("refresh")}};ComponentEditor.KeyboardManager={};
...
d=new GlobalEditor.SkyAtmosphereDataModel(new GlobalEditor.SkyAtmosphereDelegate(b.scene.skyAtmosphere));d.name="skyAtmosphere";a.add(d);GlobalEditor.BasicDescriptor.call(this,a);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,b,"resolutionScale");GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,b,"shadows");GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,b,"terrainShadows",void 0,GlobalEditor.DescriptorDataModelHandle.numberValue);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,
...
this.setSettings=function(b){a.setSettings(b)};this.clear=function(){a.setSettings(this.defaultSettings)};this.defaultSettings=this.getSettings()};GlobalEditor.EntityDescriptor=function(a){this.title="Entity";this.delegate=new GlobalEditor.EntityDelegate(a);this.dataModel=new GlobalEditor.EntityDataModel(this.delegate);GlobalEditor.BasicDescriptor.call(this,this.dataModel)};GlobalEditor.DescriptorDataModel=function(a){var b=this;this.delegate=a;this.items=[];this.itemControllers=[];this.add=function(a){this.items.push(a)};this.remove=function(a){a=this.items.indexOf(a);a>-1&&(this.items.splice(a,1),this.itemControllers.splice(a,1))};this.createTo=function(a){function c(e){if(e!=b.items.length){var f=b.items[e];b.isDataModel(f)?(f.createTo(a),b.itemControllers.push(f.itemControllers)):(f=GlobalEditor.DescItemMap.create(f,b,a),b.itemControllers.push(f));e++;c(e)}}if(this.items.length!=
0)this.itemControllers=[],c(0)};this.getAndSetFuncForName=function(a){var a=GlobalEditor.DescriptorDataModel.getFuncName(a),c=this.delegate[a.getStr],e=this.delegate[a.setStr];return[c!=void 0?function(){return c.call(b.delegate)}:void 0,e!=void 0?function(a){e.call(b.delegate,a)}:void 0]};this.update=function(){function a(b){for(var e=0;e<b.length;e++){var f=b[e];f instanceof Array?a(f):f.update!=void 0&&f.update()}}a(this.itemControllers)};this.isDataModel=function(a){return a.type==void 0&&a.createTo!=
void 0};this.getSettings=function(){function a(e){if(e!=b.items.length){var f=b.items[e];if(b.isDataModel(f))c[f.name]=f.getSettings();else if(f.name!=void 0){var g=b.getAndSetFuncForName(f.name)[0];c[f.name]=g()}e++;a(e)}}var c={};a(0);return c=this.encodeSettings(c)};this.setSettings=function(a){a=this.decodeSettings(a);for(key in a){var b=this.getAndSetFuncForName(key)[1];b!=void 0?a[key]!=void 0&&b(a[key]):(b=this.getSubDataModelByName(key),b!=void 0&&b.setSettings(a[key]))}};this.encodeSettings=
function(a){var b={};for(key in a){var e=a[key];if(typeof e=="object")if(this.getAndSetFuncForName(key)[1]!=void 0)b[key]=GlobalEditor.DescriptorDataModel.Encoder.encode(e);else{var f=this.getSubDataModelByName(key);f!=void 0&&(b[key]=f.encodeSettings(e))}else b[key]=e}return b};this.decodeSettings=function(a){var b={};for(key in a){var e=a[key];if(typeof e=="object")if(this.getAndSetFuncForName(key)[1]!=void 0)b[key]=GlobalEditor.DescriptorDataModel.Encoder.decode(e);else{var f=this.getSubDataModelByName(key);
f!=void 0&&(b[key]=f.decodeSettings(e))}else b[key]=e}return b};this.getSubDataModelByName=function(a){for(var b=this.items.length,e=0;e<b;e++){var f=this.items[e];if(this.isDataModel(f)&&f.name==a)return f}}};
...
this.setPosition=function(b){a.position=Cesium.Cartesian3.fromRadians(b.longitude,b.latitude,b.height)};this.orientationConfig={heading:0,pitch:0,roll:0};this.getOrientation=function(){return this.orientationConfig};this.setOrientation=function(b){this.orientationConfig=b;var d=GlobalEditor.CesiumUtil.getPropertyValue(a.position),c=Cesium.Math.toRadians(b.heading),e=Cesium.Math.toRadians(b.pitch),b=Cesium.Math.toRadians(b.roll);a.orientation=Cesium.Transforms.headingPitchRollQuaternion(d,c,e,b)}};
...
GlobalEditor.DescItemMap.icon=function(a,b,d){function c(a){var b=h.getContext("2d");b.clearRect(0,0,h.width,h.height);if(a!=""){var c=new Image;c.src=a;c.onload=function(){var a=h.width/c.width<h.height/c.height?h.width/c.width:h.height/c.height,e=c.width*a;a*=c.height;b.drawImage(c,0,0,c.width,c.height,(h.width-e)*0.5,(h.height-a)*0.5,e,a)}}}function e(a){var b=$("<input type='file'>");b.trigger("click");b.change(function(){var c=b.get(0).files[0];a(c)})}function f(b){var c=j();GlobalEditor.HistoryManager.addEditAction("edit",
...
f(),c=Number(h.val()),e=Number(j.val()),d=Number(k.val()),c=Cesium.Cartographic.fromDegrees(c,e,d);GlobalEditor.HistoryManager.addEditAction("edit",b,c,function(b){g(b);var c=Cesium.Math.toDegrees(b.longitude),e=Cesium.Math.toDegrees(b.latitude),b=b.height;a.latInput.val(e);a.lngInput.val(c);a.hInput.val(b)})})});this.update=function(){var a=f(),b=Cesium.Math.toDegrees(a.longitude),c=Cesium.Math.toDegrees(a.latitude),a=a.height;j.val(c);h.val(b);k.val(a)}};
...
function(){var a={};a.viewer=GlobalEditor.ToolManager.getTools()[0].descriptor.getSettings();return a};this.setSettings=function(a){GlobalEditor.ToolManager.getTools()[0].descriptor.setSettings(a.viewer);GlobalEditor.propertiesPanel.update()};this.clear=function(){GlobalEditor.ToolManager.getTools()[0].descriptor.clear();GlobalEditor.propertiesPanel.update()}};GlobalEditor.RectUtil={};
