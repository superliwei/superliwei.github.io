...
ComponentEditor.MainLayout=function(a){function b(){k=($(window).width()-l)*0.5;j=j==0?j:k;e.outerWidth(j);d.outerWidth(l);var a=$(window).width()-j-l-f.outerWidth()-g.outerWidth();c.outerWidth(a);var b=$(window).height()-$("#topMenu").outerHeight();e.outerHeight(b);d.outerHeight(b);c.outerHeight(b);c.css("left",j+f.outerWidth());d.css("left",j+a+f.outerWidth()+g.outerWidth());f.outerHeight(b);g.outerHeight(b);f.css("left",j);g.css("left",j+a+f.outerWidth());$(document).trigger(ComponentEditor.MainLayout.Event.RESIZE);
a=b-s-10;q.outerHeight(a-m.outerHeight());n.outerHeight(a);r.outerHeight(a)}this.view=$(a);var e=this.view.find("#leftBox"),c=this.view.find("#centerBox"),d=this.view.find("#rightBox"),a=this.view.find(".vDivide"),f=a.eq(0),g=a.eq(1),h=f.find(".handle"),i=g.find(".handle"),k=322,j=k,l=320;h.click(function(){j=j==k?0:k;b()});i.click(function(){l=l==320?0:320;b()});e.css("position","absolute");e.css("overflow","auto");c.css("position","absolute");d.css("position","absolute");this.view.find(".menu.tabular .item").tab();
var q=this.view.find("#propertiesPanel .segment");q.css("overflow","auto");var m=this.view.find("#propertiesPanel #header"),n=this.view.find("#historyPanel .segment");n.css("padding",5);n.css("overflow","auto");var r=this.view.find("#settingPanel .segment");r.css("overflow","auto");var s=this.view.find(".menu.tabular").outerHeight();$(window).resize(b);b();this.toggleLeft=function(){h.trigger("click")};this.toggleRight=function(){i.trigger("click")}};ComponentEditor.MainLayout.Event={RESIZE:"mainLayoutResizeEvent"};
ComponentEditor.TopMenu=function(a){function b(){$.each(d,function(){this.update()})}function e(a){function b(){if(c!="")ComponentEditor.KeyboardManager.execute(c);else switch(e){case "\u952e\u76d8\u5feb\u6377\u952e":ComponentEditor.KeyboardManager.execute("showQuickKey");break;case "\u5173\u4e8eGlobalEditor\u00b7\u7ec4\u4ef6\u7f16\u8f91\u5668":ComponentEditor.KeyboardManager.execute("about");break;case "\u505c\u6b62":ComponentEditor.KeyboardManager.execute("stop")}}var e=a.find("span.text").eq(0).text();
a.find(".item").length==0&&a.click(b);var c=a.find("span.description").text();this.update=function(){var a=!0;switch(e){case "\u64a4\u6d88":a=ComponentEditor.historyPanel.getUndoAble();break;case "\u91cd\u505a":a=ComponentEditor.historyPanel.getRedoAble();break;case "\u98de\u5230\u9009\u62e9\u7684\u76ee\u6807":a=ComponentEditor.editorContainer.viewer.selectedEntity!=null;break;case "\u5c5e\u6027\u9762\u677f":a=ComponentEditor.topMenu.panelMenuController.getSelectedValue()!="properties";break;case "\u5386\u53f2\u8bb0\u5f55":a=
...
d=[];c.each(function(){d.push(new e($(this)))});this.panelMenuController=new function(a){var b,e={properties:$("#propertiesPanel"),history:$("#historyPanel"),settings:$("#settingPanel")};$.each(e,function(){$(this).css("display","none")});this.selectValue=function(b){a.dropdown("set selected",b)};this.getSelectedValue=function(){return b};this.getMenu=function(){return a};a.dropdown({onChange:function(a){b!=void 0&&e[b].css("display","none");b=a;e[b].css("display","block")}});this.selectValue("settings")}(this.view.find(".right.menu .ui.dropdown").eq(0));
...
this.instance=null;this.clear=function(){if(this.instance!=null)this.instance.stop(),this.instance=null,this.descriptor=new ComponentEditor.NoneDescriptor,ComponentEditor.propertiesPanel.update()};this.run=function(){var a=ComponentEditor.textEditor.getText();this.text=a;try{eval(a);var b=GlobalEditor.ComponentManager.map[this.settings.name],e=Cesium.Math.toDegrees(this.settings.gps.longitude),c=Cesium.Math.toDegrees(this.settings.gps.latitude);this.clear();this.instance=new b({gps:{lng:e,lat:c}});
this.instance.play();if(this.instance.descriptor!=void 0)this.descriptor=this.instance.descriptor;ComponentEditor.propertiesPanel.update()}catch(d){GlobalEditor.Alert.show(d)}};this.isSaveAble=function(){if(this.settings.name=="")return GlobalEditor.Alert.show("JS\u7c7b\u540d\u4e0d\u80fd\u4e3a\u7a7a!"),!1;if(this.settings.desc=="")return GlobalEditor.Alert.show("\u7ec4\u4ef6\u63cf\u8ff0\u4e0d\u80fd\u4e3a\u7a7a!"),!1;if(this.settings.gps=="")return GlobalEditor.Alert.show("gps\u4e0d\u80fd\u4e3a\u7a7a!"),
...
ComponentEditor.SettingWin=function(a){function b(a,b){this.setDisplay=function(e){a.css("display",e?"block":"none");b.css("display",e?"block":"none")}}var e=this;this.view=$(a);var c=this.view.find(".ui.menu .item"),a=this.view.find(".content").eq(0).children(),d=this.view.find(".actions").eq(0).children(),f=[new function(a,e){b.call(this,a,e);var c=this,d=a.find("input").eq(0),f=e.find("button").eq(0);this.getMaxHistory=function(){return GlobalEditor.HistoryManager.maxLen};this.setMaxHistory=function(a){GlobalEditor.HistoryManager.maxLen=
a};this.initValues=function(){d.val(this.getMaxHistory())};this.initValues();f.click(function(){c.setMaxHistory(d.val())})}(a.eq(0),d.eq(0)),new function(a,e){b.call(this,a,e);var c='<table class="ui celled table">';c+=" <thead><tr>";c+="  <th>\u5feb\u6377\u952e</th>";c+="  <th>\u8bf4\u660e</th>";c+=" </tr></thead>";c+=" <tbody>";ComponentEditor.topMenu.getItems().each(function(){if($(this).find(".item").length==0){var a=$(this).find("span.text").text(),b=$(this).find("span.description").text();b!=
""&&(c+="<tr><td>"+b+"</td><td>"+a+"</td></tr>")}});c+=" </tbody>";c+="</table>";$(c).appendTo(a)}(a.eq(1),d.eq(1)),new function(a,e){b.call(this,a,e);var c=this,d=$("<audio>",{src:"assets/sounds/m01.m4a",loop:!0}),f=a.find(".icon.music");f.addClass("red");f.click(function(){f.toggleClass("red");f.hasClass("red")?c.playMusic():c.stopMusic()});var g=this.setDisplay;this.setDisplay=function(b){g.call(this,b);a.parent().css("background-color",b?"#000000":"#ffffff");b?this.playMusic():this.stopMusic()};
this.playMusic=function(){f.hasClass("red")&&d.get(0).play()};this.stopMusic=function(){d.get(0).pause();d.get(0).currentTime=0};a.children().eq(2).text("GlobalEditor\u00b7\u7ec4\u4ef6\u7f16\u8f91\u5668 "+GlobalEditor.Settings.version);var m='<div style="color:#999999;text-align: center;">'+Base64.decode("Qmxhbms=")+"</div>";m+='<div style="color:#999999;text-align: center;">'+Base64.decode("aGVyb2JsYW5rQGdtYWlsLmNvbQ==")+"</div>";$(m).appendTo(a)}(a.eq(2),d.eq(2))],g=-1;c.each(function(a){$(this).click(function(){e.selectTabIdx(a)})});
...
submitLabel:"\u4fdd\u5b58",onSubmit:function(b){var e=a.getSaveData(),e=JSON.stringify(e);a.saveText(e,b+".gecp")}})}},saveData:function(a,b){var e=$("<a>");e.attr("href",a);e.attr("download",b);e.get(0).click()},saveText:function(a,b){this.saveData("data:application/octet-stream;base64,"+Base64.encode(a),b)},browser:function(a){var b=$("<input type='file'>");b.trigger("click");b.change(function(){var e=b.get(0).files[0];a(e)})},readText:function(a,b){$("#loadingMask").dimmer({closable:!1});$("#loadingMask").find(".ui.text.loader").text("\u6587\u4ef6\u8bfb\u53d6\u4e2d...");
$("#loadingMask").dimmer("show");var e=new FileReader;e.onload=function(){$("#loadingMask").dimmer("hide");b(e.result)};e.readAsText(a)},getSaveData:function(){var a={name:"ComponentEditor|"+GlobalEditor.Settings.signature,date:new Date,version:GlobalEditor.Settings.version},b={};b.js=ComponentEditor.component.text;b.name=ComponentEditor.component.settings.name;b.desc=ComponentEditor.component.settings.desc;var e=Cesium.Math.toDegrees(ComponentEditor.component.settings.gps.longitude),c=Cesium.Math.toDegrees(ComponentEditor.component.settings.gps.latitude);
b.gps={lng:e,lat:c};b.icon=ComponentEditor.component.settings.icon;a.component=b;return a},resetEditor:function(){ComponentEditor.component.clear();GlobalEditor.HistoryManager.removeAll();ComponentEditor.editorContainer.viewer.camera.flyHome(0)},openSavedData:function(a){this.resetEditor();a=JSON.parse(a).component;ComponentEditor.component.text=a.js;ComponentEditor.component.settings.name=a.name;ComponentEditor.component.settings.desc=a.desc;ComponentEditor.component.settings.gps=Cesium.Cartographic.fromDegrees(a.gps.lng,
...
GlobalEditor.HistoryManager.go=function(a){for(a=this.items.indexOf(a);this.idx!=a;)a<this.idx?(this.items[this.idx].undo(),this.idx--):(this.idx++,this.items[this.idx].redo());$(document).trigger(GlobalEditor.HistoryManager.UPDATE)};GlobalEditor.HistoryItem=function(a,b,e){this.type=a;this.undo=b;this.redo=e};GlobalEditor.HistoryManager.addEditAction=function(a,b,e,c){this.add(a,function(){c(b)},function(){c(e)})};
GlobalEditor.HistoryPanel=function(){function a(){var a=GlobalEditor.HistoryManager.items.length,b=GlobalEditor.HistoryManager.idx;a==0?(c.addClass("disabled"),d.addClass("disabled"),f.addClass("disabled")):(f.removeClass("disabled"),b==a-1?(d.addClass("disabled"),c.removeClass("disabled")):(b==-1?c.addClass("disabled"):c.removeClass("disabled"),d.removeClass("disabled")));g.empty();a=GlobalEditor.HistoryManager.items.length;if(a==0)g.text("\u6ca1\u6709\u4efb\u4f55\u5386\u53f2\u8bb0\u5f55");else for(var b=
[],e=GlobalEditor.HistoryManager.idx,j=0;j<a;j++){var l=new GlobalEditor.HistoryItemView(GlobalEditor.HistoryManager.items[j]);l.view.prependTo(g);b.push(l);j==e&&b[j].view.addClass("active")}}var b=$("#historyPanel"),e=b.find(".ui.tab.segment .menu .item"),c=e.eq(0),d=e.eq(1),f=e.eq(2),g=b.find(".ui.tab.segment .list");a();c.click(function(){GlobalEditor.HistoryManager.undo()});d.click(function(){GlobalEditor.HistoryManager.redo()});f.click(function(){GlobalEditor.HistoryManager.removeAll()});$(document).bind(GlobalEditor.HistoryManager.UPDATE,
a);this.getUndoAble=function(){return!c.hasClass("disabled")};this.getRedoAble=function(){return!d.hasClass("disabled")}};
...
GlobalEditor.ButtonGroupSwitcher=function(a,b){var e=this,c=a.find("button"),d=-1,f=[];c.each(function(a,b){$(b).click(function(){if(d!=a&&(e.selectIdx(a),e.onChange!=void 0))e.onChange(e.getValue())});f.push($(b).attr("data-value"))});this.selectIdx=function(a){d>-1&&c.eq(d).removeClass("active");d=a;c.eq(a).addClass("active")};this.setValue=function(a){this.selectIdx(f.indexOf(a))};this.getValue=function(){return f[d]};b!=void 0&&this.setValue(b)};
GlobalEditor.Dropdown=function(a,b){var e=this;this.view=GlobalEditor.FormViewManager.createDropdownView(a,b);this.dropdown=this.view.find(".ui.dropdown");this.fireChangeEvent=!0;this.dropdown.dropdown({onChange:function(a,b,f){if(e.onChange!=void 0&&e.fireChangeEvent)e.onChange(a,b,f)}});this.setValue=function(a){this.fireChangeEvent=!1;this.dropdown.dropdown("set selected",a.toString());this.fireChangeEvent=!0}};
GlobalEditor.ColorPicker=function(a,b){var e=this;this.view=b;this.view.val(a);this.view.colorPicker({animationSpeed:0,renderCallback:function(a,b){var f;if(b==!0)a.val();else if(b==!1){if(e.onSubmit!=void 0)e.onSubmit(f)}else if(b==void 0&&(f=a.val(),e.onChange!=void 0))e.onChange(f)}});this.setColor=function(a){this.view.val(a);this.view.css("background-color",a)}};
GlobalEditor.Slider=function(a,b,e,c){var d=this,f=a.find(".ui.slider").get(0);noUiSlider.create(f,{start:[c],range:{min:[b],max:[e]}});var g=a.find("input").get(0);f.noUiSlider.on("update",function(a,b){var e=a[b];g.value=e;if(d.onUpdate!=void 0)d.onUpdate(e)});g.addEventListener("change",function(){f.noUiSlider.set(this.value);if(d.onChange!=void 0)d.onChange(this.value)});f.noUiSlider.on("change",function(){var a=d.getValue();if(d.onChange!=void 0)d.onChange(a)});this.getValue=function(){return f.noUiSlider.get()};
this.setValue=function(a){f.noUiSlider.set(a)}};
GlobalEditor.InputWin=function(a){var b=$(a),e=b.find(".header i").eq(0),c=b.find(".header label").eq(0),d=b.find("input").eq(0),f=b.find(".right.labeled .label").eq(0),g=b.find(".actions button").eq(0),h;g.click(function(){g.addClass("disabled");b.modal("hide");h!=void 0&&h(d.val())});this.setOption=function(a){e.attr("class",a.icon);c.text(a.title);d.attr("placeholder",a.placeholder);f.text(a.rightlabel);g.text(a.submitLabel);d.val(a.value);h=a.onSubmit};this.show=function(a){this.setOption(a);
g.removeClass("disabled");b.modal("show")}};
GlobalEditor.Alert=function(){var a={},b=$("<div class='ui small modal'>");$("<div class='header'><i class='warning circle icon'></i><label>\u63d0\u793a</label></div>").appendTo(b);var e=$("<div class='content'>");e.appendTo(b);var c=$("<div class='actions'>");c.appendTo(b);var d=$('<button class="ui primary button">'),f=$('<button class="ui button">');d.click(function(){d.addClass("disabled");b.modal("hide");if(a.onSubmit!=void 0)a.onSubmit()});f.click(function(){f.addClass("disabled");b.modal("hide")});
a.show=function(g,h,i,k){d.removeClass("disabled");f.removeClass("disabled");d.detach();f.detach();d.text("Submit");f.text("Cancel");h!=void 0&&(d.text(h),d.appendTo(c));i!=void 0&&(f.text(i),f.appendTo(c));a.onSubmit=k;e.text(g);b.modal("show")};return a}();
GlobalEditor.EditMaterialWin=function(a){function b(){l.removeClass("disabled");$.each(j,function(){this.reset()});i.dropdown("set selected",(0).toString())}function e(a,b){for(key in a)key!="className"&&(a[key]=b[key])}function c(a,b){function e(){var a={x:Number(f.val()),y:Number(g.val())};if(c.onChange!=void 0)c.onChange(a)}var c=this,d=a.find("input"),f=d.eq(0),g=d.eq(1);f.val(b.x);g.val(b.y);f.change(function(){e()});g.change(function(){e()});this.setPosition=function(a){f.val(a.x);g.val(a.y)}}
...
k=a.children().eq(4),o=new c(g,d.lineCount),l=new c(i,d.lineThickness),p=new c(k,d.lineOffset);o.onChange=function(a){d.lineCount=a};l.onChange=function(a){d.lineThickness=a};p.onChange=function(a){d.lineOffset=a};this.reset=function(){d.color=b.color;d.cellAlpha=b.cellAlpha;d.lineCount=b.lineCount;d.lineThickness=b.lineThickness;d.lineOffset=b.lineOffset;h.setColor(d.color);j.setValue(d.cellAlpha);o.setPosition(d.lineCount);l.setPosition(d.lineThickness);p.setPosition(d.lineOffset)};this.setValue=
function(a){a=this.encode(a);e(d,a);h.setColor(d.color);j.setValue(d.cellAlpha);o.setPosition(d.lineCount);l.setPosition(d.lineThickness);p.setPosition(d.lineOffset)};this.getValue=function(){return this.decode(d)};this.show=function(){a.show()};this.encode=function(a){return{className:f[2],color:a.color==void 0?b.color:GlobalEditor.CesiumUtil.getPropertyValue(a.color).toCssColorString(),cellAlpha:a.cellAlpha==void 0?b.cellAlpha:GlobalEditor.CesiumUtil.getPropertyValue(a.cellAlpha),lineCount:a.lineCount==
...
lineOffset:c.toCartesian2(a.lineOffset)};return new Cesium.GridMaterialProperty(a)}}(k.eq(2),g.GridMaterialProperty),new function(a,b){var d=GlobalEditor.ObjectUtil.clone(b),g=a.find(".colorPicker").eq(0),h=new GlobalEditor.ColorPicker(d.color,g);h.onChange=function(a){d.color=a};var j=a.find(".ui.checkbox").eq(0);j.checkbox({onChange:function(){var a=j.checkbox("is checked");d.transparent=a}});var i=a.children().eq(0).find("input").eq(0);i.change(function(){d.image=i.val()});var g=a.children().eq(1),
k=new c(g,d.repeat);k.onChange=function(a){d.repeat=a};this.reset=function(){d.image=b.image;d.repeat=b.repeat;d.color=b.color;d.transparent=b.transparent;i.val(d.image);k.setPosition(d.repeat);h.setColor(d.color);j.checkbox(d.transparent?"set checked":"set unchecked")};this.setValue=function(a){a=this.encode(a);e(d,a);i.val(d.image);k.setPosition(d.repeat);h.setColor(d.color);j.checkbox(d.transparent?"set checked":"set unchecked")};this.getValue=function(){return this.decode(d)};this.show=function(){a.show()};
...
color:Cesium.Color.fromCssColorString(a.color),transparent:a.transparent};return new Cesium.ImageMaterialProperty(a)}}(k.eq(3),g.ImageMaterialProperty),new function(a,b){var c=GlobalEditor.ObjectUtil.clone(b),d=a.find(".colorPicker").eq(0),g=new GlobalEditor.ColorPicker(c.color,d);g.onChange=function(a){c.color=a};var d=a.children().eq(1),h=new GlobalEditor.Slider(d,0,1,c.glowPower);h.onChange=function(a){c.glowPower=a};this.reset=function(){c.color=b.color;c.glowPower=b.glowPower;g.setColor(c.color);
h.setValue(c.glowPower)};this.setValue=function(a){a=this.encode(a);e(c,a);g.setColor(c.color);h.setValue(c.glowPower)};this.getValue=function(){return this.decode(c)};this.show=function(){a.show()};this.encode=function(a){return{className:f[4],color:a.color==void 0?b.color:GlobalEditor.CesiumUtil.getPropertyValue(a.color).toCssColorString(),glowPower:a.glowPower==void 0?b.glowPower:GlobalEditor.CesiumUtil.getPropertyValue(a.glowPower)}};this.decode=function(a){a={color:Cesium.Color.fromCssColorString(a.color),
glowPower:a.glowPower};return new Cesium.PolylineGlowMaterialProperty(a)}}(k.eq(4),g.PolylineGlowMaterialProperty),new function(a,b){var c=GlobalEditor.ObjectUtil.clone(b),d=a.find(".colorPicker").eq(0),g=a.find(".colorPicker").eq(1),h=new GlobalEditor.ColorPicker(c.color,d);h.onChange=function(a){c.color=a};var j=new GlobalEditor.ColorPicker(c.outlineColor,g);j.onChange=function(a){c.outlineColor=a};var i=a.children().eq(2).find("input").eq(0);i.change(function(){c.outlineWidth=Number(i.val())});
this.reset=function(){c.color=b.color;c.outlineColor=b.outlineColor;c.outlineWidth=b.outlineWidth;h.setColor(c.color);j.setColor(c.outlineColor);i.val(c.outlineWidth)};this.setValue=function(a){a=this.encode(a);e(c,a);h.setColor(c.color);j.setColor(c.outlineColor);i.val(c.outlineWidth)};this.getValue=function(){return this.decode(c)};this.show=function(){a.show()};this.encode=function(a){return{className:f[5],color:a.color==void 0?b.color:GlobalEditor.CesiumUtil.getPropertyValue(a.color).toCssColorString(),
...
b){var c=GlobalEditor.ObjectUtil.clone(b),d=a.find(".colorPicker").eq(0),g=a.find(".colorPicker").eq(1),h=new GlobalEditor.ColorPicker(c.evenColor,d);h.onChange=function(a){c.evenColor=a};var j=new GlobalEditor.ColorPicker(c.oddColor,g);j.onChange=function(a){c.oddColor=a};var i=a.find(".ui.dropdown").eq(0);i.dropdown({onChange:function(a){c.orientation=Number(a)}});var k=a.children().eq(2).find("input").eq(0),l=a.children().eq(3).find("input").eq(0);k.change(function(){c.repeat=Number(k.val())});
l.change(function(){c.offset=Number(l.val())});this.reset=function(){c.evenColor=b.evenColor;c.oddColor=b.oddColor;c.repeat=b.repeat;c.offset=b.offset;c.orientation=b.orientation;h.setColor(c.evenColor);j.setColor(c.oddColor);k.val(c.repeat);l.val(c.offset);i.dropdown("set selected",c.orientation.toString())};this.setValue=function(a){a=this.encode(a);e(c,a);h.setColor(c.evenColor);j.setColor(c.oddColor);k.val(c.repeat);l.val(c.offset);i.dropdown("set selected",c.orientation.toString())};this.getValue=
...
orientation:a.orientation==void 0?b.orientation:GlobalEditor.CesiumUtil.getPropertyValue(a.orientation)}};this.decode=function(a){a={evenColor:Cesium.Color.fromCssColorString(a.evenColor),oddColor:Cesium.Color.fromCssColorString(a.oddColor),repeat:a.repeat,offset:a.offset,orientation:a.orientation};return new Cesium.StripeMaterialProperty(a)}}(k.eq(6),g.StripeMaterialProperty)];i.dropdown({onChange:function(a){a=Number(a);k.hide();j[a].show();h.modal("refresh")}});var l=h.find(".actions button").eq(0);
l.click(function(){l.addClass("disabled");var a;a=Number(i.dropdown("get value"));a=j[a].getValue();d.onSubmit(a);h.modal("hide")});k.hide();this.openForEditMaterial=function(a,c){this.onSubmit=c;b();if(a!=void 0){var e=d.getClassName(a),e=f.indexOf(e);i.dropdown("set selected",e.toString());j[e].setValue(a)}h.modal("show")};c.getPosition=function(a){return{x:a.x,y:a.y}};c.toCartesian2=function(a){return new Cesium.Cartesian2(a.x,a.y)};this.getClassNames=function(){return f};this.getClassName=function(a){for(var b=
a.constructor.name,c=0;c<f.length;c++){var e=f[c];if(a instanceof Cesium[e]){b=e;break}}return b};this.isMaterialProperty=function(a){a=this.getClassName(a);return f.indexOf(a)>-1};this.encode=function(a){var b=this.getClassName(a),b=f.indexOf(b);return j[b].encode(a)};this.decode=function(a){var b=f.indexOf(a.className);return j[b].decode(a)}};
...
GlobalEditor.ComponentManager={map:{},loadItems:[],gecp:{},loadComponent:function(a,b,e){this.isGecpFile(b)?this.loadComponentFromGecpFile(a,b,e):this.loadComponentFromFolder(a,b,e)},loadComponentFromFolder:function(a,b,e){$.getJSON("componentLib/"+a+"/"+b+"/config.json",function(c){function d(){$.getScript("componentLib/"+a+"/"+b+"/"+c.require[f],function(){f++;f==c.require.length?e(c):d(f)})}if(c.require.length==0)e(c);else{var f=0;d()}})},loadComponentFromGecpFile:function(a,b,e){var c=this;$.getJSON("componentLib/"+
a+"/"+b,function(a){var f={desc:a.component.desc,icon:a.component.icon,name:a.component.name};c.gecp[b]=f;a=a.component.js;try{eval(a),e(f)}catch(g){GlobalEditor.Alert.show(g)}})},isGecpFile:function(a){return a.split(".").indexOf("gecp")==1},append:function(a,b,e){this.loadItems.push({type:a,name:b,onComplete:e})},startLoad:function(a){function b(c){var d=e.loadItems[c];e.loadComponent(d.type,d.name,function(f){d.onComplete(f);c++;c<e.loadItems.length?b(c):a!=void 0&&a()})}var e=this;b(0)}};
...
GlobalEditor.FormViewManager.createDropdownView=function(a,b){for(var e=$('<div class="inline fields">\t<div class="five wide field">\t\t<label>'+a+'</label>\t</div>\t<div class="eleven wide field">\t\t<div class="ui selection dropdown">\t\t\t<i class="dropdown icon"></i>\t\t\t<div class="default text"></div>\t\t\t<div class="menu">\t\t\t</div>\t\t</div>\t</div></div>'),c=e.find(".menu"),d=b.length,f=0;f<d;f++)$('<div class="item" data-value="'+b[f].value+'">'+b[f].label+"</div>").appendTo(c);return e};
...
GlobalEditor.FormViewManager.createIconButtonGroupView=function(a,b){for(var e=$('<div class="inline fields">\t<div class="five wide field">\t\t<label>'+a+'</label>\t</div>\t<div class="eleven wide field">\t\t<div class="ui icon basic buttons"></div>\t</div></div>'),c=e.find(".buttons"),d=0;d<b.length;d++)$('<button class="ui button" data-value="'+b[d].value+'"><i class="'+b[d].icon+' icon"></i></button>').appendTo(c);return e};
GlobalEditor.FormViewManager.createButtonGroupView=function(a,b){for(var e=$('<div class="inline fields">\t<div class="five wide field">\t\t<label>'+a+'</label>\t</div>\t<div class="eleven wide field">\t\t<div class="ui icon basic buttons"></div>\t</div></div>'),c=e.find(".buttons"),d=0;d<b.length;d++)$('<button class="ui button" data-value="'+b[d].value+'">'+b[d].label+"</button>").appendTo(c);return e};
...
GlobalEditor.FormViewManager.createIconView=function(a,b){var e=$('<div class="inline fields">\t<label style="position:absolute;margin-top:0px;">'+a+'</label>\t<div class="five wide field"></div>\t<div class="eleven wide"></div></div>'),c=e.find(".eleven.wide").eq(0),d=$('<div class="iconPicker">');d.innerWidth(b.width);d.innerHeight(b.height);d.appendTo(c);c=$("<canvas>");c.get(0).width=b.width;c.get(0).height=b.height;c.appendTo(d);return e};
...
GlobalEditor.BasicDescriptor=function(a){this.dataModels=[a];this.init=function(a){a.header.text(this.title);var e=a.form;this.container=e;$.each(this.dataModels,function(){this.createTo(e)})};this.update=function(){this.container!=void 0&&$.each(this.dataModels,function(){this.update()})}};
...
a.add({type:"checkBox",label:"\u6297\u5267\u9f7f",name:"fxaa"});a.add({type:"header",label:"\u5929\u7a7a\u76d2"});a.add({type:"checkBox",label:"\u663e\u793a",name:"showSkyBox"});a.add({type:"header",label:"\u5927\u6c14\u5c42"});var b=GlobalEditor.editorContainer.viewer,e=new GlobalEditor.SkyAtmosphereDataModel(new GlobalEditor.SkyAtmosphereDelegate(b.scene.skyAtmosphere));e.name="skyAtmosphere";a.add(e);GlobalEditor.BasicDescriptor.call(this,a);GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,
...
cesiumArrayString:function(a){return GlobalEditor.CesiumUtil.getPropertyValue(a).join(",")},cesiumArrayValue:function(a){return a.split(",")}};GlobalEditor.DescriptorDataModel.createGetterAndSetter=function(a,b,e,c,d,f,g){var h=this.getFuncName(e);a[h.getStr]=function(){f!=void 0&&(b[e]=Cesium.defaultValue(b[e],f));return(c==void 0?GlobalEditor.DescriptorDataModelHandle.donothing:c)(b[e])};a[h.setStr]=function(a){b[e]=(d==void 0?GlobalEditor.DescriptorDataModelHandle.donothing:d)(a);g!=void 0&&g()}};
...
GlobalEditor.PolygonDelegate=function(a){GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"hierarchy",GlobalEditor.DescriptorDataModelHandle.cesiumPositionsString,GlobalEditor.DescriptorDataModelHandle.cesiumPositionsValue);this.getHeight=function(){return GlobalEditor.CesiumUtil.getPropertyValue(a.height)};this.setHeight=function(b){var e=GlobalEditor.CesiumUtil.getPropertyValue(a.perPositionHeight);a.height=e?void 0:Number(b)};this.getPerPositionHeight=function(){return GlobalEditor.CesiumUtil.getPropertyValue(a.perPositionHeight)};
...
this.setPosition=function(b){a.position=Cesium.Cartesian3.fromRadians(b.longitude,b.latitude,b.height)};this.orientationConfig={heading:0,pitch:0,roll:0};this.getOrientation=function(){return b.orientationConfig};this.setOrientation=function(e){b.orientationConfig=e;var c=GlobalEditor.CesiumUtil.getPropertyValue(a.position),d=Cesium.Math.toRadians(e.heading),f=Cesium.Math.toRadians(e.pitch),e=Cesium.Math.toRadians(e.roll);a.orientation=Cesium.Transforms.headingPitchRollQuaternion(c,d,f,e)}};
...
GlobalEditor.SkyAtmosphereDelegate=function(a){GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"show");GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"hueShift");GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"saturationShift");GlobalEditor.DescriptorDataModel.createGetterAndSetter(this,a,"brightnessShift")};GlobalEditor.DescItemMap={};GlobalEditor.DescItemMap.create=function(a,b,e){return new this[a.type](a,b,e)};
GlobalEditor.DescItemMap.checkBox=function(a,b,e){var c=GlobalEditor.FormViewManager.createCheckBoxView(a.label);c.appendTo(e);var a=b.getAndSetFuncForName(a.name),d=a[0],f=a[1],g=c.find(".ui.checkbox").eq(0);g.checkbox(d()?"set checked":"set unchecked");g.checkbox({onChange:function(){var a=d(),b=g.checkbox("is checked");GlobalEditor.HistoryManager.addEditAction("edit",a,b,function(a){f(a);g.checkbox(a?"set checked":"set unchecked")})}})};
GlobalEditor.DescItemMap.color=function(a,b,e){var c=GlobalEditor.FormViewManager.createColorPickerView(a.label);c.appendTo(e);var a=b.getAndSetFuncForName(a.name),d=a[1],f=(0,a[0])(),g=new GlobalEditor.ColorPicker(f,c.find(".colorPicker"));g.onChange=function(a){d(a)};g.onSubmit=function(a){f!=a&&GlobalEditor.HistoryManager.addEditAction("edit",f,a,function(a){g.setColor(a);d(a);f=a})}};
GlobalEditor.DescItemMap.dropdown=function(a,b,e){var c=new GlobalEditor.Dropdown(a.label,a.data);c.view.appendTo(e);var a=b.getAndSetFuncForName(a.name),d=a[0],f=a[1];c.setValue(d());c.onChange=function(a){var b=d();GlobalEditor.HistoryManager.addEditAction("edit",b,a,function(a){f(a);c.setValue(a)})}};GlobalEditor.DescItemMap.header=function(a,b,e){GlobalEditor.FormViewManager.createHeader(a.label).appendTo(e)};GlobalEditor.DescItemMap.hline=function(a,b,e){GlobalEditor.FormViewManager.createHline().appendTo(e)};
GlobalEditor.DescItemMap.html=function(a,b,e){$(a.html).appendTo(e)};GlobalEditor.DescItemMap.input=function(a,b,e){var c=GlobalEditor.FormViewManager.createTextInputView(a.label);c.appendTo(e);var a=b.getAndSetFuncForName(a.name),d=a[0],f=a[1],g=c.find("input").eq(0);g.val(d());g.change(function(){var a=d(),b=g.val();GlobalEditor.HistoryManager.addEditAction("edit",a,b,function(a){f(a);g.val(a)})})};
GlobalEditor.DescItemMap.position=function(a,b,e){var c=GlobalEditor.FormViewManager.createPositionView();c.appendTo(e);var a=b.getAndSetFuncForName(a.name),d=a[0],f=a[1],c=c.find("input"),g=c.eq(0),h=c.eq(1);g.val(d().x);h.val(d().y);g.change(function(){var a=d(),b=d();b.x=Number(g.val());GlobalEditor.HistoryManager.addEditAction("edit",a,b,function(a){f(a);g.val(a.x)})});h.change(function(){var a=d(),b=d();b.y=Number(h.val());GlobalEditor.HistoryManager.addEditAction("edit",a,b,function(a){f(a);
h.val(a.y)})});this.update=function(){g.val(d().x);h.val(d().y)}};GlobalEditor.DescItemMap.size=function(a,b,e){var c=GlobalEditor.FormViewManager.createSizeView();c.appendTo(e);var a=b.getAndSetFuncForName(a.name),d=a[0],f=a[1],c=c.find("input"),g=c.eq(0),h=c.eq(1),c=d();g.val(c.width);h.val(c.height);$.each([g,h],function(){this.change(function(){var a=d(),b=g.val(),c=h.val();GlobalEditor.HistoryManager.addEditAction("edit",a,{width:b,height:c},function(a){f(a);g.val(a.width);h.val(a.height)})})})};
GlobalEditor.DescItemMap.slider=function(a,b,e){var c=GlobalEditor.FormViewManager.createSliderView(a.label);c.appendTo(e);var b=b.getAndSetFuncForName(a.name),e=b[0],d=b[1],f=new GlobalEditor.Slider(c,a.min,a.max,e()),g=e();f.onUpdate=function(a){d(a)};f.onChange=function(a){GlobalEditor.HistoryManager.addEditAction("edit",g,a,function(a){f.setValue(a);d(a);g=a})}};
GlobalEditor.DescItemMap.tabs=function(a,b,e){var c=GlobalEditor.FormViewManager.createButtonGroupView(a.label,a.items);c.appendTo(e);var a=b.getAndSetFuncForName(a.name),d=a[0],f=a[1],g=new GlobalEditor.ButtonGroupSwitcher(c,d());g.onChange=function(a){var b=d();GlobalEditor.HistoryManager.addEditAction("edit",b,a,function(a){f(a);g.setValue(a)})}};
GlobalEditor.DescItemMap.textArea=function(a,b,e){var c=GlobalEditor.FormViewManager.createTextAreaView(a.label);c.appendTo(e);var a=b.getAndSetFuncForName(a.name),d=a[0],f=a[1],g=c.find("textarea").eq(0);g.val(d());g.change(function(){var a=d(),b=g.val();GlobalEditor.HistoryManager.addEditAction("edit",a,b,function(a){f(a);g.val(a)})})};
GlobalEditor.DescItemMap.icon=function(a,b,e){function c(a){var b=h.getContext("2d");b.clearRect(0,0,h.width,h.height);if(a!=""){var c=new Image;c.src=a;c.onload=function(){var a=h.width/c.width<h.height/c.height?h.width/c.width:h.height/c.height,d=c.width*a;a*=c.height;b.drawImage(c,0,0,c.width,c.height,(h.width-d)*0.5,(h.height-a)*0.5,d,a)}}}function d(a){var b=$("<input type='file'>");b.trigger("click");b.change(function(){var c=b.get(0).files[0];a(c)})}function f(a){var b=i();GlobalEditor.HistoryManager.addEditAction("edit",
b,a,function(a){k(a);c(a)})}var g=GlobalEditor.FormViewManager.createIconView(a.label,a.size);g.appendTo(e);var e=g.find(".iconPicker"),h=e.find("canvas").get(0);e.click(function(){d(function(a){var b=new FileReader;b.onload=function(){f(b.result)};b.readAsDataURL(a)})});var a=b.getAndSetFuncForName(a.name),i=a[0],k=a[1];c(i())};
GlobalEditor.DescItemMap.cesiumCartesian3=function(a,b,e){var c=GlobalEditor.FormViewManager.createCesiumCartesian3View(a.label);c.appendTo(e);var a=b.getAndSetFuncForName(a.name),d=a[0],f=a[1],c=c.find("input"),g=c.eq(0),h=c.eq(1),i=c.eq(2),c=d();g.val(c.x);h.val(c.y);i.val(c.z);$.each([g,h,i],function(){this.change(function(){var a=d(),b=Number(g.val()),c=Number(h.val()),e=Number(i.val()),b=new Cesium.Cartesian3(b,c,e);GlobalEditor.HistoryManager.addEditAction("edit",a,b,function(a){f(a);g.val(a.x);
h.val(a.y);i.val(a.z)})})});this.update=function(){var a=d();g.val(a.x);h.val(a.y);i.val(a.z)}};
GlobalEditor.DescItemMap.cesiumCartesian2=function(a,b,e){var c=GlobalEditor.FormViewManager.createCesiumCartesian2View(a.label);c.appendTo(e);var a=b.getAndSetFuncForName(a.name),d=a[0],f=a[1],c=c.find("input"),g=c.eq(0),h=c.eq(1),c=d();g.val(c.x);h.val(c.y);$.each([g,h],function(){this.change(function(){var a=d(),b=Number(g.val()),c=Number(h.val()),b=new Cesium.Cartesian2(b,c);GlobalEditor.HistoryManager.addEditAction("edit",a,b,function(a){f(a);g.val(a.x);h.val(a.y)})})})};
GlobalEditor.DescItemMap.cesiumCartographic=function(a,b,e){var c=GlobalEditor.FormViewManager.createCesiumCartesian3View(a.label);c.appendTo(e);var d=c.find("label");$.each(["lng","lat","\u9ad8"],function(a){d.eq(a+1).text(this)});var a=b.getAndSetFuncForName(a.name),f=a[0],g=a[1],c=c.find("input"),h=c.eq(0),i=c.eq(1),k=c.eq(2),b=f(),c=Cesium.Math.toDegrees(b.longitude),a=Cesium.Math.toDegrees(b.latitude),b=b.height;i.val(a);h.val(c);k.val(b);$.each([i,h,k],function(){this.change(function(){var a=
f(),b=Number(h.val()),c=Number(i.val()),d=Number(k.val()),b=Cesium.Cartographic.fromDegrees(b,c,d);GlobalEditor.HistoryManager.addEditAction("edit",a,b,function(a){g(a);var b=Cesium.Math.toDegrees(a.longitude),c=Cesium.Math.toDegrees(a.latitude),a=a.height;i.val(c);h.val(b);k.val(a)})})});this.update=function(){var a=f(),b=Cesium.Math.toDegrees(a.longitude),c=Cesium.Math.toDegrees(a.latitude),a=a.height;i.val(c);h.val(b);k.val(a)}};
GlobalEditor.DescItemMap.cesiumOrientation=function(a,b,e){var c=GlobalEditor.FormViewManager.createCesiumOrientationView(a.label);c.appendTo(e);var a=b.getAndSetFuncForName(a.name),d=a[1],f=(0,a[0])(),c=c.find(".eleven.wide").children(),g=["heading","pitch","roll"],h=new GlobalEditor.Slider(c.eq(0),-360,360,f[g[0]]),i=new GlobalEditor.Slider(c.eq(1),-360,360,f[g[1]]),k=new GlobalEditor.Slider(c.eq(2),-360,360,f[g[2]]);$.each([h,i,k],function(a){this.onUpdate=function(b){var c=GlobalEditor.ObjectUtil.clone(f);
c[g[a]]=b;d(c)};this.onChange=function(b){var c=GlobalEditor.ObjectUtil.clone(f);c[g[a]]=b;GlobalEditor.HistoryManager.addEditAction("edit",f,c,function(a){h.setValue(a[g[0]]);i.setValue(a[g[1]]);k.setValue(a[g[2]]);d(a);f=a})}})};
GlobalEditor.DescItemMap.cesiumMaterial=function(a,b,e){var c=GlobalEditor.FormViewManager.createCesiumMaterialView(a.label);c.appendTo(e);var a=b.getAndSetFuncForName(a.name),d=a[0],f=a[1];c.find("button").eq(0).click(function(){var a=d();GlobalEditor.editMaterialWin.openForEditMaterial(a,function(b){GlobalEditor.HistoryManager.addEditAction("edit",a,b,function(a){f(a)})})})};
...
GlobalEditor.RectUtil.testRectCross=function(a,b){var e,c,d,f;e=a.x+a.width/2;c=a.y+a.height/2;d=b.x+b.width/2;f=b.y+b.height/2;return Math.abs(e-d)<=a.width/2+b.width/2&&Math.abs(c-f)<=a.height/2+b.height/2};GlobalEditor.RectUtil.merge=function(a,b){var e={};e.x=a.x<b.x?a.x:b.x;e.y=a.y<b.y?a.y:b.y;e.width=a.x+a.width>b.x+b.width?a.x+a.width-e.x:b.x+b.width-e.x;e.height=a.y+a.height>b.y+b.height?a.y+a.height-e.y:b.y+b.height-e.y;return e};GlobalEditor.ArrayUtil={};
GlobalEditor.ArrayUtil.equals=function(a,b){var e=!0;if(a.length!=b.length)e=!1;else for(var c=a.length,d=0;d<c;d++)if(a[d]!==b[d]){e=!1;break}return e};GlobalEditor.ArrayUtil.invert=function(a,b){var e=[];$.each(a,function(){b.indexOf(this)==-1&&e.push(this)});return e};GlobalEditor.ArrayUtil.filterRepeat=function(a){var b=[];$.each(a,function(){b.indexOf(this)==-1&&b.push(this)});return b};
GlobalEditor.ArrayUtil.getSameValue=function(a,b){b==void 0&&(b=function(a,b){return a==b});for(var e,c=0;c<a.length;c++)if(c==0)e=a[c];else if(!b(a[c],e)){e="-";break}return e};GlobalEditor.ArrayUtil.repeatValue=function(a,b){for(var e=[],c=0;c<b;c++)e.push(a);return e};GlobalEditor.ObjectUtil={};GlobalEditor.ObjectUtil.clone=function(a){return $.extend({},a)};GlobalEditor.CesiumUtil={};GlobalEditor.CesiumUtil.getPropertyValue=function(a){return a==void 0?"":a._value};
