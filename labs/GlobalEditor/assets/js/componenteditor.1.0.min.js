...
l.click(function(){l.addClass("disabled");var a;a=Number(i.dropdown("get value"));a=j[a].getValue();d.onSubmit(a);h.modal("hide")});k.hide();this.openForEditMaterial=function(a,c){this.onSubmit=c;b();if(a!=void 0){var e=f.indexOf(a.constructor.name);i.dropdown("set selected",e.toString());j[e].setValue(a)}h.modal("show")};c.getPosition=function(a){return{x:a.x,y:a.y}};c.toCartesian2=function(a){return new Cesium.Cartesian2(a.x,a.y)};this.getClassNames=function(){return f};this.isMaterialProperty=
function(a){return f.indexOf(a.constructor.name)>-1};this.encode=function(a){var b=f.indexOf(a.constructor.name);return j[b].encode(a)};this.decode=function(a){var b=f.indexOf(a.className);return j[b].decode(a)}};
