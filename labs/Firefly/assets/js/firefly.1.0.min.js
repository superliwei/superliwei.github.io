...
1);b.splice(c,0,a)},function(){a.view.insertBefore(b[d].view);b.splice(c,1);b.splice(d,0,a)})}function d(){var b=Firefly.editor.getEditorCanvas().components,c=Firefly.editor.getEditorCanvas().contentLayer,d=b.indexOf(a);Firefly.HistoryManager.add("edit",function(){a.view.insertBefore(b[d].view);b.pop();b.splice(d,0,a)},function(){a.view.appendTo(c);b.splice(d,1);b.push(a)})}function f(){var b=Firefly.editor.getEditorCanvas().components,c=Firefly.editor.getEditorCanvas().contentLayer,d=b.indexOf(a);
...
c.push(b));Firefly.editor.getEditorCanvas().add(b)});Firefly.editor.getEditorCanvas().scaleTool.setTargets(c);e=!0})}};Firefly.DragItem=function(a,b){this.view=$("<div class='dragItem'></div>");this.img=$("<img>",{src:a});this.img.appendTo(this.view);b!=void 0&&(this.view.outerWidth(b.width),this.view.outerHeight(b.height),this.img.css("max-width",b.width-10),this.img.css("max-height",b.height-10));this.getSnapshot=function(){var b=$("<div class='dragItemSnapshot'></div>");this.img.clone().appendTo(b);return b};this.setTip=function(b){this.view.attr("data-content",b);this.view.attr("data-variation","mini");this.view.popup({position:"bottom center"})}};Firefly.ColorPicker=function(a,b){var c=this;this.view=b;if(this.view==void 0)this.view=$('<div class="colorPicker"><div class="box"></div></div>');var e=this.view.find(".box");this.view.colpick({flat:!1,layout:"hex",submit:1,onChange:function(b,a){var e;if(c.onChange!=void 0)c.onChange("#"+a)},onSubmit:function(b,a){var h="#"+a;e.css("background-color",h);if(c.onSubmit!=void 0)c.onSubmit(h)},color:a});e.css("background-color",a);this.setColor=function(b){e.css("background-color",b);this.view.colpickSetColor(b)}};Firefly.Dropdown=function(a,b){var c=this;this.view=Firefly.FormViewManager.createDropdownView(a,b);this.dropdown=this.view.find(".ui.dropdown");this.fireChangeEvent=!0;this.dropdown.dropdown({onChange:function(b,a,f){if(c.onChange!=void 0&&c.fireChangeEvent)c.onChange(b,a,f)}});this.setValue=function(b){this.fireChangeEvent=!1;this.dropdown.dropdown("set selected",b.toString());this.fireChangeEvent=!0}};Firefly.EditorCanvas=function(a){var b=this;this.view=$("<div style='position:absolute;'></div>");this.view.outerWidth(960);this.view.outerHeight(540);this.view.appendTo(a);this.view.css("background-color","#FFFFFF");this.components=[];this.contentLayer=$("<div style='position:absolute;'></div>");this.contentLayer.appendTo(this.view);this.overLayer=$("<div style='position:absolute;'></div>");this.overLayer.appendTo(this.view);this.topLayer=$("<div style='position:absolute;'></div>");this.topLayer.appendTo(this.view);
this.scaleTool=new Firefly.ScaleTool;this.scaleTool.view.appendTo(this.overLayer);this.alignManager=new Firefly.AlignManager(this);this.enableAutoAlign=!0;this.descriptor=new Firefly.EditorCanvasDescriptor(this);(function(){var c=new Firefly.SelectBox;c.view.appendTo(b.topLayer);a.mousedown(function(a){function d(b){b.preventDefault();var a=b.clientX-l.x,d=b.clientY-l.y;a>=0?(c.view.offset({left:l.x}),c.view.outerWidth(a)):(c.view.offset({left:b.clientX}),c.view.outerWidth(-a));d>=0?(c.view.offset({top:l.y}),
c.view.outerHeight(d)):(c.view.offset({top:b.clientY}),c.view.outerHeight(-d))}function f(){for(var a=[],e=new Firefly.Rect(c.view.position().left,c.view.position().top,c.view.outerWidth(),c.view.outerHeight()),l=0;l<b.components.length;l++){var n=b.components[l].view.position().left,q=b.components[l].view.position().top,o=b.components[l].view.outerWidth(),s=b.components[l].view.outerHeight(),n=new Firefly.Rect(n,q,o,s);Firefly.Rect.testRectCross(e,n)&&a.push(b.components[l])}Firefly.HistoryManager.addSelectAction(h,
a);$(document).unbind("mousemove",d);$(document).unbind("mouseup",f);c.view.hide()}a.preventDefault();$(document).bind("mousemove",d);$(document).bind("mouseup",f);var h=b.scaleTool.targets.concat();b.scaleTool.setTargets([]);var l={x:a.clientX,y:a.clientY};c.view.show();c.view.outerWidth(0);c.view.outerHeight(0);c.view.offset({left:l.x,top:l.y})})})();this.add=function(a){a.view.appendTo(this.contentLayer);this.components.push(a);a.view.mousedown(function(e){function d(a){a.preventDefault();k||(k=
!0);var c={x:a.clientX-g.x,y:a.clientY-g.y},d=b.scaleTool.view.position().left+c.x,c=b.scaleTool.view.position().top+c.y;b.scaleTool.moveTo(d,c);g={x:a.clientX,y:a.clientY};b.enableAutoAlign&&b.alignManager.update()}function f(){$(document).unbind("mousemove",d);$(document).unbind("mouseup",f);b.enableAutoAlign&&b.alignManager.clear();if(k){var a=b.scaleTool.targets.concat(),c=h();Firefly.HistoryManager.addMoveAction(a,m,c)}}function h(){var a=[];$.each(b.scaleTool.targets,function(){a.push(this.view.position())});
return a}e.preventDefault();e.stopImmediatePropagation();$(document).bind("mousemove",d);$(document).bind("mouseup",f);if(b.scaleTool.targets.indexOf(a)<0){var l=b.scaleTool.targets.concat();Firefly.HistoryManager.addSelectAction(l,[a])}var g={x:e.clientX,y:e.clientY},m=h(),k=!1})};this.remove=function(a){this.components.splice(this.components.indexOf(a),1);a.view.remove()};this.toXmlNode=function(){var a=$("<div>");a.width(this.descriptor.getWidth());a.height(this.descriptor.getHeight());a.css("background-color",
this.descriptor.getColor());a.attr("ff-type","EditorCanvas");return a}};Firefly.Editor=function(a){function b(){var b=e.view.outerWidth()+1E3,f=e.view.outerHeight()+1E3,b=b>a.outerWidth()?b:a.outerWidth(),f=f>a.outerHeight()?f:a.outerHeight();c.outerWidth(b);c.outerHeight(f);b=(b-e.view.outerWidth())*0.5;f=(f-e.view.outerHeight())*0.5;e.view.css("left",b);e.view.css("top",f)}this.view=$("<div style='position:absolute;'></div>");this.view.outerWidth("100%");this.view.outerHeight("100%");this.view.css("overflow","auto");this.view.appendTo(a);var c=$("<div style='position:absolute;'></div>");
c.appendTo(this.view);var e=new Firefly.EditorCanvas(c);this.getEditorCanvas=function(){return e};this.scrollToCenter=function(){this.view.scrollTop((c.outerHeight()-a.outerHeight())*0.5);this.view.scrollLeft((c.outerWidth()-a.outerWidth())*0.5)};this.updateSize=function(){b();this.scrollToCenter()};this.testDragDrop=function(b){return(new Firefly.Rect(a.offset().left,a.offset().top,a.outerWidth(),a.outerHeight())).contain(b)};this.globalToLocalPoint=function(a){return new Firefly.Point(a.x-e.view.offset().left,
...
a=Firefly[a].create($(this));e.add(a)})};$(window).resize(b);b();this.scrollToCenter()};Firefly.ScaleTool=function(){function a(a){this.direction=a;var b={width:10,height:10},d=this,f={"left-up":"nw-resize","right-up":"ne-resize","left-down":"sw-resize","right-down":"se-resize","left-middle":"w-resize","right-middle":"e-resize","up-middle":"n-resize","down-middle":"s-resize"};this.view=$("<div class='controlBtn'><div class='circle'></div>");this.view.css("cursor",f[a]);this.onDrag=function(a,b,c){this.dragStart=a;this.dragMove=b;this.dragEnd=c};this.view.mousedown(function(h){function l(f){function l(){var a=
{width:k.width,height:k.height};a.width=k.width<0?0:k.width;a.height=k.height<0?0:k.height;var a=a.width/a.height<d.rect.width/d.rect.height?a.width/d.rect.width:a.height/d.rect.height,c=d.rect.width<d.rect.height?b.width/d.rect.width:b.height/d.rect.height,a=a<c?c:a;return{width:d.rect.width*a,height:d.rect.height*a}}function h(){var a={width:k.width,height:k.height};a.width=k.width<b.width?b.width:k.width;a.height=k.height<b.height?b.height:k.height;return a}var g={x:f.clientX-m.x,y:f.clientY-m.y},
p,r;switch(a){case "left-up":k.width=d.rect.width-g.x;k.height=d.rect.height-g.y;g=f.shiftKey?l():h();p=d.rect.width-g.width;r=d.rect.height-g.height;break;case "left-down":k.width=d.rect.width-g.x;k.height=d.rect.height+g.y;g=f.shiftKey?l():h();p=d.rect.width-g.width;r=g.height;break;case "right-up":k.width=d.rect.width+g.x;k.height=d.rect.height-g.y;g=f.shiftKey?l():h();p=g.width;r=d.rect.height-g.height;break;case "right-down":k.width=d.rect.width+g.x;k.height=d.rect.height+g.y;g=f.shiftKey?l():
h();p=g.width;r=g.height;break;case "left-middle":k.width=d.rect.width-g.x;g=h();p=d.rect.width-g.width;break;case "right-middle":k.width=d.rect.width+g.x;g=h();p=g.width;break;case "up-middle":k.height=d.rect.height-g.y;g=h();r=d.rect.height-g.height;break;case "down-middle":k.height=d.rect.height+g.y,g=h(),r=g.height}d.view.css("left",p);d.view.css("top",r);d.dragMove!=void 0&&d.dragMove(f)}function g(a){d.view.removeClass("selected");$(document).unbind("mousemove",l);$(document).unbind("mouseup",
g);$(document.body).css("cursor","auto");d.dragEnd!=void 0&&d.dragEnd(a)}h.preventDefault();h.stopImmediatePropagation();d.view.addClass("selected");$(document).bind("mousemove",l);$(document).bind("mouseup",g);$(document.body).css("cursor",f[a]);var m={x:h.clientX,y:h.clientY},k={width:d.rect.width,height:d.rect.height};d.dragStart!=void 0&&d.dragStart(h)});this.setPosForRect=function(b){this.rect=b;var d,e;switch(a){case "left-up":e=d=0;break;case "right-up":d=b.width;e=0;break;case "left-down":d=
0;e=b.height;break;case "right-down":d=b.width;e=b.height;break;case "left-middle":d=0;e=b.height*0.5;break;case "right-middle":d=b.width;e=b.height*0.5;break;case "up-middle":d=b.width*0.5;e=0;break;case "down-middle":d=b.width*0.5,e=b.height}this.view.css("left",d);this.view.css("top",e)}}var b=this;this.targets=[];this.view=$("<div class='scaleTool'></div>");this.content=$('<div style="position:absolute;"></div>');this.content.appendTo(this.view);this.box=$("<div class='box'></div>");this.box.appendTo(this.content);
this.descriptor=new Firefly.MultipleSelectDescriptor;this.controlBtns=function(){function c(){n=!1;g=new Firefly.Rect(b.view.position().left,b.view.position().top,b.box.outerWidth(),b.box.outerHeight());k=b.getInitLayouts(g)}function e(){if(!n){n=!0;for(var a=0;a<b.targets.length;a++){var c=b.targets[a];c.getAutoSize()&&(!c.lockWidth||!c.lockHeight)&&c.setAutoSize(!1)}}c=this.view.position().left;a=this.view.position().top;switch(this.direction){case "left-up":b.controlBtns["left-middle"].view.css("left",
c);b.controlBtns["left-down"].view.css("left",c);c=(b.controlBtns["right-middle"].view.position().left-c)*0.5+c;b.controlBtns["up-middle"].view.css("left",c);b.controlBtns["down-middle"].view.css("left",c);var d=(b.controlBtns["down-middle"].view.position().top-a)*0.5+a;b.controlBtns["left-middle"].view.css("top",d);b.controlBtns["right-middle"].view.css("top",d);b.controlBtns["up-middle"].view.css("top",a);b.controlBtns["right-up"].view.css("top",a);break;case "right-up":b.controlBtns["left-up"].view.css("top",
a);b.controlBtns["up-middle"].view.css("top",a);b.controlBtns["right-middle"].view.css("left",c);b.controlBtns["right-down"].view.css("left",c);c*=0.5;d=(b.controlBtns["down-middle"].view.position().top-a)*0.5+a;b.controlBtns["up-middle"].view.css("left",c);b.controlBtns["down-middle"].view.css("left",c);b.controlBtns["left-middle"].view.css("top",d);b.controlBtns["right-middle"].view.css("top",d);break;case "left-down":b.controlBtns["left-up"].view.css("left",c);b.controlBtns["left-middle"].view.css("left",
c);b.controlBtns["down-middle"].view.css("top",a);b.controlBtns["right-down"].view.css("top",a);c=(b.controlBtns["right-middle"].view.position().left-c)*0.5+c;d=a*0.5;b.controlBtns["up-middle"].view.css("left",c);b.controlBtns["down-middle"].view.css("left",c);b.controlBtns["left-middle"].view.css("top",d);b.controlBtns["right-middle"].view.css("top",d);break;case "right-down":b.controlBtns["right-up"].view.css("left",c);b.controlBtns["right-middle"].view.css("left",c);b.controlBtns["left-down"].view.css("top",
a);b.controlBtns["down-middle"].view.css("top",a);c*=0.5;d=a*0.5;b.controlBtns["up-middle"].view.css("left",c);b.controlBtns["down-middle"].view.css("left",c);b.controlBtns["left-middle"].view.css("top",d);b.controlBtns["right-middle"].view.css("top",d);break;case "left-middle":b.controlBtns["left-up"].view.css("left",c);b.controlBtns["left-down"].view.css("left",c);c=(b.controlBtns["right-middle"].view.position().left-c)*0.5+c;b.controlBtns["up-middle"].view.css("left",c);b.controlBtns["down-middle"].view.css("left",
c);break;case "right-middle":b.controlBtns["right-up"].view.css("left",c);b.controlBtns["right-down"].view.css("left",c);c*=0.5;b.controlBtns["up-middle"].view.css("left",c);b.controlBtns["down-middle"].view.css("left",c);break;case "up-middle":b.controlBtns["left-up"].view.css("top",a);b.controlBtns["right-up"].view.css("top",a);d=(b.controlBtns["down-middle"].view.position().top-a)*0.5+a;b.controlBtns["left-middle"].view.css("top",d);b.controlBtns["right-middle"].view.css("top",d);break;case "down-middle":b.controlBtns["left-down"].view.css("top",
a),b.controlBtns["right-down"].view.css("top",a),d=a*0.5,b.controlBtns["left-middle"].view.css("top",d),b.controlBtns["right-middle"].view.css("top",d)}a=new Firefly.Rect(b.controlBtns["left-up"].view.position().left,b.controlBtns["left-up"].view.position().top,b.controlBtns["right-up"].view.position().left-b.controlBtns["left-up"].view.position().left,b.controlBtns["left-down"].view.position().top-b.controlBtns["left-up"].view.position().top);b.box.css("left",a.x);b.box.css("top",a.y);b.box.outerWidth(a.width);
b.box.outerHeight(a.height);m=new Firefly.Rect(b.view.position().left+a.x,b.view.position().top+a.y,a.width,a.height);b.resizeTargets(k,m);b.descriptor.update(m)}function d(){b.view.offset(b.box.offset());b.box.css("left",0);b.box.css("top",0);b.update();n&&Firefly.HistoryManager.addScaleSelectedComponentsAction(g,m)}for(var f={},h=["left-up","right-up","left-down","right-down","left-middle","right-middle","up-middle","down-middle"],l=h.length,g,m,k,n,q=0;q<l;q++){var o=new a(h[q]);f[h[q]]=o;o.view.appendTo(b.content);
o.onDrag(c,e,d)}return f}();this.view.hide();this.setTargets=function(a){this.targets=a;a.length==0?this.view.hide():(this.view.show(),this.update());Firefly.propertiesPanel.setTargets(a)};this.update=function(){if(this.targets.length!=0){var a=this.getRectOfTargets();this.view.css("left",a.x);this.view.css("top",a.y);this.box.outerWidth(a.width);this.box.outerHeight(a.height);(function(){var e={none:[],all:["left-up","right-up","left-down","right-down","left-middle","right-middle","up-middle","down-middle"],
width:["left-middle","right-middle"],height:["up-middle","down-middle"]},d=e.all;if(b.targets.length==1){var f=b.targets[0];if(f.getAutoSize()||f.lockWidth&&f.lockHeight)d=e.none;else if(f.lockWidth&&!f.lockHeight)d=e.height;else if(!f.lockWidth&&f.lockHeight)d=e.width}for(direction in b.controlBtns)e=b.controlBtns[direction],e.setPosForRect(a),d.indexOf(direction)>-1?(e.view.css("pointer-events","auto"),e.view.css("opacity",1)):(e.view.css("pointer-events","none"),e.view.css("opacity",0))})()}};
this.getRectOfTargets=function(){var a,b,d,f;f=this.targets[0];a=f.view.position().left;b=f.view.position().top;d=a+f.view.outerWidth();f=b+f.view.outerHeight();if(this.targets.length>1)for(var h=1;h<this.targets.length;h++){var l=this.targets[h].view.position().left,g=this.targets[h].view.position().top,m=l+this.targets[h].view.outerWidth(),k=g+this.targets[h].view.outerHeight();a=a>l?l:a;b=b>g?g:b;d=d<m?m:d;f=f<k?k:f}return new Firefly.Rect(a,b,d-a,f-b)};this.moveTo=function(a,b){var d={};if(a!=
void 0)d.x=a-this.view.position().left,this.view.css("left",a);if(b!=void 0)d.y=b-this.view.position().top,this.view.css("top",b);for(var f=0;f<this.targets.length;f++){var h,l;a!=void 0&&(h=this.targets[f].view.position().left+d.x);b!=void 0&&(l=this.targets[f].view.position().top+d.y);this.targets[f].moveTo(h,l)}this.descriptor.update()};this.resizeTo=function(a,b){var a=a==void 0?this.box.outerWidth():a,b=b==void 0?this.box.outerHeight():b,d=new Firefly.Rect(this.view.position().left,this.view.position().top,
this.box.outerWidth(),this.box.outerHeight()),f=new Firefly.Rect(d.x,d.y,a,b);this.resizeTargets(d,f);this.box.outerWidth(a);this.box.outerHeight(b)};this.getInitLayouts=function(a){for(var e=[],d=0;d<this.targets.length;d++){var f=b.targets[d];e.push({x:(f.view.position().left-a.x)/a.width,y:(f.view.position().top-a.y)/a.height,w:f.view.outerWidth()/a.width,h:f.view.outerHeight()/a.height,left:f.view.position().left-a.x,right:a.x+a.width-f.view.position().left-f.view.outerWidth(),top:f.view.position().top-
a.y,down:a.y+a.height-f.view.position().top-f.view.outerHeight()})}return e};this.resizeTargets=function(a,e){var d;d=a instanceof Firefly.Rect?this.getInitLayouts(a):a;for(var f=0;f<this.targets.length;f++){var h=b.targets[f],l=d[f],g=e.x+e.width*l.x,m=e.y+e.height*l.y,k=e.width*l.w,n=e.height*l.h;h.lockWidth&&(g=l.left==0?e.x:g,g=l.right==0?e.x+e.width-h.view.outerWidth():g,g=g+h.view.outerWidth()<e.x+e.width?g:e.x+e.width-h.view.outerWidth(),g=g>e.x?g:e.x);h.lockHeight&&(m=l.top==0?e.y:m,m=l.down==
0?e.y+e.height-h.view.outerHeight():m,m=m+h.view.outerHeight()<e.y+e.height?m:e.y+e.height-h.view.outerHeight(),m=m>e.y?m:e.y);h.moveTo(g,m);h.resizeTo(k,n)}};this.hAlignTo=function(a){var b={x:a-this.content.position().left};this.content.css("left",a);for(var d=0;d<this.targets.length;d++)a=this.targets[d].view.position().left+b.x,this.targets[d].moveTo(a,void 0)};this.vAlignTo=function(a){var b={y:a-this.content.position().top};this.content.css("top",a);for(var d=0;d<this.targets.length;d++)a=this.targets[d].view.position().top+
b.y,this.targets[d].moveTo(void 0,a)};this.reset=function(){var a=this.view.position().left+this.content.position().left,b=this.view.position().top+this.content.position().top;this.view.css("left",a);this.content.css("left",0);this.view.css("top",b);this.content.css("top",0)}};Firefly.AlignManager=function(a){function b(){e.lineX!=void 0&&e.lineX.remove()}function c(){e.lineY!=void 0&&e.lineY.remove()}var e=this;this.fix=5;this.update=function(){var d=a.scaleTool.view.position().left,f=a.scaleTool.box.outerWidth(),f=[d,d+f*0.5,d+f],d=a.view.width(),d=[0,d*0.5,d];for(i=0;i<a.components.length;i++)if(a.scaleTool.targets.indexOf(a.components[i])==-1)var h=a.components[i].view.position().left,l=a.components[i].view.outerWidth(),d=d.concat([h,h+l*0.5,h+l]);var g;for(i=0;i<f.length;i++){for(j=
0;j<d.length;j++)if(Math.abs(f[i]-d[j])<e.fix){g=[i,j];break}if(g!=void 0)break}if(g!=void 0){f=d[g[1]];if(e.lineX==void 0)e.lineX=$("<div style='position:absolute;border-left:dashed 1px #FF0000;width:0px;'></div>");e.lineX.css("height",a.view.height());e.lineX.appendTo(a.overLayer);e.lineX.css("left",f);f=g[0];g=d[g[1]];var m;f==0?m=g-a.scaleTool.view.position().left:f==1?m=g-a.scaleTool.view.position().left-a.scaleTool.box.outerWidth()*0.5:f==2&&(m=g-a.scaleTool.view.position().left-a.scaleTool.box.outerWidth());
a.scaleTool.hAlignTo(m)}else b(),a.scaleTool.hAlignTo(0);m=a.scaleTool.view.position().top;g=a.scaleTool.box.outerHeight();g=[m,m+g*0.5,m+g];m=a.view.height();m=[0,m*0.5,m];for(i=0;i<a.components.length;i++)if(a.scaleTool.targets.indexOf(a.components[i])==-1)d=a.components[i].view.position().top,f=a.components[i].view.outerHeight(),m=m.concat([d,d+f*0.5,d+f]);var k;for(i=0;i<g.length;i++){for(j=0;j<m.length;j++)if(Math.abs(g[i]-m[j])<e.fix){k=[i,j];break}if(k!=void 0)break}if(k!=void 0){g=m[k[1]];
if(e.lineY==void 0)e.lineY=$("<div style='position:absolute;border-top:dashed 1px #FF0000;height:0px;'></div>");e.lineY.css("width",a.view.width());e.lineY.appendTo(a.overLayer);e.lineY.css("top",g);g=k[0];k=m[k[1]];var n;g==0?n=k-a.scaleTool.view.position().top:g==1?n=k-a.scaleTool.view.position().top-a.scaleTool.box.outerHeight()*0.5:g==2&&(n=k-a.scaleTool.view.position().top-a.scaleTool.box.outerHeight());a.scaleTool.vAlignTo(n)}else c(),a.scaleTool.vAlignTo(0)};this.clear=function(){b();c();a.scaleTool.reset()}};Firefly.SelectBox=function(){this.view=$('<div style="position:absolute;border: solid 1px #0000ff;"></div>');this.view.hide()};Firefly.ResourcePanel=function(){function a(a){function c(c){var f=a.getIconUrl(h[c]),m=new Firefly.DragItem(f,a.item);m.view.appendTo(d);m.view.mousedown(function(){function d(a){a.preventDefault();g||(g=!0,o=m.getSnapshot(),o.offset({left:a.clientX,top:a.clientY}),o.appendTo("body"));o!=void 0&&o.offset({left:a.clientX,top:a.clientY})}function f(){o!=void 0&&(a.onSnapshotDrop(h[c],o),o.remove());$(document).unbind("mousemove",d);$(document).unbind("mouseup",f)}e(m);$(document).bind("mousemove",
d);$(document).bind("mouseup",f);var g=!1,o});if(a.onItemCreate!=void 0)a.onItemCreate(h[c],m)}function e(a){f!=void 0&&f.view.removeClass("selected");f=a;a.view.addClass("selected")}var d=a.view,f,h;$.getJSON(a.listUrl,function(d){h=d;for(var d=h.length,f=0;f<d;f++)new c(f);if(a.onItemsCreateComplete!=void 0)a.onItemsCreateComplete()})}new function(){var b={view:$("#componentContainer"),listUrl:"componentLib/list.json",getIconUrl:function(a){return"componentLib/"+a+"/icon.png"},onSnapshotDrop:function(a,
...
a.length>0&&a.each(function(){$(this).data("colpick").clear();$(this).remove()});this.header.text("");this.form.empty();this.layoutPanel.empty()};this.setTargets([])};Firefly.HistoryPanel=function(){function a(){var a=Firefly.HistoryManager.items.length,b=Firefly.HistoryManager.idx;a==0?(e.addClass("disabled"),d.addClass("disabled"),f.addClass("disabled")):(f.removeClass("disabled"),b==a-1?(d.addClass("disabled"),e.removeClass("disabled")):(b==-1?e.addClass("disabled"):e.removeClass("disabled"),d.removeClass("disabled")));h.empty();a=Firefly.HistoryManager.items.length;if(a==0)h.text("\u6ca1\u6709\u4efb\u4f55\u5386\u53f2\u8bb0\u5f55");else for(var b=[],c=Firefly.HistoryManager.idx,
k=0;k<a;k++){var n=new Firefly.HistoryItemView(Firefly.HistoryManager.items[k]);n.view.prependTo(h);b.push(n);k==c&&b[k].view.addClass("active")}}var b=$("#historyPanel"),c=b.find(".ui.tab.segment .menu .item"),e=c.eq(0),d=c.eq(1),f=c.eq(2),h=b.find(".ui.tab.segment .list");a();e.click(function(){Firefly.HistoryManager.undo()});d.click(function(){Firefly.HistoryManager.redo()});f.click(function(){Firefly.HistoryManager.removeAll()});$(document).bind(Firefly.HistoryManager.UPDATE,a);this.getUndoAble=
...
history:$("#historyPanel")};$.each(d,function(){$(this).css("display","none")});this.selectValue=function(a){c!=void 0&&d[c].css("display","none");c=a;d[c].css("display","block")};this.getSelectedValue=function(){return c};this.getMenu=function(){return a};this.selectValue("properties");a.dropdown("set selected",c);a.dropdown({onChange:function(a){b.selectValue(a)}})}(this.view.find(".right.menu .ui.dropdown").eq(0));this.getItems=function(){return e}};Firefly.SettingWin=function(a){function b(a,b){this.setDisplay=function(c){a.css("display",c?"block":"none");b.css("display",c?"block":"none")}}var c=this;this.view=$(a);var e=this.view.find(".ui.menu .item"),a=this.view.find(".content").eq(0).children(),d=this.view.find(".actions").eq(0).children(),f=[new function(a,c){b.call(this,a,c);var d=this,e=a.find(".ui.checkbox"),f=a.find("input").eq(1),h=a.find("input").eq(2),o=c.find("button").eq(0);this.getEnableAlign=function(){return Firefly.editor.getEditorCanvas().enableAutoAlign};
...
f.val(this.getDis());h.val(this.getMaxHistory())};this.initValues();e.checkbox({onChange:function(){var a=e.checkbox("is checked");f.parent()[a?"removeClass":"addClass"]("disabled")}});o.click(function(){var a=e.checkbox("is checked");d.setEnableAlign(a);d.setDis(f.val());d.setMaxHistory(h.val())})}(a.eq(0),d.eq(0)),new function(a,c){b.call(this,a,c);var d='<table class="ui celled table">';d+=" <thead><tr>";d+="  <th>\u5feb\u6377\u952e</th>";d+="  <th>\u8bf4\u660e</th>";d+=" </tr></thead>";d+=" <tbody>";
...
var h=this.setDisplay;this.setDisplay=function(b){h.call(this,b);a.parent().css("background-color",b?"#000000":"#ffffff");b?this.playMusic():this.stopMusic()};this.playMusic=function(){f.hasClass("red")&&e.get(0).play()};this.stopMusic=function(){e.get(0).pause();e.get(0).currentTime=0};var o='<div style="color:#999999;text-align: center;">'+Base64.decode("Qmxhbms=")+"</div>";o+='<div style="color:#999999;text-align: center;">'+Base64.decode("aGVyb2JsYW5rQGdtYWlsLmNvbQ==")+"</div>";$(o).appendTo(a)}(a.eq(2),
d.eq(2))],h=-1;e.each(function(a){$(this).click(function(){c.selectTabIdx(a)})});this.view.modal({onHide:function(){f[2].stopMusic()}});this.show=function(a){f[0].initValues();this.selectTabIdx(a);this.view.modal("show")};this.selectTabIdx=function(a){h>-1&&(e.eq(h).removeClass("active blue"),f[h].setDisplay(!1));e.eq(a).addClass("active blue");h=a;f[a].setDisplay(!0);this.view.modal("refresh")}};Firefly.OpenWin=function(a){var b=this;this.view=$(a);var c=this.view.find("textarea").eq(0),e=this.view.find(".actions button").eq(0),d=this.view.find(".message");d.find(".close").click(function(){d.transition("scale out")});e.click(function(){c.closest(".field").removeClass("error");d.transition("hide");var a=c.val();Firefly.editor.checkSource(a)?(Firefly.editor.importSource(a),e.addClass("loading disabled"),b.view.modal("hide")):(d.transition("scale in"),c.closest(".field").addClass("error"))});
...
this.getColor=function(){var b=a.view.css("background-color");return Firefly.Color.getCSSHexColor(b)};this.setColor=function(b){a.view.css("background-color",b)}};Firefly.ComponentBaseDescriptor=function(a){var b=this;this.title="\u57fa\u672c\u7ec4\u4ef6";this.initComplete=!1;this.init=function(a){this.createChildren(a);this.initComplete=!0;this.update()};this.createChildren=function(c){c.header.text(this.title);var e=c.form,d=Firefly.FormViewManager.createPositionView();d.appendTo(e);var f=Firefly.FormViewManager.createSizeView();f.appendTo(e);Firefly.FormViewManager.createHline().appendTo(e);var h=Firefly.FormViewManager.createCheckBoxView("\u81ea\u52a8\u5927\u5c0f");
h.appendTo(e);e=d.find("input");this.xInput=e.eq(0);this.yInput=e.eq(1);f=f.find("input");this.widthInput=f.eq(0);this.heightInput=f.eq(1);this.autoSizeCheckBox=h.find(".ui.checkbox").eq(0);a.lockWidth&&a.lockHeight&&h.addClass("disabled");this.xInput.change(function(){var a=b.getX(),c=b.xInput.val();Firefly.HistoryManager.addPropertiesEditAction(a,c,function(a){b.setX(a);b.xInput.val(a)})});this.yInput.change(function(){var a=b.getY(),c=b.yInput.val();Firefly.HistoryManager.addPropertiesEditAction(a,
...
Firefly.HistoryManager.addPropertiesEditAction(a,c,function(a){b.setAutoSize(a);b.autoSizeCheckBox.checkbox(a?"set checked":"set unchecked")})}});Firefly.FormViewManager.createHeaderView("\u53e0\u653e\u987a\u5e8f").appendTo(c.layoutPanel);h=Firefly.FormViewManager.createLayoutView();h.appendTo(c.layoutPanel);c=h.find("button");c.popup();c.each(function(a){$(this).click(function(){switch(a){case 0:b.goTopLayer();break;case 1:b.goBottomLayer();break;case 2:b.goUpLayer();break;case 3:b.goDownLayer()}})})};
...
Firefly.FormViewManager.createTextHAlignView=function(a){return $('<div class="inline fields">\t<div class="five wide field">\t\t<label>'+a+'</label>\t</div>\t<div class="eleven wide field">\t\t<div class="ui icon basic buttons">\t\t\t<button class="ui button"><i class="align left icon"></i></button>\t\t\t<button class="ui button"><i class="align center icon"></i></button>\t\t\t<button class="ui button"><i class="align right icon"></i></button>\t\t</div>\t</div></div>')};Firefly.Rect=function(a,b,c,e){this.x=a;this.y=b;this.width=c;this.height=e;this.contain=function(a){return a.x>=this.x&&a.x<=this.x+this.width&&a.y>=this.y&&a.y<=this.y+this.height}};Firefly.Rect.testRectCross=function(a,b){var c,e,d,f;c=a.x+a.width/2;e=a.y+a.height/2;d=b.x+b.width/2;f=b.y+b.height/2;return Math.abs(c-d)<=a.width/2+b.width/2&&Math.abs(e-f)<=a.height/2+b.height/2};Firefly.Point=function(a,b){this.x=a;this.y=b};Firefly.Color={};Firefly.Color.randomColor=function(){var a=Math.floor(Math.random()*16777215).toString(16);return a.length==6?"#"+a:Firefly.Color.randomColor()};Firefly.Color.getCSSHexColor=function(a){if(a.indexOf("rgb")>-1){var b=a,b=a.indexOf("rgba")>-1?b.substr(5,b.length-6):b.substr(4,b.length-5),a=b.split(","),a={r:parseInt(a[0]),g:parseInt(a[1]),b:parseInt(a[2])};return"#"+$.colpick.rgbToHex(a)}else return a};Firefly.ArrayUtil={};Firefly.ArrayUtil.equals=function(a,b){var c=!0;if(a.length!=b.length)c=!1;else for(var e=a.length,d=0;d<e;d++)if(a[d]!==b[d]){c=!1;break}return c};Firefly.MainLayout=function(a){function b(){e.outerWidth(k);f.outerWidth(n);var a=$(window).width()-k-n-h.outerWidth()-l.outerWidth();d.outerWidth(a);var b=$(window).height()-$("#topMenu").outerHeight();e.outerHeight(b);f.outerHeight(b);d.outerHeight(b);d.css("left",k+h.outerWidth());f.css("left",k+a+h.outerWidth()+l.outerWidth());h.outerHeight(b);l.outerHeight(b);h.css("left",k);l.css("left",k+a+h.outerWidth());a=b-c.view.find(".menu").outerHeight()-10;q.outerHeight(a);o.outerHeight(a-s.outerHeight());
p.outerHeight(a)}var c=this;this.view=$(a);var e=this.view.find("#leftBox"),d=this.view.find("#centerBox"),f=this.view.find("#rightBox"),a=this.view.find(".vDivide"),h=a.eq(0),l=a.eq(1),g=h.find(".handle"),m=l.find(".handle"),k=322,n=320;g.click(function(){k=k==322?0:322;b()});m.click(function(){n=n==320?0:320;b()});e.css("position","absolute");d.css("position","absolute");f.css("position","absolute");this.view.find(".menu .item").tab();this.view.find(".segment").css("overflow","auto");var q=this.view.find("#resourcePanel .segment");
q.css("padding",5);var o=this.view.find("#propertiesPanel .segment"),s=this.view.find("#propertiesPanel #header"),p=this.view.find("#historyPanel .segment");p.css("padding",5);$(window).resize(b);b();this.toggleLeft=function(){g.trigger("click")};this.toggleRight=function(){m.trigger("click")}};
