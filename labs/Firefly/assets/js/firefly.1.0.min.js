...
Firefly.editor.getEditorCanvas().scaleTool.setTargets(Firefly.Clipboard.targets);Firefly.Clipboard.targets=[];Firefly.Clipboard.isCut=!1})}else if(this.targets.length>0&&!this.isCut){var c=[],e=!1,b=Firefly.editor.getEditorCanvas().scaleTool.targets.concat();Firefly.HistoryManager.add("paste",function(){$.each(c,function(){Firefly.editor.getEditorCanvas().remove(this)});Firefly.editor.getEditorCanvas().scaleTool.setTargets(b)},function(){$.each(Firefly.Clipboard.targets,function(a){e?a=c[a]:(a=this.clone(),
c.push(a));Firefly.editor.getEditorCanvas().add(a)});Firefly.editor.getEditorCanvas().scaleTool.setTargets(c);e=!0})}};Firefly.DragItem=function(a,b){this.view=$("<div class='dragItem'></div>");this.img=$("<img>",{src:a});this.img.appendTo(this.view);b!=void 0&&(this.view.outerWidth(b.width),this.view.outerHeight(b.height),this.img.css("max-width",b.width-10),this.img.css("max-height",b.height-10));this.getSnapshot=function(){var a=$("<div class='dragItemSnapshot'></div>");this.img.clone().appendTo(a);return a};this.setTip=function(a){this.view.attr("data-content",a);this.view.attr("data-variation","mini");this.view.popup({position:"bottom center"})}};Firefly.ColorPicker=function(a,b){var c=this;this.view=b;if(this.view==void 0)this.view=$('<div class="colorPicker"><div class="box"></div></div>');var e=this.view.find(".box");this.view.colpick({flat:!1,layout:"hex",submit:1,onChange:function(a,b){var e;if(c.onChange!=void 0)c.onChange("#"+b)},onSubmit:function(a,b){var h="#"+b;e.css("background-color",h);if(c.onSubmit!=void 0)c.onSubmit(h)},color:a});e.css("background-color",a);this.setColor=function(a){e.css("background-color",a);this.view.colpickSetColor(a)}};Firefly.Dropdown=function(a,b){var c=this;this.view=Firefly.FormViewManager.createDropdownView(a,b);this.dropdown=this.view.find(".ui.dropdown");this.fireChangeEvent=!0;this.dropdown.dropdown({onChange:function(a,b,f){if(c.onChange!=void 0&&c.fireChangeEvent)c.onChange(a,b,f)}});this.setValue=function(a){this.fireChangeEvent=!1;this.dropdown.dropdown("set selected",a.toString());this.fireChangeEvent=!0}};Firefly.EditorCanvas=function(a){var b=this;this.view=$("<div style='position:absolute;'></div>");this.view.outerWidth(960);this.view.outerHeight(540);this.view.appendTo(a);this.view.css("background-color","#FFFFFF");this.components=[];this.contentLayer=$("<div style='position:absolute;'></div>");this.contentLayer.appendTo(this.view);this.overLayer=$("<div style='position:absolute;'></div>");this.overLayer.appendTo(this.view);this.topLayer=$("<div style='position:absolute;'></div>");this.topLayer.appendTo(this.view);
this.scaleTool=new Firefly.ScaleTool;this.scaleTool.view.appendTo(this.overLayer);this.alignManager=new Firefly.AlignManager(this);this.enableAutoAlign=!0;this.descriptor=new Firefly.EditorCanvasDescriptor(this);(function(){var c=new Firefly.SelectBox;c.view.appendTo(b.topLayer);a.mousedown(function(a){function d(a){a.preventDefault();var b=a.clientX-l.x,d=a.clientY-l.y;b>=0?(c.view.offset({left:l.x}),c.view.outerWidth(b)):(c.view.offset({left:a.clientX}),c.view.outerWidth(-b));d>=0?(c.view.offset({top:l.y}),
c.view.outerHeight(d)):(c.view.offset({top:a.clientY}),c.view.outerHeight(-d))}function f(){for(var a=[],e=new Firefly.Rect(c.view.position().left,c.view.position().top,c.view.outerWidth(),c.view.outerHeight()),l=0;l<b.components.length;l++){var n=b.components[l].view.position().left,q=b.components[l].view.position().top,o=b.components[l].view.outerWidth(),s=b.components[l].view.outerHeight(),n=new Firefly.Rect(n,q,o,s);Firefly.Rect.testRectCross(e,n)&&a.push(b.components[l])}Firefly.HistoryManager.addSelectAction(h,
