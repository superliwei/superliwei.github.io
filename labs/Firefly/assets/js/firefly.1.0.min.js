...
"properties";break;case "\u5386\u53f2\u8bb0\u5f55":a=Firefly.topMenu.panelMenuController.getSelectedValue()!="history";break;case "\u7ec4\u6210\u7fa4\u7ec4":a=Firefly.editor.getEditorCanvas().scaleTool.targets.length>1;break;case "\u89e3\u6563\u7fa4\u7ec4":a=Firefly.editor.getEditorCanvas().scaleTool.targets.length==1&&Firefly.editor.getEditorCanvas().scaleTool.targets[0]instanceof Firefly.Group}this.setEnabled(a)};this.setEnabled=function(b){b?a.removeClass("disabled"):a.addClass("disabled")}}this.view=
