...
c.push(a));Firefly.editor.getEditorCanvas().add(a)});Firefly.editor.getEditorCanvas().scaleTool.setTargets(c);e=!0})}};Firefly.DragItem=function(b,a){this.view=$("<div class='dragItem'></div>");this.img=$("<img>",{src:b,ondragstart:"return false;"});this.img.appendTo(this.view);a!=void 0&&(this.view.outerWidth(a.width),this.view.outerHeight(a.height),this.img.css("max-width",a.width-10),this.img.css("max-height",a.height-10));this.getSnapshot=function(){var a=$("<div class='dragItemSnapshot'></div>");this.img.clone().appendTo(a);return a};this.setTip=function(a){this.view.attr("data-content",a);this.view.attr("data-variation",
"mini");this.view.popup({position:"bottom center"})}};Firefly.ColorPicker=function(b,a){var c=this;this.view=a;if(this.view==void 0)this.view=$('<div class="colorPicker"><div class="box"></div></div>');var e=this.view.find(".box");this.view.colpick({flat:!1,layout:"hex",submit:1,onChange:function(a,b){var e;if(c.onChange!=void 0)c.onChange("#"+b)},onSubmit:function(a,b){var f="#"+b;e.css("background-color",f);if(c.onSubmit!=void 0)c.onSubmit(f)},color:b});e.css("background-color",b);this.setColor=function(a){e.css("background-color",a);this.view.colpickSetColor(a)}};Firefly.Dropdown=function(b,a){var c=this;this.view=Firefly.FormViewManager.createDropdownView(b,a);this.dropdown=this.view.find(".ui.dropdown");this.fireChangeEvent=!0;this.dropdown.dropdown({onChange:function(a,d,b){if(c.onChange!=void 0&&c.fireChangeEvent)c.onChange(a,d,b)}});this.setValue=function(a){this.fireChangeEvent=!1;this.dropdown.dropdown("set selected",a.toString());this.fireChangeEvent=!0}};Firefly.EditorCanvas=function(b){var a=this;this.size={width:960,height:540};this.scale=1;var c=[0.06,0.12,0.25,0.5,0.66,1,2,3,4,8,16,32,64],e=5;this.view=$("<div style='position:absolute;'></div>");this.view.outerWidth(this.size.width);this.view.outerHeight(this.size.height);this.view.appendTo(b);this.view.css("background-color","#FFFFFF");this.components=[];this.contentLayer=$("<div style='position:absolute;'></div>");this.contentLayer.appendTo(this.view);this.overLayer=$("<div style='position:absolute;'></div>");
this.overLayer.appendTo(this.view);this.topLayer=$("<div style='position:absolute;'></div>");this.topLayer.appendTo(this.view);this.scaleTool=new Firefly.ScaleTool(this);this.scaleTool.view.appendTo(this.overLayer);this.alignManager=new Firefly.AlignManager(this);this.enableAutoAlign=!0;this.descriptor=new Firefly.EditorCanvasDescriptor(this);(function(){var d=new Firefly.SelectBox;d.view.appendTo(a.topLayer);b.mousedown(function(c){function b(a){a.preventDefault();var c=a.clientX-l.x,g=a.clientY-
l.y;c>=0?(d.view.offset({left:l.x}),d.view.outerWidth(c)):(d.view.offset({left:a.clientX}),d.view.outerWidth(-c));g>=0?(d.view.offset({top:l.y}),d.view.outerHeight(g)):(d.view.offset({top:a.clientY}),d.view.outerHeight(-g))}function e(){for(var c=[],g=new Firefly.Rect(d.view.position().left,d.view.position().top,d.view.outerWidth(),d.view.outerHeight()),l=0;l<a.components.length;l++){var p=a.components[l].view.position().left,s=a.components[l].view.position().top,t=a.components[l].view.outerWidth()*
a.scale,q=a.components[l].view.outerHeight()*a.scale,p=new Firefly.Rect(p,s,t,q);Firefly.Rect.testRectCross(g,p)&&c.push(a.components[l])}Firefly.HistoryManager.addSelectAction(k,c);$(document).unbind("mousemove",b);$(document).unbind("mouseup",e);d.view.hide()}c.preventDefault();$(document).bind("mousemove",b);$(document).bind("mouseup",e);var k=a.scaleTool.targets.concat();a.scaleTool.setTargets([]);var l={x:c.clientX,y:c.clientY};d.view.show();d.view.outerWidth(0);d.view.outerHeight(0);d.view.offset({left:l.x,
top:l.y})})})();this.add=function(c){c.view.appendTo(this.contentLayer);this.components.push(c);c.view.mousedown(function(b){function e(c){c.preventDefault();p||(p=!0);var d={x:c.clientX-m.client.x,y:c.clientY-m.client.y},c=m.scaleToolPos.x+d.x,d=m.scaleToolPos.y+d.y;if(a.enableAutoAlign)d=a.alignManager.update({x:c,y:d}),c=d.x,d=d.y;a.scaleTool.moveTo(c,d)}function h(){$(document).unbind("mousemove",e);$(document).unbind("mouseup",h);a.enableAutoAlign&&a.alignManager.clear();if(p){var c=a.scaleTool.targets.concat(),
d=k();Firefly.HistoryManager.addMoveAction(c,o,d)}}function k(){var c=[];$.each(a.scaleTool.targets,function(){var a=parseInt(this.view.css("left")),d=parseInt(this.view.css("top"));c.push({left:a,top:d})});return c}b.preventDefault();b.stopImmediatePropagation();var l=a.scaleTool.targets.concat(),n;if(a.scaleTool.targets.indexOf(c)<0)b.shiftKey?(n=l.concat(),n.push(c)):n=[c],Firefly.HistoryManager.addSelectAction(l,n);else if(b.shiftKey){n=l.concat();b=n.indexOf(c);n.splice(b,1);Firefly.HistoryManager.addSelectAction(l,
...
q,r;switch(a){case "left-up":m.width=b.rect.width-k.x;m.height=b.rect.height-k.y;k=h.shiftKey?f():l();q=b.rect.width-k.width;r=b.rect.height-k.height;break;case "left-down":m.width=b.rect.width-k.x;m.height=b.rect.height+k.y;k=h.shiftKey?f():l();q=b.rect.width-k.width;r=k.height;break;case "right-up":m.width=b.rect.width+k.x;m.height=b.rect.height-k.y;k=h.shiftKey?f():l();q=k.width;r=b.rect.height-k.height;break;case "right-down":m.width=b.rect.width+k.x;m.height=b.rect.height+k.y;k=h.shiftKey?f():
l();q=k.width;r=k.height;break;case "left-middle":m.width=b.rect.width-k.x;k=l();q=b.rect.width-k.width;break;case "right-middle":m.width=b.rect.width+k.x;k=l();q=k.width;break;case "up-middle":m.height=b.rect.height-k.y;k=l();r=b.rect.height-k.height;break;case "down-middle":m.height=b.rect.height+k.y,k=l(),r=k.height}b.view.css("left",q);b.view.css("top",r);b.dragMove!=void 0&&b.dragMove(h)}function l(a){b.view.removeClass("selected");$(document).unbind("mousemove",k);$(document).unbind("mouseup",
...
this.view.css("left"),e=this.view.css("top");a.addComponent(this.clone(),b,e)});return a};this.toXmlNode=function(){var a=this.view.clone();a.attr("ff-type","Group");a.empty();$.each(this.components,function(){this.toXmlNode().appendTo(a)});return a}};Firefly.Group.create=function(b){var a=new Firefly.Group;a.view=b.clone();a.view.empty();b.children().each(function(){var b=$(this),e=Firefly[b.attr("ff-type")].create(b),d=b.css("left"),b=b.css("top");a.addComponent(e,d,b)});return a};Firefly.Preview=function(){function b(){function b(){d.css("left",g.outerWidth());d.css("top",0);d.outerWidth($(window).width()-g.outerWidth());d.outerHeight($(window).height());var a=n.view.outerWidth(),c=n.view.outerHeight(),e=a+1E3,h=c+1E3,e=e>d.outerWidth()?e:d.outerWidth(),h=h>d.outerHeight()?h:d.outerHeight();f.outerWidth(e);f.outerHeight(h);c=(h-c)*0.5;n.view.css("left",(e-a)*0.5);n.view.css("top",c)}function c(){m.scrollTop((f.outerHeight()-d.outerHeight())*0.5);m.scrollLeft((f.outerWidth()-
d.outerWidth())*0.5)}function q(a){$.each([k,l],function(b){var c=this.find("i");b==a?c.addClass("yellow"):c.removeClass("yellow")});$.each([m,o],function(b){b==a?this.show():this.hide()})}function r(){o.show();var a=Firefly.editor.exportSource();p.doc.setValue(a)}e!=void 0?(r(),q(0),n.buildCurrent(),h.removeClass("disabled"),b(),c()):(e=$("#previewView"),d=e.find("#container"),g=e.find(".ui.menu"),m=$("<div style='position:absolute;width:100%;height:100%;overflow:auto;'></div>"),m.appendTo(d),o=
$("<div style='position:absolute;width:100%;height:100%;background:#ff0000;'></div>"),o.appendTo(d),f=$("<div style='position:absolute;'></div>"),f.appendTo(m),n=new a,n.view.appendTo(f),n.buildCurrent(),h=g.find(".item").eq(0),k=g.find(".item").eq(1),l=g.find(".item").eq(2),$.each([k,l],function(a){this.click(function(){q(a)})}),h.click(function(){n.clear();h.addClass("disabled");e.dimmer("hide");p.doc.setValue("")}),$(window).resize(b),b(),c(),o.css("background-color","#0000C0"),p=CodeMirror(o.get(0),
...
a.components,b=a.length,c=0;c<b;c++){var d=a[c].clone();d.unwrap();d.view.appendTo(this.contentLayer)}};this.clear=function(){this.contentLayer.empty()}}var c={},e,d,g,f,h,k,l,n,m,o,p;c.playCurrent=function(){this.show()};c.show=function(){$("#previewView").dimmer({closable:!1});$("#previewView").dimmer("show");b()};return c}();Firefly.EditorCanvasDescriptor=function(b){var a=this;this.title="\u753b\u5e03";this.initComplete=!1;this.init=function(a){this.createChildren(a);this.initComplete=!0;this.update()};this.createChildren=function(b){b.header.text(this.title);var b=b.form,e=Firefly.FormViewManager.createSizeView();e.appendTo(b);Firefly.FormViewManager.createHline().appendTo(b);var d=Firefly.FormViewManager.createColorPickerView("\u80cc\u666f\u989c\u8272");d.appendTo(b);this.colorPicker=new Firefly.ColorPicker(this.getColor(),
