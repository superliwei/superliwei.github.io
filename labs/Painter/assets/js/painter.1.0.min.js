...
new Painter.FilterWin;this.settingWin=new Painter.SettingWin("#settingWin");this.inputWin=new Painter.InputWin("#inputWin");this.editCanvasSizeWin=new Painter.EditCanvasSizeWin("#eidtCanvasSizeWin")};$(function(){Painter.init()});Painter.MainLayout=function(a){function b(){c.outerWidth(k);f.outerWidth(h);var a=$(window).width()-k-h-e.outerWidth()-g.outerWidth();d.outerWidth(a);var b=$(window).height()-$("#topMenu").outerHeight();c.outerHeight(b);f.outerHeight(b);d.outerHeight(b);d.css("left",k+e.outerWidth());f.css("left",k+a+e.outerWidth()+g.outerWidth());e.outerHeight(b);g.outerHeight(b);e.css("left",k);g.css("left",k+a+e.outerWidth());m.outerWidth(h);m.outerHeight(o);n.outerWidth(h);a=b-o-l.outerHeight();n.outerHeight(a);
l.css("top",o);n.css("top",o+l.outerHeight());a=a-s-10;p.outerHeight(a);q.outerHeight(a-t.outerHeight());r.outerHeight(a);u.update()}this.view=$(a);var c=this.view.find("#leftBox"),d=this.view.find("#centerBox"),f=this.view.find("#rightBox"),a=this.view.find(".vDivide"),e=a.eq(0),g=a.eq(1),j=e.find(".handle"),i=g.find(".handle"),k=51,h=320;j.click(function(){k=k==51?0:51;b()});i.click(function(){h=h==320?0:320;b()});c.css("position","absolute");d.css("position","absolute");f.css("position","absolute");
var m=f.find("#topBox"),n=f.find("#bottomBox"),l=f.find(".hDivide"),o=200;l.click(function(){o=o==200?0:200;b()});m.css("position","absolute");n.css("position","absolute");this.view.find(".menu.tabular .item").tab();var p=this.view.find("#layerPanel .segment");p.css("padding",5);p.css("overflow","hidden");var q=this.view.find("#propertiesPanel .segment");q.css("overflow","auto");var t=this.view.find("#propertiesPanel #header"),r=this.view.find("#historyPanel .segment");r.css("padding",5);r.css("overflow",
"auto");var s=this.view.find(".menu.tabular").outerHeight(),u=new function(){var a=p.find("#listContainer");this.update=function(){var b=p.outerHeight()-95;a.outerHeight(b)}};$(window).resize(b);b();this.toggleLeft=function(){j.trigger("click")};this.toggleRight=function(){i.trigger("click")};this.toggleRightTop=function(){l.trigger("click")}};Painter.TopMenu=function(a){function b(){$.each(f,function(){this.update()})}function c(a){function b(){if(d!="")Painter.KeyboardManager.execute(d);else switch(c){case "\u5bfc\u51fa\u56fe\u7247":Painter.KeyboardManager.execute("export");break;case "\u952e\u76d8\u5feb\u6377\u952e":Painter.KeyboardManager.execute("showQuickKey");break;case "\u64ad\u653e\u5f53\u524d\u7ed8\u753b\u8fc7\u7a0b":Painter.KeyboardManager.execute("playPaintPath");break;case "\u5173\u4e8ePainter":Painter.KeyboardManager.execute("about");
break;case "\u6253\u5f00\u7ed8\u753b\u8fc7\u7a0b":Painter.KeyboardManager.execute("openPaintPath");break;case "\u4fdd\u5b58\u7ed8\u753b\u8fc7\u7a0b":Painter.KeyboardManager.execute("savePaintPath")}}var c=a.find("span.text").eq(0).text();a.find(".item").length==0&&a.click(b);var d=a.find("span.description").text();this.update=function(){var a=!0;switch(c){case "\u64a4\u6d88":a=Painter.historyPanel.getUndoAble();break;case "\u91cd\u505a":a=Painter.historyPanel.getRedoAble();break;case "\u5220\u9664\u56fe\u5c42":a=
Painter.editor.getEditorCanvas().getSelectedLayer();break;case "\u79fb\u52a8\u56fe\u5c42":a=Painter.editor.getEditorCanvas().getSelectedLayer();break;case "\u6dfb\u52a0\u6ee4\u955c":a=Painter.editor.getEditorCanvas().getSelectedLayer();break;case "\u64ad\u653e\u5f53\u524d\u7ed8\u753b\u8fc7\u7a0b":a=Painter.Recorder.getActions().length>0;break;case "\u56fe\u5c42\u9762\u677f":a=Painter.topMenu.panelMenuController.getSelectedValue()!="layers";break;case "\u5c5e\u6027\u9762\u677f":a=Painter.topMenu.panelMenuController.getSelectedValue()!=
"properties";break;case "\u5386\u53f2\u8bb0\u5f55":a=Painter.topMenu.panelMenuController.getSelectedValue()!="history";break;case "\u753b\u7b14":a=Painter.toolPanel.getCurrentToolIdx()!=0;break;case "\u6a61\u76ae\u64e6":a=Painter.toolPanel.getCurrentToolIdx()!=1;break;case "\u5438\u8272\u5de5\u5177":a=Painter.toolPanel.getCurrentToolIdx()!=2;break;case "\u6cb9\u6f06\u6876":a=Painter.toolPanel.getCurrentToolIdx()!=3}this.setEnabled(a)};this.setEnabled=function(b){b?a.removeClass("disabled"):a.addClass("disabled")}}
this.view=$(a);a=this.view.find(".ui.dropdown:not(.right.menu .ui.dropdown)");a.dropdown({on:"hover",onShow:function(){b()}});var d=a.find(".item"),f=[];d.each(function(){f.push(new c($(this)))});this.panelMenuController=new function(a){var b=this,c,d={properties:$("#propertiesPanel"),history:$("#historyPanel"),layers:$("#layerPanel")};$.each(d,function(){$(this).css("display","none")});this.selectValue=function(a){c!=void 0&&d[c].css("display","none");c=a;d[c].css("display","block")};this.getSelectedValue=
function(){return c};this.getMenu=function(){return a};this.selectValue("layers");a.dropdown("set selected",c);a.dropdown({onChange:function(a){b.selectValue(a)}})}(this.view.find(".right.menu .ui.dropdown").eq(0));this.getItems=function(){return d}};Painter.Editor=function(a){function b(){var b=d.view.outerWidth()+1E3,e=d.view.outerHeight()+1E3,b=b>a.outerWidth()?b:a.outerWidth(),e=e>a.outerHeight()?e:a.outerHeight();c.outerWidth(b);c.outerHeight(e);b=(b-d.view.outerWidth())*0.5;e=(e-d.view.outerHeight())*0.5;d.view.css("left",b);d.view.css("top",e)}this.view=$("<div style='position:absolute;'></div>");this.view.outerWidth("100%");this.view.outerHeight("100%");this.view.css("overflow","auto");this.view.appendTo(a);var c=$("<div style='position:absolute;'></div>");
c.appendTo(this.view);var d=new Painter.EditorCanvas(c);this.getEditorCanvas=function(){return d};this.scrollToCenter=function(){this.view.scrollTop((c.outerHeight()-a.outerHeight())*0.5);this.view.scrollLeft((c.outerWidth()-a.outerWidth())*0.5)};this.updateSize=function(){b();this.scrollToCenter()};$(window).resize(b);b();this.scrollToCenter()};Painter.EditorCanvas=function(a){function b(a,b){b==void 0||b!=void 0&&b>h.length-1?(a.getCanvas().appendTo(j),h.push(a)):(a.getCanvas().insertBefore(h[b].getCanvas()),h.splice(b,0,a));Painter.layerPanel.getLayerListController().addItem(a,b)}function c(a){m!=void 0&&Painter.layerPanel.getLayerListController().unSelectItemByLayer(m);m=a;a!=void 0&&Painter.layerPanel.getLayerListController().selectItemByLayer(a)}function d(a){var b=h.indexOf(a);h.splice(b,1);a.getCanvas().remove();Painter.layerPanel.getLayerListController().removeItemByLayer(a);
m===a&&(m=void 0)}function f(a,b){g.view.outerWidth(a);g.view.outerHeight(b);for(var c=0;c<h.length;){var d=h[c],e=d.getCanvas();e.get(0).width=a;e.get(0).height=b;d.repaint();c++}g.bufferCanvas.get(0).width=a;g.bufferCanvas.get(0).height=b;$(window).trigger("resize")}function e(a){a=h.indexOf(a);if(a+1<h.length)return h[a+1];else if(a-1>-1&&h.length>0)return h[a-1]}var g=this;this.view=$("<div style='position:absolute;'></div>");this.view.outerWidth(800);this.view.outerHeight(600);this.view.appendTo(a);
this.view.css("background-image","url(assets/image/alphaBg.png)");var j=$("<div style='position:absolute;'></div>");j.appendTo(this.view);var i=$("<div style='position:absolute;'></div>");i.appendTo(this.view);var k=$("<div style='position:absolute;width:100%;height:100%'></div>");k.appendTo(this.view);this.bufferCanvas=$("<canvas>",{style:"position:absolute;"});this.bufferCanvas.attr("width",this.view.outerWidth());this.bufferCanvas.attr("height",this.view.outerHeight());var h=[],m,n,a=new Painter.Layer(this);
...
a.clientY));n!=void 0&&(n.view.css("left",a.x),n.view.css("top",a.y))});k.mousedown(function(a){function b(a){a=g.globalToLocalPoint(new Painter.Point(a.clientX,a.clientY));e.mousemove(a)}function c(a){$(document).off("mousemove",b);$(document).off("mouseup",c);a=g.globalToLocalPoint(new Painter.Point(a.clientX,a.clientY));e.mouseup(a);f.remove();g.addLayerAction(d,e.getAction())}var d=g.getSelectedLayer();if(d!=void 0){$(document).on("mousemove",b);$(document).on("mouseup",c);var e=Painter.toolPanel.getCurrentTool(),
f=g.bufferCanvas;f.insertAfter(d.getCanvas());a=g.globalToLocalPoint(new Painter.Point(a.clientX,a.clientY));e.setDrawCanvasAndBufferCanvas(d.getCanvas().get(0),f.get(0));e.mousedown(a)}})})();this.globalToLocalPoint=function(a){return new Painter.Point(a.x-this.view.offset().left,a.y-this.view.offset().top)};this.open=function(a){for(a=JSON.parse(a);h.length>0;)d(h[0]);Painter.HistoryManager.removeAll();Painter.Recorder.removeAll();var g={width:a.width,height:a.height};f(g.width,g.height);for(g=
0;g<a.layers.length;g++){var e=a.layers[g],j=new Painter.Layer(this);j.setName(e.name);j.setAlpha(e.alpha);j.setVisible(e.visible);var i=new Painter.LayerAction(Painter.LayerActionType.SetData,e.data);j.addAction(i);b(j);Painter.Recorder.addAction(new Painter.Recorder.Action(Painter.Recorder.Type.newLayer));Painter.Recorder.addAction(new Painter.Recorder.Action(Painter.Recorder.Type.setLayerAlpha,{layerIdx:g,alpha:e.alpha}));Painter.Recorder.addAction(new Painter.Recorder.Action(Painter.Recorder.Type.setLayerVisible,
{layerIdx:g,visible:e.visible}));Painter.Recorder.addAction(new Painter.Recorder.Action(Painter.Recorder.Type.drawLayer,{layerIdx:g,action:i}))}c(h[h.length-1]);this.dispatchUpdateEvent()};this.setCursor=function(a){k.css("cursor",a)};this.setDragView=function(a){n=a;i.empty();n!=void 0&&(n.view.hide(),n.view.appendTo(i))};this.getSelectedLayer=function(){return m};this.getLayers=function(){return h};this.dispatchUpdateEvent=function(){this.view.trigger("editCanvasUpdate")};this.setSize=function(a,
b){var c={width:g.view.outerWidth(),height:g.view.outerHeight()};Painter.HistoryManager.addEditAction("changeSize",c,{width:a,height:b},function(a){f(a.width,a.height);g.dispatchUpdateEvent()})};this.addLayerAction=function(a,b){if(b!=void 0){var c=new Painter.Recorder.Action(Painter.Recorder.Type.drawLayer,{layerIdx:h.indexOf(a),action:b});Painter.HistoryManager.add("paint",function(){a.removeAction(b);Painter.Recorder.removeAction(c);g.dispatchUpdateEvent()},function(){a.addAction(b);Painter.Recorder.addAction(c);
g.dispatchUpdateEvent()})}};this.applyFilterToSelectedLayer=function(a){var b=this.getSelectedLayer();b!=void 0&&(a=new Painter.LayerAction(Painter.LayerActionType.ApplyFilter,a),this.addLayerAction(b,a))};this.newLayer=function(){var a=this.getSelectedLayer(),g=new Painter.Layer(this);g.setName("\u65b0\u56fe\u5c42");var e=a!=void 0?h.indexOf(a)+1:void 0,f=new Painter.Recorder.Action(Painter.Recorder.Type.newLayer,e);Painter.HistoryManager.add("newLayer",function(){d(g);c(a);Painter.Recorder.removeAction(f)},
function(){b(g,e);c(g);Painter.Recorder.addAction(f)})};this.removeSelectedLayer=function(){var a=this.getSelectedLayer(),f=h.indexOf(a);if(a!=void 0){var j=e(a),i=new Painter.Recorder.Action(Painter.Recorder.Type.removeLayer,f);Painter.HistoryManager.add("removeLayer",function(){b(a,f);c(a);g.dispatchUpdateEvent();Painter.Recorder.removeAction(i)},function(){d(a);j!=void 0&&c(j);g.dispatchUpdateEvent();Painter.Recorder.addAction(i)})}};this.moveSelectedLayer=function(a){function b(){var c=h.indexOf(f),
d=c+1;if(d<h.length){var e=new Painter.Recorder.Action(Painter.Recorder.Type.moveLayer,{layerIdx:c,direction:a});Painter.HistoryManager.add("moveLayer",function(){f.getCanvas().insertBefore(h[c].getCanvas());h.splice(d,1);h.splice(c,0,f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,"down");g.dispatchUpdateEvent();Painter.Recorder.removeAction(e)},function(){f.getCanvas().insertAfter(h[d].getCanvas());h.splice(c,1);h.splice(d,0,f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,
"up");g.dispatchUpdateEvent();Painter.Recorder.addAction(e)})}}function c(){var b=h.indexOf(f),d=b-1;if(d>-1){var e=new Painter.Recorder.Action(Painter.Recorder.Type.moveLayer,{layerIdx:b,direction:a});Painter.HistoryManager.add("moveLayer",function(){f.getCanvas().insertAfter(h[b].getCanvas());h.splice(d,1);h.splice(b,0,f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,"up");g.dispatchUpdateEvent();Painter.Recorder.removeAction(e)},function(){f.getCanvas().insertBefore(h[d].getCanvas());
h.splice(b,1);h.splice(d,0,f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,"down");g.dispatchUpdateEvent();Painter.Recorder.addAction(e)})}}function d(){var b=h.indexOf(f);if(b!=h.length-1){var c=new Painter.Recorder.Action(Painter.Recorder.Type.moveLayer,{layerIdx:b,direction:a});Painter.HistoryManager.add("moveLayer",function(){f.getCanvas().insertBefore(h[b].getCanvas());h.pop();h.splice(b,0,f);Painter.layerPanel.getLayerListController().moveTopItemToIdxByLayer(f,b);g.dispatchUpdateEvent();
Painter.Recorder.removeAction(c)},function(){f.getCanvas().appendTo(j);h.splice(b,1);h.push(f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,"top");g.dispatchUpdateEvent();Painter.Recorder.addAction(c)})}}function e(){var b=h.indexOf(f);if(b>0){var c=new Painter.Recorder.Action(Painter.Recorder.Type.moveLayer,{layerIdx:b,direction:a});Painter.HistoryManager.add("moveLayer",function(){f.getCanvas().insertAfter(h[b].getCanvas());h.shift();h.splice(b,0,f);Painter.layerPanel.getLayerListController().moveBottomItemToIdxByLayer(f,
b);g.dispatchUpdateEvent();Painter.Recorder.removeAction(c)},function(){f.getCanvas().prependTo(j);h.splice(b,1);h.unshift(f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,"bottom");g.dispatchUpdateEvent();Painter.Recorder.addAction(c)})}}var f=this.getSelectedLayer();if(f!=void 0)switch(a){case "up":b();break;case "down":c();break;case "top":d();break;case "bottom":e()}};this.changeSelectedLayerAlpha=function(a){var b=this.getSelectedLayer(),c=b.getAlpha(),d=h.indexOf(b),e=new Painter.Recorder.Action(Painter.Recorder.Type.setLayerAlpha,
{layerIdx:d,alpha:a});Painter.HistoryManager.addEditAction("editLayer",c,a,function(c){Painter.layerPanel.getToolBarController().getAlphaSlider().setValue(c);Painter.layerPanel.getLayerListController().setLayerAlpha(b,c);g.dispatchUpdateEvent();c==a?Painter.Recorder.addAction(e):Painter.Recorder.removeAction(e)})};this.setLayerVisible=function(a,b){var c=a.getVisible(),d=h.indexOf(a),e=new Painter.Recorder.Action(Painter.Recorder.Type.setLayerVisible,{layerIdx:d,visible:b});Painter.HistoryManager.addEditAction("editLayer",
c,b,function(c){Painter.layerPanel.getLayerListController().setLayerVisible(a,c);g.dispatchUpdateEvent();c==b?Painter.Recorder.addAction(e):Painter.Recorder.removeAction(e)})};this.setLayerName=function(a,b){var c=a.getName();c!=b&&Painter.HistoryManager.addEditAction("editLayer",c,b,function(b){Painter.layerPanel.getLayerListController().setLayerName(a,b)})};this.selectLayer=function(a){var b=this.getSelectedLayer();b!=a&&Painter.HistoryManager.addEditAction("selectLayer",b,a,function(a){c(a)})};
...
break;case Painter.LayerActionType.SetData:var e=new Image;e.src=this.data;b=a.getCanvas().get(0).getContext("2d");f=a.getCanvas().get(0).width;a=a.getCanvas().get(0).height;b.drawImage(e,0,0,e.width,e.height,0,0,f,a)}};this.getJsonObj=function(){var a={};a.type=this.type;switch(this.type){case Painter.LayerActionType.AddShape:a.shape=this.shape.getJsonObj();break;case Painter.LayerActionType.FloodFill:a.floodFill=this.floodFill;break;case Painter.LayerActionType.ApplyFilter:a.filter=this.filter;
break;case Painter.LayerActionType.SetBackgroundColor:a.backgroundColor=this.backgroundColor;break;case Painter.LayerActionType.SetData:a.data=this.data}return a}};Painter.Shape=function(a){this.brush=a.brush;this.brushSettings=a.brushSettings;this.mousedownPoint=a.mousedownPoint;this.mousemovePoints=a.mousemovePoints;this.mouseupPoint=a.mouseupPoint;this.paintTo=function(a){var c=Painter.editor.getEditorCanvas().bufferCanvas.get(0);this.brush.setDrawCanvasAndBufferCanvas(a.getCanvas().get(0),c);var d=this.brushSettings.clone();d.globalCompositeOperation="source-over";this.brush.useSettings(d);this.brush.mousedown(this.mousedownPoint);for(d=0;d<this.mousemovePoints.length;)this.brush.mousemove(this.mousemovePoints[d]),
d++;this.brush.mouseup(this.mouseupPoint);a=a.getCanvas().get(0).getContext("2d");d=new Image;d.src=c.toDataURL();a.save();if(this.brushSettings.globalCompositeOperation=="destination-out")a.globalCompositeOperation="destination-out";a.drawImage(d,0,0);a.restore();c.getContext("2d").clearRect(0,0,c.width,c.height)};this.getJsonObj=function(){var a={};a.brushIdx=Painter.toolPanel.getBrush().items.indexOf(this.brush);a.brushIdx=a.brushIdx==-1?0:a.brushIdx;a.brushSettings=this.brushSettings;a.mousedownPoint=
this.mousedownPoint;a.mousemovePoints=this.mousemovePoints;a.mouseupPoint=this.mouseupPoint;return a}};Painter.PreviewView=function(){var a=$("#previewContainer"),b,c,d;this.init=function(f){d=f;b=$("<div>");b.css("position","absolute");b.css("background-image","url(assets/image/alphaBg.png)");b.appendTo(a);c=$("<canvas>");c.css("position","absolute");c.appendTo(b);this.update();var e=this;d.view.on("editCanvasUpdate",function(){e.update()})};this.update=function(){var f=a.prev().outerHeight(),e=d.view.outerWidth(),g=d.view.outerHeight(),j=a.outerWidth(),i=a.outerHeight()-f,k=j/e<i/g?j/e:i/g;e*=k;
g*=k;j=(j-e)*0.5;i=(i-g)*0.5;e=Math.round(e);g=Math.round(g);b.outerWidth(e);b.outerHeight(g);b.css("left",j);b.css("top",i+f);c.attr("width",e);c.attr("height",g);f=c.get(0).getContext("2d");f.clearRect(0,0,c.get(0).width,c.get(0).height);for(i=0;i<d.getLayers().length;){e=d.getLayers()[i];if(e.getVisible())j=e.getCanvas().get(0),g=new Image,g.src=j.toDataURL(),f.save(),f.globalAlpha=e.getAlpha(),f.drawImage(g,0,0,g.width,g.height,0,0,c.get(0).width,c.get(0).height),f.restore();i++}}};Painter.HistoryPanel=function(){function a(){var a=Painter.HistoryManager.items.length,b=Painter.HistoryManager.idx;a==0?(d.addClass("disabled"),f.addClass("disabled"),e.addClass("disabled")):(e.removeClass("disabled"),b==a-1?(f.addClass("disabled"),d.removeClass("disabled")):(b==-1?d.addClass("disabled"):d.removeClass("disabled"),f.removeClass("disabled")));g.empty();a=Painter.HistoryManager.items.length;if(a==0)g.text("\u6ca1\u6709\u4efb\u4f55\u5386\u53f2\u8bb0\u5f55");else for(var b=[],c=Painter.HistoryManager.idx,
h=0;h<a;h++){var m=new Painter.HistoryItemView(Painter.HistoryManager.items[h]);m.view.prependTo(g);b.push(m);h==c&&b[h].view.addClass("active")}}var b=$("#historyPanel"),c=b.find(".ui.tab.segment .menu .item"),d=c.eq(0),f=c.eq(1),e=c.eq(2),g=b.find(".ui.tab.segment .list");a();d.click(function(){Painter.HistoryManager.undo()});f.click(function(){Painter.HistoryManager.redo()});e.click(function(){Painter.HistoryManager.removeAll()});$(document).bind(Painter.HistoryManager.UPDATE,a);this.getUndoAble=
...
this.applySettings=function(a){a.strokeStyle=this.settings.color;if(this.settings.material=="")a.strokeStyle=this.settings.color;else{var b=this.settings.material,c=new Image;c.src=b;b=a.createPattern(c,"repeat");a.strokeStyle=b}a.lineWidth=this.settings.size;a.globalAlpha=this.settings.alpha;a.globalCompositeOperation=this.settings.globalCompositeOperation;a.lineCap=this.settings.lineCap;a.lineJoin=this.settings.lineJoin;a.miterLimit=this.settings.miterLimit}};Painter.ShapeBrush=function(){Painter.BasicBrush.call(this);this.descriptor=new Painter.ShapeBrushDescriptor(this);this.setDrawCanvasAndBufferCanvas=function(a,b){this.canvas=a;this.bufferCanvas=b};var a,b,c,d;this.initBrush=function(){a==void 0&&(a=$("<canvas width='100' height='100'></canvas>"));var c=a.get(0).getContext("2d"),d=new Image;d.src=this.settings.shape.src;c.clearRect(0,0,a.get(0).width,a.get(0).height);c.drawImage(d,0,0,d.width,d.height,0,0,100,100);var d=c.getImageData(0,0,a.get(0).width,
a.get(0).height),g=tinycolor(this.settings.color).toRgb();JSManipulate.rgbadjust.filter(d,{red:g.r/255,green:g.g/255,blue:g.b/255});c.putImageData(d,0,0);b=new Image;b.src=a.get(0).toDataURL()};this.mousedown=function(a){c=a;this.initBrush();var e=this.bufferCanvas.getContext("2d");e.clearRect(0,0,this.bufferCanvas.width,this.bufferCanvas.height);e.save();this.applySettings(e);if(this.settings.style==0)e.globalAlpha=1,$(this.bufferCanvas).css("opacity",this.settings.alpha);else if(this.settings.style==
1)e.globalAlpha=this.settings.alpha/10;var g=this.settings.size;d=g;e.drawImage(b,0,0,b.width,b.height,a.x-g*0.5,a.y-g*0.5,g,g)};this.mousemove=function(a){var e=a.x-c.x,a=a.y-c.y,g=Math.sqrt(e*e+a*a),j=this.settings.size,e=Math.atan2(a,e),a=this.bufferCanvas.getContext("2d"),i=this.settings.spacing;j*=1+(g-i>0?g-i:0)/j*this.settings.scaleFactor;for(var j=j>100?100:j,j=j<1?1:j,g=Math.floor(g/i),k=0;k<g;k++){var h=d+(j-d)*(k/g),m=h,n=c.x+i*(k+1)*Math.cos(e),l=c.y+i*(k+1)*Math.sin(e);a.drawImage(b,
0,0,b.width,b.height,n-h*0.5,l-m*0.5,h,m);k==g-1&&(c=new Painter.Point(n,l))}d=j};this.mouseup=function(){var a=this.bufferCanvas.getContext("2d");if(this.settings.style==0){$(this.bufferCanvas).css("opacity",1);var b=new Image;b.src=this.bufferCanvas.toDataURL();a.clearRect(0,0,this.bufferCanvas.width,this.bufferCanvas.height);a.globalAlpha=this.settings.alpha;a.drawImage(b,0,0)}a.restore()};this.applySettings=function(a){a.globalAlpha=this.settings.alpha}};Painter.BasicBrushSettings=function(){this.clone=function(){var a=new Painter.BasicBrushSettings;a.applySettings(this.color,this.size,this.alpha,this.globalCompositeOperation);return a};this.applySettings=function(a,b,c,d){this.color=a;this.size=b;this.alpha=c;this.globalCompositeOperation=d};this.applySettingsFromObj=function(a){for(key in a)this[key]=a[key]};this.applySettings("#000000",1,1,"source-over")};Painter.LineBrushSettings=function(){Painter.BasicBrushSettings.call(this);var a=this.applySettings;this.applySettings=function(b,c,d,f,e,g,j,i){a.call(this,b,c,d,f);this.material=e;this.lineCap=g;this.lineJoin=j;this.miterLimit=i};this.clone=function(){var a=new Painter.LineBrushSettings;a.applySettings(this.color,this.size,this.alpha,this.globalCompositeOperation,this.material,this.lineCap,this.lineJoin,this.miterLimit);return a};this.applySettings(this.color,this.size,this.alpha,this.globalCompositeOperation,
"","round","round",10)};Painter.ShapeBrushSettings=function(){Painter.BasicBrushSettings.call(this);this.clone=function(){var a=new Painter.ShapeBrushSettings;a.applySettings(this.color,this.size,this.alpha,this.globalCompositeOperation,this.scaleFactor,this.shape,this.style,this.spacing);return a};var a=this.applySettings;this.applySettings=function(b,c,d,f,e,g,j,i){a.call(this,b,c,d,f);this.scaleFactor=e;this.shape=g;this.style=j;this.spacing=i};this.applySettings(this.color,this.size,this.alpha,this.globalCompositeOperation,
...
b.modal("hide");var a=i[j].filter;a!=void 0&&Painter.editor.getEditorCanvas().applyFilterToSelectedLayer(a.getConfig())});c.dropdown({onChange:function(b){b=parseInt(b);d.empty();j=b;b=i[b].filter;b!=void 0&&b.descriptor.init(d);a(b)}});this.show=function(){b.modal("show");f.removeClass("disabled")}};Painter.filter={};
Painter.filter.BasicFilter=function(){var a=this;this.descriptor=new function(){function b(b,d){var f=b.name,e=b.label,g=b.min,j=b.max,i=b.value;switch(b.type){case "slider":e=Painter.FormViewManager.createSliderView(e);e.appendTo(d);a.initOption();(new Painter.Slider(e,g,j,i)).onChange=function(b){a.option[f]=Number(b);a.onChange()};break;case "checkbox":g=Painter.FormViewManager.createCheckBoxView(e);g.appendTo(d);a.initOption();var k=g.find(".ui.checkbox").eq(0);k.checkbox(i?"set checked":"set unchecked");
...
d.attr("height",e);f=d.get(0).getContext("2d");f.clearRect(0,0,d.get(0).width,d.get(0).height);for(e=0;e<c.getLayers().length;){var g=c.getLayers()[e];if(g.getVisible()){var j=g.getCanvas().get(0),i=new Image;i.src=j.toDataURL();f.save();f.globalAlpha=g.getAlpha();f.drawImage(i,0,0,i.width,i.height,0,0,d.get(0).width,d.get(0).height);f.restore()}e++}c=d.get(0).toDataURL("png");c=c.replace("image/png","image/octet-stream");a.saveData(c,b+".png")}})},saveData:function(a,b){var c=$("<a>");c.attr("href",
a);c.attr("download",b);c.get(0).click()},saveText:function(a,b){this.saveData("data:application/octet-stream;base64,"+Base64.encode(a),b)},browser:function(a){var b=$("<input type='file'>");b.trigger("click");b.change(function(){var c=b.get(0).files[0];a(c)})},readText:function(a,b){$("#loadingMask").dimmer({closable:!1});$("#loadingMask").find(".ui.text.loader").text("\u6587\u4ef6\u8bfb\u53d6\u4e2d...");$("#loadingMask").dimmer("show");var c=new FileReader;c.onload=function(){$("#loadingMask").dimmer("hide");
b(c.result)};c.readAsText(a)}};Painter.PathPlayer=function(){function a(){function a(){if(l!=void 0){e.outerWidth($(window).width());e.outerHeight($(window).height()-g.outerHeight());$(k).width($(window).width()-140);var b=l.width,c=l.height;i.initSize(b,c);var d=b+1E3,f=c+1E3,d=d>e.outerWidth()?d:e.outerWidth(),f=f>e.outerHeight()?f:e.outerHeight();j.outerWidth(d);j.outerHeight(f);c=(f-c)*0.5;i.view.css("left",(d-b)*0.5);i.view.css("top",c)}}f!=void 0?h.removeClass("disabled"):(f=$("#pathPlayerView"),e=f.find("#container"),g=
f.find(".ui.menu"),j=$("<div style='position:absolute;'></div>"),j.appendTo(e),i=new c,i.view.appendTo(j),k=f.find(".ui.slider").get(0),noUiSlider.create(k,{start:[0],connect:"lower",animate:!1,range:{min:[0],max:[1]}}),h=g.find(".item").eq(0),m=g.find(".item").eq(1),h.click(function(){d.stop();h.addClass("disabled");f.dimmer("hide")}),m.click(function(){d.isPlaying?d.pause():d.play()}),k.noUiSlider.on("start",function(){d.pause()}),k.noUiSlider.on("end",function(){var a=k.noUiSlider.get();d.seek(a)}),
...
c=new Painter.Shape({brush:g,brushSettings:f,mousedownPoint:a.mousedownPoint,mousemovePoints:a.mousemovePoints,mouseupPoint:a.mouseupPoint}),c=new Painter.LayerAction(Painter.LayerActionType.AddShape,c),e.addAction(c)):(c=a.mousemovePoints[c-1],g.mousemove(c))};this.clear=function(){for(;b.length>0;)this.removeLayer(0);this.bufferCanvas.remove()}}var d={},f,e,g,j,i,k,h,m,n,l,o=0,p,q=-1;d.isPlaying=!1;d.isPlayComplete=!1;d.play=function(){var a=m.find("i");a.removeClass("play");a.addClass("pause");
this.isPlaying=!0;if(this.isPlayComplete)i.clear(),this.isPlayComplete=!1,o=0,q=-1;this.enterFrame()};d.pause=function(){var a=m.find("i");a.addClass("play");a.removeClass("pause");this.isPlaying=!1;window.cancelAnimationFrame(n)};d.stop=function(){this.pause();k.noUiSlider.set(0);i.clear();this.isPlayComplete=!1;o=0;q=-1;p=l=void 0};d.seek=function(a){o=Number(a);d.isPlayComplete=o==1;this.paint()};d.enterFrame=function(){o=o>1?1:o;k.noUiSlider.set(o);d.paint();o==1?(d.pause(),d.isPlayComplete=!0):
(o+=1/p.length,n=window.requestAnimationFrame(arguments.callee))};d.playCurrent=function(){this.open(Painter.File.getPaintPathString())};d.open=function(a){l=JSON.parse(a);p=this.getSteps();this.show();var b=f.find(".ui.dimmer");b.dimmer({closable:!1});b.dimmer("show");(function(a){function b(a,c){var d=new Image;d.onload=function(){c()};d.src=a}for(var c=[],d=l.actions,e=0;e<d.length;){var f=d[e];if(f.type==Painter.Recorder.Type.drawLayer&&f.action.type==Painter.LayerActionType.AddShape){var f=f.action.shape,
g;if(f.brushSettings.material!=void 0&&f.brushSettings.material!="")g=f.brushSettings.material;else if(f.brushSettings.shape!=void 0)g=f.brushSettings.shape.src;g!=void 0&&c.indexOf(g)==-1&&c.push(g)}e++}c.length==0?a():(e=0,b(c[e],function(){e++;e==c.length?a():b(c[e],arguments.callee)}))})(function(){b.dimmer("hide");m.trigger("click")})};d.show=function(){$("#pathPlayerView").dimmer({closable:!1});$("#pathPlayerView").dimmer("show");a()};d.getSteps=function(){for(var a=[],c=l.actions,d=0;d<c.length;){var e=
c[d];if(e.type==Painter.Recorder.Type.drawLayer){var f=e.action;if(f.type==Painter.LayerActionType.AddShape)for(var f=f.shape.mousemovePoints.length+2,g=0;g<f;)a.push(new b(e,g,f)),g++;else a.push(new b(e,0,1))}else a.push(new b(e,0,1));d++}return a};d.paint=function(){var a=Math.round(o*(p.length-1));if(q!=a){if(a>q)for(var b=q;a-b!=0;)b++,this.addStep(b);else this.startStepTo(a);q=a}};d.addStep=function(a){a=p[a];if(a.len==1)switch(a.action.type){case Painter.Recorder.Type.newLayer:i.newLayer(a.action.toIdx);
break;case Painter.Recorder.Type.removeLayer:i.removeLayer(a.action.layerIdx);break;case Painter.Recorder.Type.moveLayer:i.moveLayer(a.action.layerIdx,a.action.direction);break;case Painter.Recorder.Type.setLayerAlpha:i.setLayerAlpha(a.action.layerIdx,a.action.alpha);break;case Painter.Recorder.Type.setLayerVisible:i.setLayerVisible(a.action.layerIdx,a.action.visible);break;case Painter.Recorder.Type.drawLayer:switch(a.action.action.type){case Painter.LayerActionType.SetBackgroundColor:i.setLayerBackgroundColor(a.action.layerIdx,
a.action.action.backgroundColor);break;case Painter.LayerActionType.FloodFill:i.setLayerFloodFill(a.action.layerIdx,a.action.action.floodFill);break;case Painter.LayerActionType.ApplyFilter:i.setLayerApplyFilter(a.action.layerIdx,a.action.action.filter);break;case Painter.LayerActionType.SetData:i.setLayerData(a.action.layerIdx,a.action.action.data)}}else i.paintLayerShapeByStep(a)};d.startStepTo=function(a){i.clear();for(var b=-1;a-b!=0;)b++,this.addStep(b)};return d}();Painter.InputWin=function(a){var b=$(a),c=b.find(".header i").eq(0),d=b.find(".header label").eq(0),f=b.find("input").eq(0),e=b.find(".right.labeled .label").eq(0),g=b.find(".actions button").eq(0),j;g.click(function(){g.addClass("disabled");b.modal("hide");j!=void 0&&j(f.val())});this.setOption=function(a){c.attr("class",a.icon);d.text(a.title);f.attr("placeholder",a.placeholder);e.text(a.rightlabel);g.text(a.submitLabel);f.val(a.value);j=a.onSubmit};this.show=function(a){this.setOption(a);g.removeClass("disabled");
...
f.val(a.width);e.val(a.height);g.removeClass("disabled");c.modal("show")}};
