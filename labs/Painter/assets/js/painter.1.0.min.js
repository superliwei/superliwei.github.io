...
new Painter.FilterWin;this.settingWin=new Painter.SettingWin("#settingWin");this.inputWin=new Painter.InputWin("#inputWin");this.editCanvasSizeWin=new Painter.EditCanvasSizeWin("#eidtCanvasSizeWin");this.onlineFileWin=new Painter.OnlineFileWin("#onlineFileWin")};$(function(){Painter.init()});Painter.MainLayout=function(a){function b(){c.outerWidth(k);f.outerWidth(n);var a=$(window).width()-k-n-e.outerWidth()-g.outerWidth();d.outerWidth(a);var b=$(window).height()-$("#topMenu").outerHeight();c.outerHeight(b);f.outerHeight(b);d.outerHeight(b);d.css("left",k+e.outerWidth());f.css("left",k+a+e.outerWidth()+g.outerWidth());e.outerHeight(b);g.outerHeight(b);e.css("left",k);g.css("left",k+a+e.outerWidth());o.outerWidth(n);o.outerHeight(m);j.outerWidth(n);a=b-m-l.outerHeight();j.outerHeight(a);
l.css("top",m);j.css("top",m+l.outerHeight());a=a-t-10;p.outerHeight(a);q.outerHeight(a-r.outerHeight());s.outerHeight(a);u.update()}this.view=$(a);var c=this.view.find("#leftBox"),d=this.view.find("#centerBox"),f=this.view.find("#rightBox"),a=this.view.find(".vDivide"),e=a.eq(0),g=a.eq(1),h=e.find(".handle"),i=g.find(".handle"),k=51,n=320;h.click(function(){k=k==51?0:51;b()});i.click(function(){n=n==320?0:320;b()});c.css("position","absolute");d.css("position","absolute");f.css("position","absolute");
var o=f.find("#topBox"),j=f.find("#bottomBox"),l=f.find(".hDivide"),m=200;l.click(function(){m=m==200?0:200;b()});o.css("position","absolute");j.css("position","absolute");this.view.find(".menu.tabular .item").tab();var p=this.view.find("#layerPanel .segment");p.css("padding",5);p.css("overflow","hidden");var q=this.view.find("#propertiesPanel .segment");q.css("overflow","auto");var r=this.view.find("#propertiesPanel #header"),s=this.view.find("#historyPanel .segment");s.css("padding",5);s.css("overflow",
"auto");var t=this.view.find(".menu.tabular").outerHeight(),u=new function(){var a=p.find("#listContainer");this.update=function(){var b=p.outerHeight()-95;a.outerHeight(b)}};$(window).resize(b);b();this.toggleLeft=function(){h.trigger("click")};this.toggleRight=function(){i.trigger("click")};this.toggleRightTop=function(){l.trigger("click")}};Painter.TopMenu=function(a){function b(){$.each(f,function(){this.update()})}function c(a){function b(){if(d!="")Painter.KeyboardManager.execute(d);else switch(c){case "\u5bfc\u51fa\u56fe\u7247":Painter.KeyboardManager.execute("export");break;case "\u952e\u76d8\u5feb\u6377\u952e":Painter.KeyboardManager.execute("showQuickKey");break;case "\u64ad\u653e\u5f53\u524d\u7ed8\u753b\u8fc7\u7a0b":Painter.KeyboardManager.execute("playPaintPath");break;case "\u5173\u4e8ePainter":Painter.KeyboardManager.execute("about");
...
c.appendTo(this.view);var d=new Painter.EditorCanvas(c);this.getEditorCanvas=function(){return d};this.scrollToCenter=function(){this.view.scrollTop((c.outerHeight()-a.outerHeight())*0.5);this.view.scrollLeft((c.outerWidth()-a.outerWidth())*0.5)};this.updateSize=function(){b()};$(window).resize(b);b();this.scrollToCenter()};Painter.EditorCanvas=function(a){function b(a,b){b==void 0||b!=void 0&&b>j.length-1?(a.getCanvas().appendTo(k),j.push(a)):(a.getCanvas().insertBefore(j[b].getCanvas()),j.splice(b,0,a));Painter.layerPanel.getLayerListController().addItem(a,b)}function c(a){l!=void 0&&Painter.layerPanel.getLayerListController().unSelectItemByLayer(l);l=a;a!=void 0&&Painter.layerPanel.getLayerListController().selectItemByLayer(a)}function d(a){var b=j.indexOf(a);j.splice(b,1);a.getCanvas().remove();Painter.layerPanel.getLayerListController().removeItemByLayer(a);
l===a&&(l=void 0)}function f(a,b){g.size.width=a;g.size.height=b;g.view.outerWidth(a*g.scale);g.view.outerHeight(b*g.scale);for(var c=0;c<j.length;){var d=j[c],e=d.getCanvas();e.get(0).width=a;e.get(0).height=b;d.repaint();c++}g.bufferCanvas.get(0).width=a;g.bufferCanvas.get(0).height=b;Painter.editor.updateSize()}function e(a){a=j.indexOf(a);if(a+1<j.length)return j[a+1];else if(a-1>-1&&j.length>0)return j[a-1]}var g=this;this.size={width:800,height:600};this.scale=1;var h=[0.06,0.12,0.25,0.5,0.66,
1,2,3,4,8,16,32,64],i=5;this.view=$("<div style='position:absolute;'></div>");this.view.outerWidth(this.size.width);this.view.outerHeight(this.size.height);this.view.appendTo(a);this.view.css("background-image","url(assets/image/alphaBg.png)");var k=$("<div style='position:absolute;'></div>");k.appendTo(this.view);var n=$("<div style='position:absolute;'></div>");n.appendTo(this.view);var o=$("<div style='position:absolute;width:100%;height:100%'></div>");o.appendTo(this.view);this.bufferCanvas=$("<canvas>",
{style:"position:absolute;"});this.bufferCanvas.attr("width",this.size.width);this.bufferCanvas.attr("height",this.size.height);var j=[],l,m,a=new Painter.Layer(this);a.setName("\u80cc\u666f\u5c42");var p=new Painter.LayerAction(Painter.LayerActionType.SetBackgroundColor,"#ffffff");a.addAction(p);b(a);c(a);Painter.Recorder.addAction(new Painter.Recorder.Action(Painter.Recorder.Type.newLayer));Painter.Recorder.addAction(new Painter.Recorder.Action(Painter.Recorder.Type.drawLayer,{layerIdx:0,action:p}));
(function(){o.mouseover(function(){m!=void 0&&m.view.show()});o.on("mouseout",function(){m!=void 0&&m.view.hide()});$(document).mousemove(function(a){m!=void 0&&m.view.offset({left:a.clientX,top:a.clientY})});o.mousedown(function(a){function b(a){a=g.globalToLocalPoint(new Painter.Point(a.clientX,a.clientY));e.mousemove(a)}function c(a){$(document).off("mousemove",b);$(document).off("mouseup",c);a=g.globalToLocalPoint(new Painter.Point(a.clientX,a.clientY));e.mouseup(a);f.remove();g.addLayerAction(d,
...
e.layers.length==0?a():(d=0,b(e.layers[d].data,function(){d++;d==e.layers.length?a():b(e.layers[d].data,arguments.callee)}))})(function(){for($("#loadingMask").dimmer("hide");j.length>0;)d(j[0]);Painter.HistoryManager.removeAll();Painter.Recorder.removeAll();g.zoomToLevel(5);var a={width:e.width,height:e.height};f(a.width,a.height);Painter.editor.scrollToCenter();for(a=0;a<e.layers.length;a++){var i=e.layers[a],k=new Painter.Layer(g);k.setName(i.name);k.setAlpha(i.alpha);k.setVisible(i.visible);var q=
new Painter.LayerAction(Painter.LayerActionType.SetData,h[a]);k.addAction(q);b(k);Painter.Recorder.addAction(new Painter.Recorder.Action(Painter.Recorder.Type.newLayer));Painter.Recorder.addAction(new Painter.Recorder.Action(Painter.Recorder.Type.setLayerAlpha,{layerIdx:a,alpha:i.alpha}));Painter.Recorder.addAction(new Painter.Recorder.Action(Painter.Recorder.Type.setLayerVisible,{layerIdx:a,visible:i.visible}));Painter.Recorder.addAction(new Painter.Recorder.Action(Painter.Recorder.Type.drawLayer,
{layerIdx:a,action:q}))}c(j[j.length-1]);g.dispatchUpdateEvent()})};this.setCursor=function(a){o.css("cursor",a)};this.setDragView=function(a){m=a;n.empty();m!=void 0&&(m.view.hide(),m.view.appendTo(n))};this.getSelectedLayer=function(){return l};this.getLayers=function(){return j};this.dispatchUpdateEvent=function(){this.view.trigger("editCanvasUpdate")};this.setSize=function(a,b){Painter.HistoryManager.addEditAction("changeSize",{width:g.size.width,height:g.size.height},{width:a,height:b},function(a){f(a.width,
a.height);g.dispatchUpdateEvent()})};this.addLayerAction=function(a,b){if(b!=void 0){var c=new Painter.Recorder.Action(Painter.Recorder.Type.drawLayer,{layerIdx:j.indexOf(a),action:b});Painter.HistoryManager.add("paint",function(){a.removeAction(b);Painter.Recorder.removeAction(c);g.dispatchUpdateEvent()},function(){a.addAction(b);Painter.Recorder.addAction(c);g.dispatchUpdateEvent()})}};this.applyFilterToSelectedLayer=function(a){var b=this.getSelectedLayer();b!=void 0&&(a=new Painter.LayerAction(Painter.LayerActionType.ApplyFilter,
a),this.addLayerAction(b,a))};this.newLayer=function(){var a=this.getSelectedLayer(),g=new Painter.Layer(this);g.setName("\u65b0\u56fe\u5c42");var e=a!=void 0?j.indexOf(a)+1:void 0,f=new Painter.Recorder.Action(Painter.Recorder.Type.newLayer,e);Painter.HistoryManager.add("newLayer",function(){d(g);c(a);Painter.Recorder.removeAction(f)},function(){b(g,e);c(g);Painter.Recorder.addAction(f)})};this.removeSelectedLayer=function(){var a=this.getSelectedLayer(),f=j.indexOf(a);if(a!=void 0){var h=e(a),i=
new Painter.Recorder.Action(Painter.Recorder.Type.removeLayer,f);Painter.HistoryManager.add("removeLayer",function(){b(a,f);c(a);g.dispatchUpdateEvent();Painter.Recorder.removeAction(i)},function(){d(a);h!=void 0&&c(h);g.dispatchUpdateEvent();Painter.Recorder.addAction(i)})}};this.moveSelectedLayer=function(a){function b(){var c=j.indexOf(f),d=c+1;if(d<j.length){var e=new Painter.Recorder.Action(Painter.Recorder.Type.moveLayer,{layerIdx:c,direction:a});Painter.HistoryManager.add("moveLayer",function(){f.getCanvas().insertBefore(j[c].getCanvas());
j.splice(d,1);j.splice(c,0,f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,"down");g.dispatchUpdateEvent();Painter.Recorder.removeAction(e)},function(){f.getCanvas().insertAfter(j[d].getCanvas());j.splice(c,1);j.splice(d,0,f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,"up");g.dispatchUpdateEvent();Painter.Recorder.addAction(e)})}}function c(){var b=j.indexOf(f),d=b-1;if(d>-1){var e=new Painter.Recorder.Action(Painter.Recorder.Type.moveLayer,{layerIdx:b,direction:a});
Painter.HistoryManager.add("moveLayer",function(){f.getCanvas().insertAfter(j[b].getCanvas());j.splice(d,1);j.splice(b,0,f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,"up");g.dispatchUpdateEvent();Painter.Recorder.removeAction(e)},function(){f.getCanvas().insertBefore(j[d].getCanvas());j.splice(b,1);j.splice(d,0,f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,"down");g.dispatchUpdateEvent();Painter.Recorder.addAction(e)})}}function d(){var b=j.indexOf(f);if(b!=
j.length-1){var c=new Painter.Recorder.Action(Painter.Recorder.Type.moveLayer,{layerIdx:b,direction:a});Painter.HistoryManager.add("moveLayer",function(){f.getCanvas().insertBefore(j[b].getCanvas());j.pop();j.splice(b,0,f);Painter.layerPanel.getLayerListController().moveTopItemToIdxByLayer(f,b);g.dispatchUpdateEvent();Painter.Recorder.removeAction(c)},function(){f.getCanvas().appendTo(k);j.splice(b,1);j.push(f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,"top");g.dispatchUpdateEvent();
Painter.Recorder.addAction(c)})}}function e(){var b=j.indexOf(f);if(b>0){var c=new Painter.Recorder.Action(Painter.Recorder.Type.moveLayer,{layerIdx:b,direction:a});Painter.HistoryManager.add("moveLayer",function(){f.getCanvas().insertAfter(j[b].getCanvas());j.shift();j.splice(b,0,f);Painter.layerPanel.getLayerListController().moveBottomItemToIdxByLayer(f,b);g.dispatchUpdateEvent();Painter.Recorder.removeAction(c)},function(){f.getCanvas().prependTo(k);j.splice(b,1);j.unshift(f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,
"bottom");g.dispatchUpdateEvent();Painter.Recorder.addAction(c)})}}var f=this.getSelectedLayer();if(f!=void 0)switch(a){case "up":b();break;case "down":c();break;case "top":d();break;case "bottom":e()}};this.changeSelectedLayerAlpha=function(a){var b=this.getSelectedLayer(),c=b.getAlpha(),d=j.indexOf(b),e=new Painter.Recorder.Action(Painter.Recorder.Type.setLayerAlpha,{layerIdx:d,alpha:a});Painter.HistoryManager.addEditAction("editLayer",c,a,function(c){Painter.layerPanel.getToolBarController().getAlphaSlider().setValue(c);
Painter.layerPanel.getLayerListController().setLayerAlpha(b,c);g.dispatchUpdateEvent();c==a?Painter.Recorder.addAction(e):Painter.Recorder.removeAction(e)})};this.setLayerVisible=function(a,b){var c=a.getVisible(),d=j.indexOf(a),e=new Painter.Recorder.Action(Painter.Recorder.Type.setLayerVisible,{layerIdx:d,visible:b});Painter.HistoryManager.addEditAction("editLayer",c,b,function(c){Painter.layerPanel.getLayerListController().setLayerVisible(a,c);g.dispatchUpdateEvent();c==b?Painter.Recorder.addAction(e):
Painter.Recorder.removeAction(e)})};this.setLayerName=function(a,b){var c=a.getName();c!=b&&Painter.HistoryManager.addEditAction("editLayer",c,b,function(b){Painter.layerPanel.getLayerListController().setLayerName(a,b)})};this.selectLayer=function(a){var b=this.getSelectedLayer();b!=a&&Painter.HistoryManager.addEditAction("selectLayer",b,a,function(a){c(a)})};this.zoomToLevel=function(a,b){if(a!=i){if(b==void 0)var c=this.view.offset().left+this.view.outerWidth()*0.5,d=this.view.offset().top+this.view.outerHeight()*
...
a.brushIdx=a.brushIdx==-1?0:a.brushIdx;a.brushSettings=this.brushSettings;a.mousedownPoint=this.mousedownPoint;a.mousemovePoints=this.mousemovePoints;a.mouseupPoint=this.mouseupPoint;return a}};Painter.PreviewView=function(){var a=$("#previewContainer"),b,c,d;this.init=function(f){d=f;b=$("<div>");b.css("position","absolute");b.css("background-image","url(assets/image/alphaBg.png)");b.appendTo(a);c=$("<canvas>");c.css("position","absolute");c.appendTo(b);this.update();var e=this;d.view.on("editCanvasUpdate",function(){e.update()})};this.update=function(){var f=a.prev().outerHeight(),e=d.size.width,g=d.size.height,h=a.outerWidth(),i=a.outerHeight()-f,k=h/e<i/g?h/e:i/g;e*=k;g*=k;h=(h-e)*0.5;
i=(i-g)*0.5;e=Math.round(e);g=Math.round(g);b.outerWidth(e);b.outerHeight(g);b.css("left",h);b.css("top",i+f);c.attr("width",e);c.attr("height",g);f=c.get(0).getContext("2d");f.clearRect(0,0,c.get(0).width,c.get(0).height);for(i=0;i<d.getLayers().length;){e=d.getLayers()[i];if(e.getVisible())h=e.getCanvas().get(0),f.save(),f.globalAlpha=e.getAlpha(),f.drawImage(h,0,0,h.width,h.height,0,0,c.get(0).width,c.get(0).height),f.restore();i++}}};Painter.HistoryPanel=function(){function a(){var a=Painter.HistoryManager.items.length,b=Painter.HistoryManager.idx;a==0?(d.addClass("disabled"),f.addClass("disabled"),e.addClass("disabled")):(e.removeClass("disabled"),b==a-1?(f.addClass("disabled"),d.removeClass("disabled")):(b==-1?d.addClass("disabled"):d.removeClass("disabled"),f.removeClass("disabled")));g.empty();a=Painter.HistoryManager.items.length;if(a==0)g.text("\u6ca1\u6709\u4efb\u4f55\u5386\u53f2\u8bb0\u5f55");else for(var b=[],c=Painter.HistoryManager.idx,
n=0;n<a;n++){var o=new Painter.HistoryItemView(Painter.HistoryManager.items[n]);o.view.prependTo(g);b.push(o);n==c&&b[n].view.addClass("active")}}var b=$("#historyPanel"),c=b.find(".ui.tab.segment .menu .item"),d=c.eq(0),f=c.eq(1),e=c.eq(2),g=b.find(".ui.tab.segment .list");a();d.click(function(){Painter.HistoryManager.undo()});f.click(function(){Painter.HistoryManager.redo()});e.click(function(){Painter.HistoryManager.removeAll()});$(document).bind(Painter.HistoryManager.UPDATE,a);this.getUndoAble=
...
this.unSelectItemByLayer=function(b){a(b).setSelected(!1)};this.removeItemByLayer=function(b){var b=a(b),c=g.indexOf(b);g.splice(c,1);b.view.remove()};this.setLayerAlpha=function(b,c){a(b).setAlpha(c)};this.setLayerVisible=function(b,c){a(b).setVisible(c)};this.setLayerName=function(b,c){a(b).setName(c)};this.moveItemByLayer=function(b,c){function k(){var a=g.indexOf(l),b=a+1;l.view.insertBefore(g[b].view);g.splice(a,1);g.splice(b,0,l)}function n(){var a=g.indexOf(l),b=a-1;l.view.insertAfter(g[b].view);
g.splice(a,1);g.splice(b,0,l)}function o(){var a=g.indexOf(l);l.view.prependTo(d);g.splice(a,1);g.push(l)}function j(){var a=g.indexOf(l);l.view.appendTo(d);g.splice(a,1);g.unshift(l)}var l=a(b);switch(c){case "up":k();break;case "down":n();break;case "top":o();break;case "bottom":j()}};this.moveTopItemToIdxByLayer=function(b,c){var d=a(b);d.view.insertAfter(g[c].view);g.pop();g.splice(c,0,d)};this.moveBottomItemToIdxByLayer=function(b,c){var d=a(b);d.view.insertBefore(g[c].view);g.shift();g.splice(c,
...
filter:new Painter.filter.SquareSmear},{label:"Black & White",filter:new Painter.filter.BlackWhite},{label:"Triangle Ripples",filter:new Painter.filter.TriangleRipples},{label:"Twirl",filter:new Painter.filter.Twirl},{label:"Vignette",filter:new Painter.filter.Vignette},{label:"Water Ripples",filter:new Painter.filter.WaterRipples}];$.each(i,function(b){$('<option value="'+b+'">'+this.label+"</option>").appendTo(c);if(this.filter!=void 0)this.filter.onChange=function(){a(this)}});f.click(function(){f.addClass("disabled");
b.modal("hide");var a=i[h].filter;a!=void 0&&Painter.editor.getEditorCanvas().applyFilterToSelectedLayer(a.getConfig())});c.dropdown({onChange:function(b){b=parseInt(b);d.empty();h=b;b=i[b].filter;b!=void 0&&b.descriptor.init(d);a(b)}});this.show=function(){b.modal("show");f.removeClass("disabled")}};Painter.filter={};
Painter.filter.BasicFilter=function(){var a=this;this.descriptor=new function(){function b(b,d){var f=b.name,e=b.label,g=b.min,h=b.max,i=b.value;switch(b.type){case "slider":e=Painter.FormViewManager.createSliderView(e);e.appendTo(d);a.initOption();(new Painter.Slider(e,g,h,i)).onChange=function(b){a.option[f]=Number(b);a.onChange()};break;case "checkbox":g=Painter.FormViewManager.createCheckBoxView(e);g.appendTo(d);a.initOption();var k=g.find(".ui.checkbox").eq(0);k.checkbox(i?"set checked":"set unchecked");
...
Base64.encode(a),b)},browser:function(a){var b=$("<input type='file'>");b.trigger("click");b.change(function(){var c=b.get(0).files[0];a(c)})},readText:function(a,b){$("#loadingMask").dimmer({closable:!1});$("#loadingMask").find(".ui.text.loader").text("\u6587\u4ef6\u8bfb\u53d6\u4e2d...");$("#loadingMask").dimmer("show");var c=new FileReader;c.onload=function(){$("#loadingMask").dimmer("hide");b(c.result)};c.readAsText(a)}};Painter.PathPlayer=function(){function a(){function a(){if(l!=void 0){e.outerWidth($(window).width());e.outerHeight($(window).height()-g.outerHeight());$(k).width($(window).width()-140);var b=l.width,c=l.height;i.initSize(b,c);var d=b+1E3,f=c+1E3,d=d>e.outerWidth()?d:e.outerWidth(),f=f>e.outerHeight()?f:e.outerHeight();h.outerWidth(d);h.outerHeight(f);c=(f-c)*0.5;i.view.css("left",(d-b)*0.5);i.view.css("top",c)}}f!=void 0?n.removeClass("disabled"):(f=$("#pathPlayerView"),e=f.find("#container"),g=
f.find(".ui.menu"),h=$("<div style='position:absolute;'></div>"),h.appendTo(e),i=new c,i.view.appendTo(h),k=f.find(".ui.slider").get(0),noUiSlider.create(k,{start:[0],connect:"lower",animate:!1,range:{min:[0],max:[1]}}),n=g.find(".item").eq(0),o=g.find(".item").eq(1),n.click(function(){d.stop();n.addClass("disabled");f.dimmer("hide")}),o.click(function(){d.isPlaying?d.pause():d.play()}),k.noUiSlider.on("start",function(){d.pause()}),k.noUiSlider.on("end",function(){var a=k.noUiSlider.get();d.seek(a)}),
...
c,d=a+1;d<b.length&&(h.getCanvas().insertAfter(b[d].getCanvas()),b.splice(a,1),b.splice(d,0,h))}function f(){var a=c,d=a-1;d>-1&&(h.getCanvas().insertBefore(b[d].getCanvas()),b.splice(a,1),b.splice(d,0,h))}function g(){var d=c;d!=b.length-1&&(h.getCanvas().appendTo(a),b.splice(d,1),b.push(h))}function i(){var d=c;d>0&&(h.getCanvas().prependTo(a),b.splice(d,1),b.unshift(h))}var h=b[c];switch(d){case "up":e();break;case "down":f();break;case "top":g();break;case "bottom":i()}};this.setLayerAlpha=function(a,
c){b[a].setAlpha(c)};this.setLayerVisible=function(a,c){b[a].setVisible(c)};this.setLayerData=function(a,c){var d=new Painter.LayerAction(Painter.LayerActionType.SetData,c);b[a].addAction(d)};this.setLayerBackgroundColor=function(a,c){var d=new Painter.LayerAction(Painter.LayerActionType.SetBackgroundColor,c);b[a].addAction(d)};this.setLayerFloodFill=function(a,c){var d=new Painter.LayerAction(Painter.LayerActionType.FloodFill,c);b[a].addAction(d)};this.setLayerApplyFilter=function(a,c){var d=new Painter.LayerAction(Painter.LayerActionType.ApplyFilter,
c);b[a].addAction(d)};this.paintLayerShapeByStep=function(a){var c=a.idx,d=a.len,e=b[a.action.layerIdx],a=a.action.action.shape,f=a.brushIdx,g=Painter.toolPanel.getBrush().items[f],f=Painter.toolPanel.getBrush().settingsItems[f].clone();f.applySettingsFromObj(a.brushSettings);g.useSettings(f);g.setDrawCanvasAndBufferCanvas(e.getCanvas().get(0),this.bufferCanvas.get(0));c==0?(this.bufferCanvas.insertAfter(e.getCanvas()),c=a.mousedownPoint,g.mousedown(c)):c==d-1?(c=a.mouseupPoint,g.mouseup(c),this.bufferCanvas.remove(),
c=new Painter.Shape({brush:g,brushSettings:f,mousedownPoint:a.mousedownPoint,mousemovePoints:a.mousemovePoints,mouseupPoint:a.mouseupPoint}),c=new Painter.LayerAction(Painter.LayerActionType.AddShape,c),e.addAction(c)):(c=a.mousemovePoints[c-1],g.mousemove(c))};this.clear=function(){for(;b.length>0;)this.removeLayer(0);this.bufferCanvas.remove()}}var d={},f,e,g,h,i,k,n,o,j,l,m=0,p,q=-1,r;d.isPlaying=!1;d.isPlayComplete=!1;d.play=function(){var a=o.find("i");a.removeClass("play");a.addClass("pause");
this.isPlaying=!0;if(this.isPlayComplete)i.clear(),this.isPlayComplete=!1,m=0,q=-1;this.enterFrame()};d.pause=function(){var a=o.find("i");a.addClass("play");a.removeClass("pause");this.isPlaying=!1;window.cancelAnimationFrame(j)};d.stop=function(){this.pause();k.noUiSlider.set(0);i.clear();this.isPlayComplete=!1;m=0;q=-1;r=p=l=void 0};d.seek=function(a){m=Number(a);d.isPlayComplete=m==1;this.paint()};d.enterFrame=function(){m=m>1?1:m;k.noUiSlider.set(m);d.paint();m==1?(d.pause(),d.isPlayComplete=
!0):(m+=1/p.length,j=window.requestAnimationFrame(arguments.callee))};d.playCurrent=function(){this.open(Painter.File.getPaintPathString())};d.open=function(a){l=JSON.parse(a);p=this.getSteps();this.show();var b=f.find(".ui.dimmer");b.dimmer({closable:!1});b.dimmer("show");(function(a){function b(a,c){var d=new Image;d.onload=function(){var b=r,d=a[0],e;f.width=this.width;f.height=this.height;e=f.getContext("2d");e.drawImage(this,0,0,this.width,this.height,0,0,f.width,f.height);e=e.getImageData(0,
0,f.width,f.height);b[d]=e;c()};d.src=a[1]}var c=[],d=l.actions,e=0,f=$("<canvas>").get(0);for(r=[];e<d.length;){var g=d[e];if(g.type==Painter.Recorder.Type.drawLayer)if(g.action.type==Painter.LayerActionType.AddShape){var g=g.action.shape,h;if(g.brushSettings.material!=void 0&&g.brushSettings.material!="")h=g.brushSettings.material;else if(g.brushSettings.shape!=void 0)h=g.brushSettings.shape.src;h!=void 0&&c.indexOf(h)==-1&&c.push([e,h])}else g.action.type==Painter.LayerActionType.SetData&&c.push([e,
...
g,f)),g++;else a.push(new b(e,0,1))}else a.push(new b(e,0,1));d++}return a};d.paint=function(){var a=Math.round(m*(p.length-1));if(q!=a){if(a>q)for(var b=q;a-b!=0;)b++,this.addStep(b);else this.startStepTo(a);q=a}};d.addStep=function(a){a=p[a];if(a.len==1)switch(a.action.type){case Painter.Recorder.Type.newLayer:i.newLayer(a.action.toIdx);break;case Painter.Recorder.Type.removeLayer:i.removeLayer(a.action.layerIdx);break;case Painter.Recorder.Type.moveLayer:i.moveLayer(a.action.layerIdx,a.action.direction);
break;case Painter.Recorder.Type.setLayerAlpha:i.setLayerAlpha(a.action.layerIdx,a.action.alpha);break;case Painter.Recorder.Type.setLayerVisible:i.setLayerVisible(a.action.layerIdx,a.action.visible);break;case Painter.Recorder.Type.drawLayer:switch(a.action.action.type){case Painter.LayerActionType.SetBackgroundColor:i.setLayerBackgroundColor(a.action.layerIdx,a.action.action.backgroundColor);break;case Painter.LayerActionType.FloodFill:i.setLayerFloodFill(a.action.layerIdx,a.action.action.floodFill);
break;case Painter.LayerActionType.ApplyFilter:i.setLayerApplyFilter(a.action.layerIdx,a.action.action.filter);break;case Painter.LayerActionType.SetData:var b=r[l.actions.indexOf(a.action)];i.setLayerData(a.action.layerIdx,b)}}else i.paintLayerShapeByStep(a)};d.startStepTo=function(a){i.clear();for(var b=-1;a-b!=0;)b++,this.addStep(b)};return d}();Painter.InputWin=function(a){var b=$(a),c=b.find(".header i").eq(0),d=b.find(".header label").eq(0),f=b.find("input").eq(0),e=b.find(".right.labeled .label").eq(0),g=b.find(".actions button").eq(0),h;g.click(function(){g.addClass("disabled");b.modal("hide");h!=void 0&&h(f.val())});this.setOption=function(a){c.attr("class",a.icon);d.text(a.title);f.attr("placeholder",a.placeholder);e.text(a.rightlabel);g.text(a.submitLabel);f.val(a.value);h=a.onSubmit};this.show=function(a){this.setOption(a);g.removeClass("disabled");
