...
new Painter.FilterWin;this.settingWin=new Painter.SettingWin("#settingWin");this.inputWin=new Painter.InputWin("#inputWin");this.editCanvasSizeWin=new Painter.EditCanvasSizeWin("#eidtCanvasSizeWin");this.onlineFileWin=new Painter.OnlineFileWin("#onlineFileWin")};$(function(){Painter.init()});Painter.MainLayout=function(a){function b(){c.outerWidth(k);f.outerWidth(m);var a=$(window).width()-k-m-e.outerWidth()-g.outerWidth();d.outerWidth(a);var b=$(window).height()-$("#topMenu").outerHeight();c.outerHeight(b);f.outerHeight(b);d.outerHeight(b);d.css("left",k+e.outerWidth());f.css("left",k+a+e.outerWidth()+g.outerWidth());e.outerHeight(b);g.outerHeight(b);e.css("left",k);g.css("left",k+a+e.outerWidth());o.outerWidth(m);o.outerHeight(n);i.outerWidth(m);a=b-n-l.outerHeight();i.outerHeight(a);
l.css("top",n);i.css("top",n+l.outerHeight());a=a-u-10;p.outerHeight(a);q.outerHeight(a-r.outerHeight());s.outerHeight(a);v.update()}this.view=$(a);var c=this.view.find("#leftBox"),d=this.view.find("#centerBox"),f=this.view.find("#rightBox"),a=this.view.find(".vDivide"),e=a.eq(0),g=a.eq(1),h=e.find(".handle"),j=g.find(".handle"),k=51,m=320;h.click(function(){k=k==51?0:51;b()});j.click(function(){m=m==320?0:320;b()});c.css("position","absolute");d.css("position","absolute");f.css("position","absolute");
var o=f.find("#topBox"),i=f.find("#bottomBox"),l=f.find(".hDivide"),n=200;l.click(function(){n=n==200?0:200;b()});o.css("position","absolute");i.css("position","absolute");this.view.find(".menu.tabular .item").tab();var p=this.view.find("#layerPanel .segment");p.css("padding",5);p.css("overflow","hidden");var q=this.view.find("#propertiesPanel .segment");q.css("overflow","auto");var r=this.view.find("#propertiesPanel #header"),s=this.view.find("#historyPanel .segment");s.css("padding",5);s.css("overflow",
"auto");var u=this.view.find(".menu.tabular").outerHeight(),v=new function(){var a=p.find("#listContainer");this.update=function(){var b=p.outerHeight()-95;a.outerHeight(b)}};$(window).resize(b);b();this.toggleLeft=function(){h.trigger("click")};this.toggleRight=function(){j.trigger("click")};this.toggleRightTop=function(){l.trigger("click")}};Painter.TopMenu=function(a){function b(){$.each(f,function(){this.update()})}function c(a){function b(){if(d!="")Painter.KeyboardManager.execute(d);else switch(c){case "\u5bfc\u51fa\u56fe\u7247":Painter.KeyboardManager.execute("export");break;case "\u952e\u76d8\u5feb\u6377\u952e":Painter.KeyboardManager.execute("showQuickKey");break;case "\u64ad\u653e\u5f53\u524d\u7ed8\u753b\u8fc7\u7a0b":Painter.KeyboardManager.execute("playPaintPath");break;case "\u5173\u4e8ePainter":Painter.KeyboardManager.execute("about");
...
3;break;case "\u653e\u5927\u955c":a=Painter.toolPanel.getCurrentToolIdx()!=4}this.setEnabled(a)};this.setEnabled=function(b){b?a.removeClass("disabled"):a.addClass("disabled")}}this.view=$(a);a=this.view.find(".ui.dropdown:not(.right.menu .ui.dropdown)");a.dropdown({on:"hover",onShow:function(){b()}});var d=a.find(".item"),f=[];d.each(function(){f.push(new c($(this)))});this.zoomMenuController=new function(a){var b=[0.06,0.12,0.25,0.5,0.66,1,2,3,4,8,16,32,64];$.each(b,function(c){$('<a class="item" data-value="'+
c+'">'+b[c]*100+"%</a>").appendTo(a.find(".menu").eq(0))});a.dropdown({onChange:function(a){Painter.editor.getEditorCanvas().zoomToLevel(Number(a))}});this.selectValue=function(c){a.dropdown("set text",b[c]*100+"%")};this.selectValue(5)}(this.view.find(".right.menu .ui.dropdown").eq(0));this.panelMenuController=new function(a){var b,c={properties:$("#propertiesPanel"),history:$("#historyPanel"),layers:$("#layerPanel")};$.each(c,function(){$(this).css("display","none")});this.selectValue=function(b){a.dropdown("set selected",
b)};this.getSelectedValue=function(){return b};this.getMenu=function(){return a};a.dropdown({onChange:function(a){b!=void 0&&c[b].css("display","none");b=a;c[b].css("display","block")}});this.selectValue("layers")}(this.view.find(".right.menu .ui.dropdown").eq(1));this.getItems=function(){return d}};Painter.Editor=function(a){function b(){var b=d.view.outerWidth()+1E3,e=d.view.outerHeight()+1E3,b=b>a.outerWidth()?b:a.outerWidth(),e=e>a.outerHeight()?e:a.outerHeight();c.outerWidth(b);c.outerHeight(e);b=(b-d.view.outerWidth())*0.5;e=(e-d.view.outerHeight())*0.5;d.view.css("left",b);d.view.css("top",e)}this.view=$("<div style='position:absolute;'></div>");this.view.outerWidth("100%");this.view.outerHeight("100%");this.view.css("overflow","auto");this.view.appendTo(a);var c=$("<div style='position:absolute;'></div>");
c.appendTo(this.view);var d=new Painter.EditorCanvas(c);this.getEditorCanvas=function(){return d};this.scrollToCenter=function(){this.view.scrollTop((c.outerHeight()-a.outerHeight())*0.5);this.view.scrollLeft((c.outerWidth()-a.outerWidth())*0.5)};this.updateSize=function(){b()};$(window).resize(b);b();this.scrollToCenter()};Painter.EditorCanvas=function(a){function b(a,b){b==void 0||b!=void 0&&b>i.length-1?(a.getCanvas().appendTo(k),i.push(a)):(a.getCanvas().insertBefore(i[b].getCanvas()),i.splice(b,0,a));Painter.layerPanel.getLayerListController().addItem(a,b)}function c(a){l!=void 0&&Painter.layerPanel.getLayerListController().unSelectItemByLayer(l);l=a;a!=void 0&&Painter.layerPanel.getLayerListController().selectItemByLayer(a)}function d(a){var b=i.indexOf(a);i.splice(b,1);a.getCanvas().remove();Painter.layerPanel.getLayerListController().removeItemByLayer(a);
l===a&&(l=void 0)}function f(a,b){g.size.width=a;g.size.height=b;g.view.outerWidth(a*g.scale);g.view.outerHeight(b*g.scale);for(var c=0;c<i.length;){var d=i[c],e=d.getCanvas();e.get(0).width=a;e.get(0).height=b;d.repaint();c++}g.bufferCanvas.get(0).width=a;g.bufferCanvas.get(0).height=b;Painter.editor.updateSize()}function e(a){a=i.indexOf(a);if(a+1<i.length)return i[a+1];else if(a-1>-1&&i.length>0)return i[a-1]}var g=this;this.size={width:800,height:600};this.scale=1;var h=[0.06,0.12,0.25,0.5,0.66,
1,2,3,4,8,16,32,64],j=5;this.view=$("<div style='position:absolute;'></div>");this.view.outerWidth(this.size.width);this.view.outerHeight(this.size.height);this.view.appendTo(a);this.view.css("background-image","url(assets/image/alphaBg.png)");var k=$("<div style='position:absolute;'></div>");k.appendTo(this.view);var m=$("<div style='position:absolute;'></div>");m.appendTo(this.view);var o=$("<div style='position:absolute;width:100%;height:100%'></div>");o.appendTo(this.view);this.bufferCanvas=$("<canvas>",
{style:"position:absolute;"});this.bufferCanvas.attr("width",this.size.width);this.bufferCanvas.attr("height",this.size.height);var i=[],l,n,a=new Painter.Layer(this);a.setName("\u80cc\u666f\u5c42");var p=new Painter.LayerAction(Painter.LayerActionType.SetBackgroundColor,"#ffffff");a.addAction(p);b(a);c(a);Painter.Recorder.addAction(new Painter.Recorder.Action(Painter.Recorder.Type.newLayer));Painter.Recorder.addAction(new Painter.Recorder.Action(Painter.Recorder.Type.drawLayer,{layerIdx:0,action:p}));
(function(){o.mouseover(function(){n!=void 0&&n.view.show()});o.on("mouseout",function(){n!=void 0&&n.view.hide()});$(document).mousemove(function(a){n!=void 0&&n.view.offset({left:a.clientX,top:a.clientY})});o.mousedown(function(a){function b(a){a=g.globalToLocalPoint(new Painter.Point(a.clientX,a.clientY));e.mousemove(a)}function c(a){$(document).off("mousemove",b);$(document).off("mouseup",c);a=g.globalToLocalPoint(new Painter.Point(a.clientX,a.clientY));e.mouseup(a);f.remove();g.addLayerAction(d,
e.getAction())}a.preventDefault();var d=g.getSelectedLayer();if(d!=void 0){$(document).on("mousemove",b);$(document).on("mouseup",c);var e=Painter.toolPanel.getCurrentTool(),f=g.bufferCanvas;f.insertAfter(d.getCanvas());a=g.globalToLocalPoint(new Painter.Point(a.clientX,a.clientY));e.setDrawCanvasAndBufferCanvas(d.getCanvas().get(0),f.get(0));e.mousedown(a)}})})();this.globalToLocalPoint=function(a){var b=a.x-this.view.offset().left,a=a.y-this.view.offset().top;b/=this.scale;a/=this.scale;return new Painter.Point(b,
a)};this.open=function(a){var e=JSON.parse(a);$("#loadingMask").dimmer({closable:!1});$("#loadingMask").find(".ui.text.loader").text("\u9884\u52a0\u8f7d\u56fe\u5c42");$("#loadingMask").dimmer("show");var h=[];(function(a){function b(a,d){var g=new Image;g.onload=function(){h.push(c(this));d()};g.src=a}function c(a){g.width=a.width;g.height=a.height;var b=g.getContext("2d");b.drawImage(a,0,0,a.width,a.height,0,0,g.width,g.height);return b.getImageData(0,0,g.width,g.height)}var d=0,g=$("<canvas>").get(0);
e.layers.length==0?a():(d=0,b(e.layers[d].data,function(){d++;d==e.layers.length?a():b(e.layers[d].data,arguments.callee)}))})(function(){for($("#loadingMask").dimmer("hide");i.length>0;)d(i[0]);Painter.HistoryManager.removeAll();Painter.Recorder.removeAll();g.zoomToLevel(5);var a={width:e.width,height:e.height};f(a.width,a.height);Painter.editor.scrollToCenter();for(a=0;a<e.layers.length;a++){var j=e.layers[a],t=new Painter.Layer(g);t.setName(j.name);t.setAlpha(j.alpha);t.setVisible(j.visible);var k=
new Painter.LayerAction(Painter.LayerActionType.SetData,h[a]);t.addAction(k);b(t);Painter.Recorder.addAction(new Painter.Recorder.Action(Painter.Recorder.Type.newLayer));Painter.Recorder.addAction(new Painter.Recorder.Action(Painter.Recorder.Type.setLayerAlpha,{layerIdx:a,alpha:j.alpha}));Painter.Recorder.addAction(new Painter.Recorder.Action(Painter.Recorder.Type.setLayerVisible,{layerIdx:a,visible:j.visible}));Painter.Recorder.addAction(new Painter.Recorder.Action(Painter.Recorder.Type.drawLayer,
{layerIdx:a,action:k}))}c(i[i.length-1]);g.dispatchUpdateEvent()})};this.setCursor=function(a){o.css("cursor",a)};this.setDragView=function(a){n=a;m.empty();n!=void 0&&(n.view.hide(),n.view.appendTo(m))};this.getSelectedLayer=function(){return l};this.getLayers=function(){return i};this.dispatchUpdateEvent=function(){this.view.trigger("editCanvasUpdate")};this.setSize=function(a,b){Painter.HistoryManager.addEditAction("changeSize",{width:g.size.width,height:g.size.height},{width:a,height:b},function(a){f(a.width,
a.height);g.dispatchUpdateEvent()})};this.addLayerAction=function(a,b){if(b!=void 0){var c=new Painter.Recorder.Action(Painter.Recorder.Type.drawLayer,{layerIdx:i.indexOf(a),action:b});Painter.HistoryManager.add("paint",function(){a.removeAction(b);Painter.Recorder.removeAction(c);g.dispatchUpdateEvent()},function(){a.addAction(b);Painter.Recorder.addAction(c);g.dispatchUpdateEvent()})}};this.applyFilterToSelectedLayer=function(a){var b=this.getSelectedLayer();b!=void 0&&(a=new Painter.LayerAction(Painter.LayerActionType.ApplyFilter,
a),this.addLayerAction(b,a))};this.newLayer=function(){var a=this.getSelectedLayer(),g=new Painter.Layer(this);g.setName("\u65b0\u56fe\u5c42");var e=a!=void 0?i.indexOf(a)+1:void 0,f=new Painter.Recorder.Action(Painter.Recorder.Type.newLayer,e);Painter.HistoryManager.add("newLayer",function(){d(g);c(a);Painter.Recorder.removeAction(f)},function(){b(g,e);c(g);Painter.Recorder.addAction(f)})};this.removeSelectedLayer=function(){var a=this.getSelectedLayer(),f=i.indexOf(a);if(a!=void 0){var h=e(a),j=
new Painter.Recorder.Action(Painter.Recorder.Type.removeLayer,f);Painter.HistoryManager.add("removeLayer",function(){b(a,f);c(a);g.dispatchUpdateEvent();Painter.Recorder.removeAction(j)},function(){d(a);h!=void 0&&c(h);g.dispatchUpdateEvent();Painter.Recorder.addAction(j)})}};this.moveSelectedLayer=function(a){function b(){var c=i.indexOf(f),d=c+1;if(d<i.length){var e=new Painter.Recorder.Action(Painter.Recorder.Type.moveLayer,{layerIdx:c,direction:a});Painter.HistoryManager.add("moveLayer",function(){f.getCanvas().insertBefore(i[c].getCanvas());
i.splice(d,1);i.splice(c,0,f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,"down");g.dispatchUpdateEvent();Painter.Recorder.removeAction(e)},function(){f.getCanvas().insertAfter(i[d].getCanvas());i.splice(c,1);i.splice(d,0,f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,"up");g.dispatchUpdateEvent();Painter.Recorder.addAction(e)})}}function c(){var b=i.indexOf(f),d=b-1;if(d>-1){var e=new Painter.Recorder.Action(Painter.Recorder.Type.moveLayer,{layerIdx:b,direction:a});
Painter.HistoryManager.add("moveLayer",function(){f.getCanvas().insertAfter(i[b].getCanvas());i.splice(d,1);i.splice(b,0,f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,"up");g.dispatchUpdateEvent();Painter.Recorder.removeAction(e)},function(){f.getCanvas().insertBefore(i[d].getCanvas());i.splice(b,1);i.splice(d,0,f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,"down");g.dispatchUpdateEvent();Painter.Recorder.addAction(e)})}}function d(){var b=i.indexOf(f);if(b!=
i.length-1){var c=new Painter.Recorder.Action(Painter.Recorder.Type.moveLayer,{layerIdx:b,direction:a});Painter.HistoryManager.add("moveLayer",function(){f.getCanvas().insertBefore(i[b].getCanvas());i.pop();i.splice(b,0,f);Painter.layerPanel.getLayerListController().moveTopItemToIdxByLayer(f,b);g.dispatchUpdateEvent();Painter.Recorder.removeAction(c)},function(){f.getCanvas().appendTo(k);i.splice(b,1);i.push(f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,"top");g.dispatchUpdateEvent();
Painter.Recorder.addAction(c)})}}function e(){var b=i.indexOf(f);if(b>0){var c=new Painter.Recorder.Action(Painter.Recorder.Type.moveLayer,{layerIdx:b,direction:a});Painter.HistoryManager.add("moveLayer",function(){f.getCanvas().insertAfter(i[b].getCanvas());i.shift();i.splice(b,0,f);Painter.layerPanel.getLayerListController().moveBottomItemToIdxByLayer(f,b);g.dispatchUpdateEvent();Painter.Recorder.removeAction(c)},function(){f.getCanvas().prependTo(k);i.splice(b,1);i.unshift(f);Painter.layerPanel.getLayerListController().moveItemByLayer(f,
"bottom");g.dispatchUpdateEvent();Painter.Recorder.addAction(c)})}}var f=this.getSelectedLayer();if(f!=void 0)switch(a){case "up":b();break;case "down":c();break;case "top":d();break;case "bottom":e()}};this.changeSelectedLayerAlpha=function(a){var b=this.getSelectedLayer(),c=b.getAlpha(),d=i.indexOf(b),e=new Painter.Recorder.Action(Painter.Recorder.Type.setLayerAlpha,{layerIdx:d,alpha:a});Painter.HistoryManager.addEditAction("editLayer",c,a,function(c){Painter.layerPanel.getToolBarController().getAlphaSlider().setValue(c);
Painter.layerPanel.getLayerListController().setLayerAlpha(b,c);g.dispatchUpdateEvent();c==a?Painter.Recorder.addAction(e):Painter.Recorder.removeAction(e)})};this.setLayerVisible=function(a,b){var c=a.getVisible(),d=i.indexOf(a),e=new Painter.Recorder.Action(Painter.Recorder.Type.setLayerVisible,{layerIdx:d,visible:b});Painter.HistoryManager.addEditAction("editLayer",c,b,function(c){Painter.layerPanel.getLayerListController().setLayerVisible(a,c);g.dispatchUpdateEvent();c==b?Painter.Recorder.addAction(e):
Painter.Recorder.removeAction(e)})};this.setLayerName=function(a,b){var c=a.getName();c!=b&&Painter.HistoryManager.addEditAction("editLayer",c,b,function(b){Painter.layerPanel.getLayerListController().setLayerName(a,b)})};this.selectLayer=function(a){var b=this.getSelectedLayer();b!=a&&Painter.HistoryManager.addEditAction("selectLayer",b,a,function(a){c(a)})};this.zoomToLevel=function(a,b){if(a!=j){if(b==void 0)var c=this.view.offset().left+this.view.outerWidth()*0.5,d=this.view.offset().top+this.view.outerHeight()*
0.5,b=this.globalToLocalPoint(new Painter.Point(c,d));var c=h[a],d=Painter.editor.view.scrollLeft(),g=Painter.editor.view.scrollTop();k.css("-webkit-transform","scale("+c+")");this.view.outerWidth(this.size.width*c);this.view.outerHeight(this.size.height*c);Painter.toolPanel.getBrush().getDragView().setScale(c);Painter.toolPanel.getEraser().getDragView().setScale(c);Painter.editor.updateSize();d+=(c-this.scale)*b.x;g+=(c-this.scale)*b.y;Painter.editor.view.scrollLeft(d);Painter.editor.view.scrollTop(g);
Painter.topMenu.zoomMenuController.selectValue(a);this.scale=c;j=a}};this.zoomIn=function(a){var b=j+1;b<h.length&&this.zoomToLevel(b,a)};this.zoomOut=function(a){var b=j-1;b>0&&this.zoomToLevel(b,a)};Painter.previewView.init(this)};Painter.ToolPanel=function(){function a(a){d!=void 0&&d.removeClass("basic violet active");d=a;d.addClass("basic violet active");a=b.getCurrentTool();Painter.propertiesPanel.setTargets([a]);Painter.editor.getEditorCanvas().setCursor(a.getCursor());Painter.editor.getEditorCanvas().setDragView(a.getDragView())}var b=this,c=$("#toolPanel").find("button");c.each(function(){$(this).click(function(){var a=c.index($(this));b.switchToolIdx(a)})});var d,f=[new Painter.Brush,new Painter.Eraser,new Painter.ColorSucker,
new Painter.PaintBucket,new Painter.Zoomer];this.getCurrentToolIdx=function(){return c.index(d)};this.getCurrentTool=function(){var a=this.getCurrentToolIdx();return f[a]};this.getBrush=function(){return f[0]};this.getEraser=function(){return f[1]};this.getPaintBucket=function(){return f[3]};this.switchToolIdx=function(b){var d=this.getCurrentTool();Painter.HistoryManager.addEditAction("switchTool",d,f[b],function(b){b=f.indexOf(b);a(c.eq(b))})};a(c.eq(0))};Painter.Brush=function(){this.items=[new Painter.LineBrush,new Painter.ShapeBrush];this.settingsItems=[new Painter.LineBrushSettings,new Painter.ShapeBrushSettings];this.brushIcons=["write","paint brush"];this.selectedBrush=this.items[0];this.descriptor=new Painter.BrushDescriptor(this);var a;this.getSettingsByItem=function(a){return this.settingsItems[this.items.indexOf(a)]};this.getCursor=function(){return"url(assets/image/cursors/CrossHair.gif) 7 7,auto"};this.getDragView=function(){return this.selectedBrush.getDragView()};
...
a.brushIdx=a.brushIdx==-1?0:a.brushIdx;a.brushSettings=this.brushSettings;a.mousedownPoint=this.mousedownPoint;a.mousemovePoints=this.mousemovePoints;a.mouseupPoint=this.mouseupPoint;return a}};Painter.PreviewView=function(){var a=$("#previewContainer"),b,c,d;this.init=function(f){d=f;b=$("<div>");b.css("position","absolute");b.css("background-image","url(assets/image/alphaBg.png)");b.appendTo(a);c=$("<canvas>");c.css("position","absolute");c.appendTo(b);this.update();var e=this;d.view.on("editCanvasUpdate",function(){e.update()})};this.update=function(){var f=a.prev().outerHeight(),e=d.size.width,g=d.size.height,h=a.outerWidth(),j=a.outerHeight()-f,k=h/e<j/g?h/e:j/g;e*=k;g*=k;h=(h-e)*0.5;
j=(j-g)*0.5;e=Math.round(e);g=Math.round(g);b.outerWidth(e);b.outerHeight(g);b.css("left",h);b.css("top",j+f);c.attr("width",e);c.attr("height",g);f=c.get(0).getContext("2d");f.clearRect(0,0,c.get(0).width,c.get(0).height);for(j=0;j<d.getLayers().length;){e=d.getLayers()[j];if(e.getVisible())h=e.getCanvas().get(0),f.save(),f.globalAlpha=e.getAlpha(),f.drawImage(h,0,0,h.width,h.height,0,0,c.get(0).width,c.get(0).height),f.restore();j++}}};Painter.HistoryPanel=function(){function a(){var a=Painter.HistoryManager.items.length,b=Painter.HistoryManager.idx;a==0?(d.addClass("disabled"),f.addClass("disabled"),e.addClass("disabled")):(e.removeClass("disabled"),b==a-1?(f.addClass("disabled"),d.removeClass("disabled")):(b==-1?d.addClass("disabled"):d.removeClass("disabled"),f.removeClass("disabled")));g.empty();a=Painter.HistoryManager.items.length;if(a==0)g.text("\u6ca1\u6709\u4efb\u4f55\u5386\u53f2\u8bb0\u5f55");else for(var b=[],c=Painter.HistoryManager.idx,
m=0;m<a;m++){var o=new Painter.HistoryItemView(Painter.HistoryManager.items[m]);o.view.prependTo(g);b.push(o);m==c&&b[m].view.addClass("active")}}var b=$("#historyPanel"),c=b.find(".ui.tab.segment .menu .item"),d=c.eq(0),f=c.eq(1),e=c.eq(2),g=b.find(".ui.tab.segment .list");a();d.click(function(){Painter.HistoryManager.undo()});f.click(function(){Painter.HistoryManager.redo()});e.click(function(){Painter.HistoryManager.removeAll()});$(document).bind(Painter.HistoryManager.UPDATE,a);this.getUndoAble=
...
this.unSelectItemByLayer=function(b){a(b).setSelected(!1)};this.removeItemByLayer=function(b){var b=a(b),c=g.indexOf(b);g.splice(c,1);b.view.remove()};this.setLayerAlpha=function(b,c){a(b).setAlpha(c)};this.setLayerVisible=function(b,c){a(b).setVisible(c)};this.setLayerName=function(b,c){a(b).setName(c)};this.moveItemByLayer=function(b,c){function k(){var a=g.indexOf(l),b=a+1;l.view.insertBefore(g[b].view);g.splice(a,1);g.splice(b,0,l)}function m(){var a=g.indexOf(l),b=a-1;l.view.insertAfter(g[b].view);
g.splice(a,1);g.splice(b,0,l)}function o(){var a=g.indexOf(l);l.view.prependTo(d);g.splice(a,1);g.push(l)}function i(){var a=g.indexOf(l);l.view.appendTo(d);g.splice(a,1);g.unshift(l)}var l=a(b);switch(c){case "up":k();break;case "down":m();break;case "top":o();break;case "bottom":i()}};this.moveTopItemToIdxByLayer=function(b,c){var d=a(b);d.view.insertAfter(g[c].view);g.pop();g.splice(c,0,d)};this.moveBottomItemToIdxByLayer=function(b,c){var d=a(b);d.view.insertBefore(g[c].view);g.shift();g.splice(c,
...
a.shiftKey&&Painter.KeyboardManager.execute("Shift+3");break;case 52:a.shiftKey&&Painter.KeyboardManager.execute("Shift+4");case 53:a.shiftKey&&Painter.KeyboardManager.execute("Shift+5");break;case 38:a.preventDefault();a.ctrlKey&&a.shiftKey?Painter.KeyboardManager.execute("Ctrl+Shift+\u2191"):a.ctrlKey&&Painter.KeyboardManager.execute("Ctrl+\u2191");break;case 40:a.preventDefault();a.ctrlKey&&a.shiftKey?Painter.KeyboardManager.execute("Ctrl+Shift+\u2193"):a.ctrlKey&&Painter.KeyboardManager.execute("Ctrl+\u2193");
break;case 70:a.ctrlKey&&Painter.KeyboardManager.execute("Ctrl+F");break;case 85:a.ctrlKey&&Painter.KeyboardManager.execute("Ctrl+U")}})};
...
filter:new Painter.filter.SquareSmear},{label:"Black & White",filter:new Painter.filter.BlackWhite},{label:"Triangle Ripples",filter:new Painter.filter.TriangleRipples},{label:"Twirl",filter:new Painter.filter.Twirl},{label:"Vignette",filter:new Painter.filter.Vignette},{label:"Water Ripples",filter:new Painter.filter.WaterRipples}];$.each(j,function(b){$('<option value="'+b+'">'+this.label+"</option>").appendTo(c);if(this.filter!=void 0)this.filter.onChange=function(){a(this)}});f.click(function(){f.addClass("disabled");
b.modal("hide");var a=j[h].filter;a!=void 0&&Painter.editor.getEditorCanvas().applyFilterToSelectedLayer(a.getConfig())});c.dropdown({onChange:function(b){b=parseInt(b);d.empty();h=b;b=j[b].filter;b!=void 0&&b.descriptor.init(d);a(b)}});this.show=function(){b.modal("show");f.removeClass("disabled")}};Painter.filter={};
Painter.filter.BasicFilter=function(){var a=this;this.descriptor=new function(){function b(b,d){var f=b.name,e=b.label,g=b.min,h=b.max,j=b.value;switch(b.type){case "slider":e=Painter.FormViewManager.createSliderView(e);e.appendTo(d);a.initOption();(new Painter.Slider(e,g,h,j)).onChange=function(b){a.option[f]=Number(b);a.onChange()};break;case "checkbox":g=Painter.FormViewManager.createCheckBoxView(e);g.appendTo(d);a.initOption();var k=g.find(".ui.checkbox").eq(0);k.checkbox(j?"set checked":"set unchecked");
...
title:"\u4fdd\u5b58\u6587\u4ef6",placeholder:"\u8f93\u5165\u6587\u4ef6\u540d\u79f0",rightlabel:".paint",value:"paint-"+(new Date).getTime(),submitLabel:"\u4fdd\u5b58",onSubmit:function(b){for(var c=Painter.editor.getEditorCanvas(),d={width:c.size.width,height:c.size.height,layers:[]},c=c.getLayers(),f=0;f<c.length;){var e=c[f],g=e.getCanvas(),e={name:e.getName(),alpha:e.getAlpha(),visible:e.getVisible(),data:g.get(0).toDataURL("png")};d.layers.push(e);f++}d=JSON.stringify(d);a.saveText(d,b+".paint")}})},
getPaintPathString:function(){for(var a=Painter.editor.getEditorCanvas(),a={width:a.size.width,height:a.size.height,actions:[]},b=Painter.Recorder.getActions(),c=0;c<b.length;){var d=b[c].getJsonObj();a.actions.push(d);c++}return JSON.stringify(a)},savePaintPathFile:function(){var a=this;Painter.inputWin.show({icon:"save icon",title:"\u4fdd\u5b58\u7ed8\u753b\u8fc7\u7a0b",placeholder:"\u8f93\u5165\u6587\u4ef6\u540d\u79f0",rightlabel:".process",value:"paint-process-"+(new Date).getTime(),submitLabel:"\u4fdd\u5b58",
onSubmit:function(b){var c=a.getPaintPathString();a.saveText(c,b+".process")}})},exportImage:function(){var a=this;Painter.inputWin.show({icon:"file image outline icon",title:"\u5bfc\u51fa\u56fe\u7247",placeholder:"\u8f93\u5165\u56fe\u7247\u540d\u79f0",rightlabel:".png",value:"export-"+(new Date).getTime(),submitLabel:"\u5bfc\u51fa",onSubmit:function(b){var c=Painter.editor.getEditorCanvas(),d=$("<canvas>"),f=c.size.height;d.attr("width",c.size.width);d.attr("height",f);f=d.get(0).getContext("2d");
f.clearRect(0,0,d.get(0).width,d.get(0).height);for(var e=0;e<c.getLayers().length;){var g=c.getLayers()[e];if(g.getVisible()){var h=g.getCanvas().get(0);f.save();f.globalAlpha=g.getAlpha();f.drawImage(h,0,0,h.width,h.height,0,0,d.get(0).width,d.get(0).height);f.restore()}e++}c=d.get(0).toDataURL("png");c=c.replace("image/png","image/octet-stream");a.saveData(c,b+".png")}})},saveData:function(a,b){var c=$("<a>");c.attr("href",a);c.attr("download",b);c.get(0).click()},saveText:function(a,b){this.saveData("data:application/octet-stream;base64,"+
Base64.encode(a),b)},browser:function(a){var b=$("<input type='file'>");b.trigger("click");b.change(function(){var c=b.get(0).files[0];a(c)})},readText:function(a,b){$("#loadingMask").dimmer({closable:!1});$("#loadingMask").find(".ui.text.loader").text("\u6587\u4ef6\u8bfb\u53d6\u4e2d...");$("#loadingMask").dimmer("show");var c=new FileReader;c.onload=function(){$("#loadingMask").dimmer("hide");b(c.result)};c.readAsText(a)}};Painter.PathPlayer=function(){function a(){function a(){if(n!=void 0){e.outerWidth($(window).width());e.outerHeight($(window).height()-g.outerHeight());$(k).width($(window).width()-140-i.outerWidth());var b=n.width,c=n.height;j.initSize(b,c);var d=b+1E3,f=c+1E3,d=d>e.outerWidth()?d:e.outerWidth(),f=f>e.outerHeight()?f:e.outerHeight();h.outerWidth(d);h.outerHeight(f);c=(f-c)*0.5;j.view.css("left",(d-b)*0.5);j.view.css("top",c)}}f!=void 0?m.removeClass("disabled"):(f=$("#pathPlayerView"),e=f.find("#container"),
g=f.find(".ui.menu"),h=$("<div style='position:absolute;'></div>"),h.appendTo(e),j=new c,j.view.appendTo(h),k=f.find(".ui.slider").get(0),noUiSlider.create(k,{start:[0],connect:"lower",animate:!1,range:{min:[0],max:[1]}}),m=g.find(".item").eq(0),o=g.find(".item").eq(1),m.click(function(){d.stop();m.addClass("disabled");f.dimmer("hide")}),o.click(function(){d.isPlaying?d.pause():d.play()}),k.noUiSlider.on("start",function(){d.pause()}),k.noUiSlider.on("end",function(){var a=k.noUiSlider.get();d.seek(a)}),
k.noUiSlider.on("change",function(){d.pause();var a=k.noUiSlider.get();d.seek(a)}),i=f.find(".right.menu .ui.dropdown"),i.dropdown({onChange:function(a){$(k).width($(window).width()-140-i.outerWidth());u=a}}),i.dropdown("set selected",u),$(window).resize(a));a();e.scrollTop((h.outerHeight()-e.outerHeight())*0.5);e.scrollLeft((h.outerWidth()-e.outerWidth())*0.5)}function b(a,b,c){this.action=a;this.idx=b;this.len=c}function c(){this.view=$("<div style='position:absolute;'></div>");this.view.css("background-image",
"url(assets/image/alphaBg.png)");var a=$("<div style='position:absolute;'></div>");a.appendTo(this.view);this.bufferCanvas=$("<canvas>",{style:"position:absolute;"});var b=[];this.initSize=function(a,b){this.size={width:a,height:b};this.view.outerWidth(a);this.view.outerHeight(b);this.bufferCanvas.attr("width",a);this.bufferCanvas.attr("height",b)};this.newLayer=function(c){var d=new Painter.Layer(this);c==void 0||c!=void 0&&c>b.length-1?(d.getCanvas().appendTo(a),b.push(d)):(d.getCanvas().insertBefore(b[c].getCanvas()),
b.splice(c,0,d))};this.removeLayer=function(a){var c=b[a];b.splice(a,1);c.getCanvas().remove()};this.moveLayer=function(c,d){function e(){var a=c,d=a+1;d<b.length&&(h.getCanvas().insertAfter(b[d].getCanvas()),b.splice(a,1),b.splice(d,0,h))}function f(){var a=c,d=a-1;d>-1&&(h.getCanvas().insertBefore(b[d].getCanvas()),b.splice(a,1),b.splice(d,0,h))}function g(){var d=c;d!=b.length-1&&(h.getCanvas().appendTo(a),b.splice(d,1),b.push(h))}function j(){var d=c;d>0&&(h.getCanvas().prependTo(a),b.splice(d,
1),b.unshift(h))}var h=b[c];switch(d){case "up":e();break;case "down":f();break;case "top":g();break;case "bottom":j()}};this.setLayerAlpha=function(a,c){b[a].setAlpha(c)};this.setLayerVisible=function(a,c){b[a].setVisible(c)};this.setLayerData=function(a,c){var d=new Painter.LayerAction(Painter.LayerActionType.SetData,c);b[a].addAction(d)};this.setLayerBackgroundColor=function(a,c){var d=new Painter.LayerAction(Painter.LayerActionType.SetBackgroundColor,c);b[a].addAction(d)};this.setLayerFloodFill=
function(a,c){var d=new Painter.LayerAction(Painter.LayerActionType.FloodFill,c);b[a].addAction(d)};this.setLayerApplyFilter=function(a,c){var d=new Painter.LayerAction(Painter.LayerActionType.ApplyFilter,c);b[a].addAction(d)};this.paintLayerShapeByStep=function(a){var c=a.idx,d=a.len,e=b[a.action.layerIdx],a=a.action.action.shape,f=a.brushIdx,g=Painter.toolPanel.getBrush().items[f],f=Painter.toolPanel.getBrush().settingsItems[f].clone();f.applySettingsFromObj(a.brushSettings);g.useSettings(f);g.setDrawCanvasAndBufferCanvas(e.getCanvas().get(0),
this.bufferCanvas.get(0));c==0?(this.bufferCanvas.insertAfter(e.getCanvas()),c=a.mousedownPoint,g.mousedown(c)):c==d-1?(c=a.mouseupPoint,g.mouseup(c),this.bufferCanvas.remove(),c=new Painter.Shape({brush:g,brushSettings:f,mousedownPoint:a.mousedownPoint,mousemovePoints:a.mousemovePoints,mouseupPoint:a.mouseupPoint}),c=new Painter.LayerAction(Painter.LayerActionType.AddShape,c),e.addAction(c)):(c=a.mousemovePoints[c-1],g.mousemove(c))};this.clear=function(){for(;b.length>0;)this.removeLayer(0);this.bufferCanvas.remove()}}
var d={},f,e,g,h,j,k,m,o,i,l,n,p=0,q,r=-1,s,u=1;d.isPlaying=!1;d.isPlayComplete=!1;d.play=function(){var a=o.find("i");a.removeClass("play");a.addClass("pause");this.isPlaying=!0;if(this.isPlayComplete)j.clear(),this.isPlayComplete=!1,p=0,r=-1;this.enterFrame()};d.pause=function(){var a=o.find("i");a.addClass("play");a.removeClass("pause");this.isPlaying=!1;window.cancelAnimationFrame(l)};d.stop=function(){this.pause();k.noUiSlider.set(0);j.clear();this.isPlayComplete=!1;p=0;r=-1;s=q=n=void 0;i.dropdown("set selected",
1)};d.seek=function(a){p=Number(a);d.isPlayComplete=p==1;this.paint()};d.enterFrame=function(){p=p>1?1:p;k.noUiSlider.set(p);d.paint();p==1?(d.pause(),d.isPlayComplete=!0):(p+=u/q.length,l=window.requestAnimationFrame(arguments.callee))};d.playCurrent=function(){this.open(Painter.File.getPaintPathString())};d.open=function(a){n=JSON.parse(a);q=this.getSteps();this.show();var b=f.find(".ui.dimmer");b.dimmer({closable:!1});b.dimmer("show");(function(a){function b(a,c){var d=new Image;d.onload=function(){var b=
s,d=a[0],e;f.width=this.width;f.height=this.height;e=f.getContext("2d");e.drawImage(this,0,0,this.width,this.height,0,0,f.width,f.height);e=e.getImageData(0,0,f.width,f.height);b[d]=e;c()};d.src=a[1]}var c=[],d=n.actions,e=0,f=$("<canvas>").get(0);for(s=[];e<d.length;){var g=d[e];if(g.type==Painter.Recorder.Type.drawLayer)if(g.action.type==Painter.LayerActionType.AddShape){var g=g.action.shape,h;if(g.brushSettings.material!=void 0&&g.brushSettings.material!="")h=g.brushSettings.material;else if(g.brushSettings.shape!=
void 0)h=g.brushSettings.shape.src;h!=void 0&&c.indexOf(h)==-1&&c.push([e,h])}else g.action.type==Painter.LayerActionType.SetData&&c.push([e,g.action.data]);e++}c.length==0?a():(e=0,b(c[e],function(){e++;e==c.length?a():b(c[e],arguments.callee)}))})(function(){b.dimmer("hide");o.trigger("click")})};d.show=function(){$("#pathPlayerView").dimmer({closable:!1});$("#pathPlayerView").dimmer("show");a()};d.getSteps=function(){for(var a=[],c=n.actions,d=0;d<c.length;){var e=c[d];if(e.type==Painter.Recorder.Type.drawLayer){var f=
e.action;if(f.type==Painter.LayerActionType.AddShape)for(var f=f.shape.mousemovePoints.length+2,g=0;g<f;)a.push(new b(e,g,f)),g++;else a.push(new b(e,0,1))}else a.push(new b(e,0,1));d++}return a};d.paint=function(){var a=Math.round(p*(q.length-1));if(r!=a){if(a>r)for(var b=r;a-b!=0;)b++,this.addStep(b);else this.startStepTo(a);r=a}};d.addStep=function(a){a=q[a];if(a.len==1)switch(a.action.type){case Painter.Recorder.Type.newLayer:j.newLayer(a.action.toIdx);break;case Painter.Recorder.Type.removeLayer:j.removeLayer(a.action.layerIdx);
break;case Painter.Recorder.Type.moveLayer:j.moveLayer(a.action.layerIdx,a.action.direction);break;case Painter.Recorder.Type.setLayerAlpha:j.setLayerAlpha(a.action.layerIdx,a.action.alpha);break;case Painter.Recorder.Type.setLayerVisible:j.setLayerVisible(a.action.layerIdx,a.action.visible);break;case Painter.Recorder.Type.drawLayer:switch(a.action.action.type){case Painter.LayerActionType.SetBackgroundColor:j.setLayerBackgroundColor(a.action.layerIdx,a.action.action.backgroundColor);break;case Painter.LayerActionType.FloodFill:j.setLayerFloodFill(a.action.layerIdx,
a.action.action.floodFill);break;case Painter.LayerActionType.ApplyFilter:j.setLayerApplyFilter(a.action.layerIdx,a.action.action.filter);break;case Painter.LayerActionType.SetData:var b=s[n.actions.indexOf(a.action)];j.setLayerData(a.action.layerIdx,b)}}else j.paintLayerShapeByStep(a)};d.startStepTo=function(a){j.clear();for(var b=-1;a-b!=0;)b++,this.addStep(b)};return d}();Painter.InputWin=function(a){var b=$(a),c=b.find(".header i").eq(0),d=b.find(".header label").eq(0),f=b.find("input").eq(0),e=b.find(".right.labeled .label").eq(0),g=b.find(".actions button").eq(0),h;g.click(function(){g.addClass("disabled");b.modal("hide");h!=void 0&&h(f.val())});this.setOption=function(a){c.attr("class",a.icon);d.text(a.title);f.attr("placeholder",a.placeholder);e.text(a.rightlabel);g.text(a.submitLabel);f.val(a.value);h=a.onSubmit};this.show=function(a){this.setOption(a);g.removeClass("disabled");
b.modal("show")}};Painter.Alert=function(){var a={},b=$("<div class='ui small modal'>");$("<div class='header'><i class='warning circle icon'></i><label>\u63d0\u793a</label></div>").appendTo(b);var c=$("<div class='content'>");c.appendTo(b);$("<div class='actions'>").appendTo(b);a.show=function(a){c.text(a);b.modal("show")};return a}();Painter.EditCanvasSizeWin=function(a){function b(){var a=Painter.editor.getEditorCanvas();return{width:a.size.width,height:a.size.height}}var c=$(a),d=c.find(".content p span").eq(0),f=c.find("input").eq(0),e=c.find("input").eq(1),g=c.find(".actions button").eq(0);g.click(function(){var a=b();(a.width!=f.val()||a.height!=e.val())&&Painter.editor.getEditorCanvas().setSize(f.val(),e.val());g.addClass("disabled");c.modal("hide")});this.show=function(){var a=b();d.text(a.width+" * "+a.height);f.val(a.width);
e.val(a.height);g.removeClass("disabled");c.modal("show")}};Painter.OnlineFileWin=function(a){function b(a){var b;b='<div class="ui image" style="border: solid 1px #E3E3E3;float: left;margin-left: 10px;margin-top: 10px;width:240px;height:180px;padding:1px;">';b+='<div class="ui dimmer">';b+='<div class="content">';b+='<div class="center">';b+='<h2 class="ui inverted header">'+a+"</h2>";b+='<div class="ui button">\u6587\u4ef6</div>';b+='<div class="ui button">\u7ed8\u753b\u8fc7\u7a0b</div>';b+="</div>";b+="</div>";b+="</div>";b+='<div style="width:100%;height:100%;background-image:url('+
("paints/"+a+"/"+a+".png")+');background-size:contain;background-repeat:no-repeat;background-origin:content;background-position:50% 50%;"></div>';b+="</div>";this.view=$(b);this.view.dimmer({on:"hover"});var d=this.view.find(".ui.dimmer .ui.button").eq(0),e=this.view.find(".ui.dimmer .ui.button").eq(1);d.click(function(){c.openPaint(a);d.addClass("disabled")});e.click(function(){c.openProcess(a);e.addClass("disabled")});this.reset=function(){d.removeClass("disabled");e.removeClass("disabled")}}var c=
this,d=$(a),f=d.find(".content").eq(0),e=!1,g=[];this.show=function(){e?(this.reset(),d.modal("show")):($("#loadingMask").dimmer({closable:!1}),$("#loadingMask").find(".ui.text.loader").text("\u5217\u8868\u8bfb\u53d6\u4e2d..."),$("#loadingMask").dimmer("show"),$.getJSON("paints/list.json",function(a){$("#loadingMask").dimmer("hide");for(var c=0;c<a.length;c++){var k=new b(a[c]);k.view.prependTo(f);g.push(k)}e=!0;d.modal("show")}))};this.reset=function(){for(var a=0;a<g.length;a++)g[a].reset()};this.openPaint=
function(a){d.modal("hide");a="paints/"+a+"/"+a+".paint";$("#loadingMask").dimmer({closable:!1});$("#loadingMask").find(".ui.text.loader").text("\u6570\u636e\u8bfb\u53d6\u4e2d...");$("#loadingMask").dimmer("show");$.get(a,function(a){$("#loadingMask").dimmer("hide");Painter.editor.getEditorCanvas().open(a)})};this.openProcess=function(a){d.modal("hide");a="paints/"+a+"/"+a+".process";$("#loadingMask").dimmer({closable:!1});$("#loadingMask").find(".ui.text.loader").text("\u6570\u636e\u8bfb\u53d6\u4e2d...");
$("#loadingMask").dimmer("show");$.get(a,function(a){$("#loadingMask").dimmer("hide");Painter.PathPlayer.open(a)})}};Painter.Zoomer=function(){function a(){Painter.toolPanel.getCurrentTool()===b&&Painter.editor.getEditorCanvas().setCursor(b.getCursor())}var b=this;this.descriptor=new Painter.ZoomerDescriptor(this);var c="zoomIn";$(window).keydown(function(b){b.keyCode==17&&c!="zoomOut"&&(c="zoomOut",a())});$(window).keyup(function(b){b.keyCode==17&&c!="zoomIn"&&(c="zoomIn",a())});this.getCursor=function(){return"url(assets/image/cursors/"+c+".png) 18 18,auto"};this.getDragView=function(){};this.setDrawCanvasAndBufferCanvas=
function(a){this.canvas=a};this.mousedown=function(a){c=="zoomIn"?Painter.editor.getEditorCanvas().zoomIn(a):Painter.editor.getEditorCanvas().zoomOut(a)};this.mousemove=function(){};this.mouseup=function(){};this.getAction=function(){}};Painter.ZoomerDescriptor=function(){this.title="\u653e\u5927\u955c";this.init=function(a){a.header.text(this.title);$("<div>\u65e0\u4efb\u4f55\u5c5e\u6027</div>").appendTo(a.form)}};
