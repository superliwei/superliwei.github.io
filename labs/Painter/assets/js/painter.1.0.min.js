...
new Painter.FilterWin;this.settingWin=new Painter.SettingWin("#settingWin");this.inputWin=new Painter.InputWin("#inputWin");this.editCanvasSizeWin=new Painter.EditCanvasSizeWin("#eidtCanvasSizeWin");this.onlineFileWin=new Painter.OnlineFileWin("#onlineFileWin")};$(function(){Painter.init()});Painter.MainLayout=function(a){function b(){c.outerWidth(k);f.outerWidth(h);var a=$(window).width()-k-h-e.outerWidth()-g.outerWidth();d.outerWidth(a);var b=$(window).height()-$("#topMenu").outerHeight();c.outerHeight(b);f.outerHeight(b);d.outerHeight(b);d.css("left",k+e.outerWidth());f.css("left",k+a+e.outerWidth()+g.outerWidth());e.outerHeight(b);g.outerHeight(b);e.css("left",k);g.css("left",k+a+e.outerWidth());m.outerWidth(h);m.outerHeight(o);n.outerWidth(h);a=b-o-l.outerHeight();n.outerHeight(a);
