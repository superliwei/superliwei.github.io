...
e.val(a.height);g.removeClass("disabled");c.modal("show")}};Painter.OnlineFileWin=function(a){function b(a){var b;b='<div class="ui image" style="border: solid 1px #E3E3E3;float: left;margin-left: 10px;margin-top: 10px;width:240px;height:180px;padding:1px;display:table;">';b+='<div class="ui dimmer">';b+='<div class="content">';b+='<div class="center">';b+='<h2 class="ui inverted header">'+a+"</h2>";b+='<div class="ui button">\u6587\u4ef6</div>';b+='<div class="ui button">\u7ed8\u753b\u8fc7\u7a0b</div>';b+="</div>";b+="</div>";b+="</div>";b+='<span style="display:table-cell;vertical-align:middle;"><img class="ui image" src="'+
("paints/"+a+"/"+a+".png")+'"></span>';b+="</div>";this.view=$(b);this.view.dimmer({on:"hover"});var d=this.view.find(".ui.dimmer .ui.button").eq(0),e=this.view.find(".ui.dimmer .ui.button").eq(1);d.click(function(){c.openPaint(a);d.addClass("disabled")});e.click(function(){c.openProcess(a);e.addClass("disabled")});this.reset=function(){d.removeClass("disabled");e.removeClass("disabled")}}var c=this,d=$(a),f=d.find(".content").eq(0),e=!1,g=[];this.show=function(){e?(this.reset(),d.modal("show")):
