...
PageNodes.HistoryManager.addEditAction(a.pages.length>0||a.links.length>0?"select":"unselect",b,a,function(b){PageNodes.editorContainer.selectPages(b.pages);PageNodes.editorContainer.selectLinks(b.links);PageNodes.propertiesPanel.update()})},addSelectButtonAction:function(b,a){PageNodes.ArrayUtil.equals(b,a)?(PageNodes.editorContainer.selectButtons(a),PageNodes.propertiesPanel.update()):PageNodes.HistoryManager.addEditAction(a.length>0?"select":"unselect",b,a,function(a){PageNodes.editorContainer.selectButtons(a);
...
break;case PageNodes.SelectMode.Page:c()}};a.addMoveAction=function(b,a,d){PageNodes.HistoryManager.addEditAction("move",a,d,function(a){$.each(b,function(b){var c=a[b].y;this.content.x=a[b].x;this.content.y=c;PageNodes.editorContainer.update(this)})})};a.addMoveButtonAction=function(b,a,d){PageNodes.HistoryManager.addEditAction("move",a,d,function(a){$.each(b,function(b){var c=a[b].y;this.content.x=a[b].x;this.content.y=c;PageNodes.editorContainer.update(this.page)})})};a.switchLinks=function(a,
...
0)this.itemControllers=[],d(0)};this.getAndSetFuncForName=function(a){var a=PageNodes.DescriptorDataModel.getFuncName(a),d=this.delegate[a.getStr],e=this.delegate[a.setStr];return[d!=void 0?function(){return d.call(b.delegate)}:void 0,e!=void 0?function(a){e.call(b.delegate,a)}:void 0]};this.update=function(){function a(b){for(var e=0;e<b.length;e++){var f=b[e];f instanceof Array?a(f):f.update!=void 0&&f.update()}}a(this.itemControllers)};this.isDataModel=function(a){return a.type==void 0&&a.createTo!=
void 0};this.getSettings=function(){function a(e){if(e!=b.items.length){var f=b.items[e];if(b.isDataModel(f))d[f.name]=f.getSettings();else if(f.name!=void 0){var g=b.getAndSetFuncForName(f.name)[0];d[f.name]=g()}e++;a(e)}}var d={};a(0);return d=this.encodeSettings(d)};this.setSettings=function(a){a=this.decodeSettings(a);for(key in a){var b=this.getAndSetFuncForName(key)[1];b!=void 0?a[key]!=void 0&&b(a[key]):(b=this.getSubDataModelByName(key),b!=void 0&&b.setSettings(a[key]))}};this.encodeSettings=
function(a){var b={};for(key in a){var e=a[key];if(typeof e=="object")if(this.getAndSetFuncForName(key)[1]!=void 0)b[key]=PageNodes.DescriptorDataModel.Encoder.encode(e);else{var f=this.getSubDataModelByName(key);f!=void 0&&(b[key]=f.encodeSettings(e))}else b[key]=e}return b};this.decodeSettings=function(a){var b={};for(key in a){var e=a[key];if(typeof e=="object")if(this.getAndSetFuncForName(key)[1]!=void 0)b[key]=PageNodes.DescriptorDataModel.Encoder.decode(e);else{var f=this.getSubDataModelByName(key);
f!=void 0&&(b[key]=f.decodeSettings(e))}else b[key]=e}return b};this.getSubDataModelByName=function(a){for(var b=this.items.length,e=0;e<b;e++){var f=this.items[e];if(this.isDataModel(f)&&f.name==a)return f}}};PageNodes.DescriptorDataModel.Encoder={encode:function(a){return a},decode:function(a){return a}};PageNodes.DescriptorDataModel.getFuncName=function(a){var b=a.length,a=a.charAt(0).toUpperCase()+a.substr(1,b-1);return{getStr:"get"+a,setStr:"set"+a}};
PageNodes.DescriptorDataModelHandle={donothing:function(a){return a},emptyToUndefined:function(a){return a!=""?a:void 0},numberValue:function(a){return Number(a)}};
