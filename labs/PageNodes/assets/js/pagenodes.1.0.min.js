...
0)this.itemControllers=[],d(0)};this.getAndSetFuncForName=function(a){var a=PageNodes.DescriptorDataModel.getFuncName(a),d=this.delegate[a.getStr],e=this.delegate[a.setStr];return[function(){return d.call(b.delegate)},function(a){e.call(b.delegate,a)}]};this.update=function(){function a(b){for(var e=0;e<b.length;e++){var f=b[e];f instanceof Array?a(f):f.update!=void 0&&f.update()}}a(this.itemControllers)};this.isDataModel=function(a){return a.type==void 0&&a.createTo!=void 0};this.getSettings=function(){function a(e){if(e!=
b.items.length){var f=b.items[e];if(b.isDataModel(f))d[f.name]=f.getSettings();else if(f.name!=void 0){var g=b.getAndSetFuncForName(f.name)[0];d[f.name]=g()}e++;a(e)}}var d={};a(0);return d=this.encodeSettings(d)};this.setSettings=function(a){a=this.decodeSettings(a);for(key in a){var b=this.getAndSetFuncForName(key)[1];b!=void 0?a[key]!=void 0&&b(a[key]):(b=this.getSubDataModelByName(key),b!=void 0&&b.setSettings(a[key]))}};this.encodeSettings=function(a){var b={};for(key in a){var e=a[key];if(typeof e==
"object")if(this.getAndSetFuncForName(key)[1]!=void 0)b[key]=PageNodes.DescriptorDataModel.Encoder.encode(e);else{var f=this.getSubDataModelByName(key);f!=void 0&&(b[key]=f.encodeSettings(e))}else b[key]=e}return b};this.decodeSettings=function(a){var b={};for(key in a){var e=a[key];if(typeof e=="object")if(this.getAndSetFuncForName(key)[1]!=void 0)b[key]=PageNodes.DescriptorDataModel.Encoder.decode(e);else{var f=this.getSubDataModelByName(key);f!=void 0&&(b[key]=f.decodeSettings(e))}else b[key]=
