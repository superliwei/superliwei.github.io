...
new PageNodes.OnlineFileWin("#onlineFileWin");this.ToolManager.init()};$(function(){PageNodes.init()});PageNodes.Test=function(){return{testRender:function(){}}}();PageNodes.Settings={pageScale:1/6,pageSize:{width:960,height:540}};PageNodes.KeyboardManager={};
PageNodes.KeyboardManager.init=function(){function a(a){return a.target instanceof HTMLTextAreaElement||a.target instanceof HTMLInputElement}$(window).keydown(function(b){if(!a(b))switch(b.keyCode){case 78:b.ctrlKey&&b.preventDefault();break;case 79:b.ctrlKey&&b.preventDefault();break;case 83:b.ctrlKey&&b.preventDefault();break;case 85:b.ctrlKey&&b.preventDefault();break;case 49:(b.ctrlKey||b.shiftKey)&&b.preventDefault();break;case 50:(b.ctrlKey||b.shiftKey)&&b.preventDefault();break;case 89:b.ctrlKey&&
...
PageNodes.KeyboardManager.execute("Ctrl+A");break;case 68:b.ctrlKey&&PageNodes.KeyboardManager.execute("Ctrl+D");break;case 73:b.ctrlKey&&b.shiftKey&&PageNodes.KeyboardManager.execute("Ctrl+Shift+I")}});$(window).mousewheel(function(a){if(a.ctrlKey){a.preventDefault();var c=PageNodes.editorContainer,d=a.clientX-c.container.offset().left,c=a.clientY-c.container.offset().top,d=new PIXI.Point(d,c);PageNodes.editorContainer.zoom({delta:a.deltaY,point:d})}})};
...
PageNodes.HistoryManager.go=function(a){for(a=this.items.indexOf(a);this.idx!=a;)a<this.idx?(this.items[this.idx].undo(),this.idx--):(this.idx++,this.items[this.idx].redo());$(document).trigger(PageNodes.HistoryManager.UPDATE)};PageNodes.HistoryItem=function(a,b,c){this.type=a;this.undo=b;this.redo=c};PageNodes.HistoryManager.addEditAction=function(a,b,c,d){this.add(a,function(){d(b)},function(){d(c)})};PageNodes.GeneralManager=function(){var a={switchToolIdx:function(a){var c=PageNodes.ToolManager.getSelectedIdx();PageNodes.HistoryManager.addEditAction("switchTool",c,a,function(a){PageNodes.toolPanel.selectIdx(a);PageNodes.ToolManager.selectToolIdx(a)})},addSelectAction:function(a,c){PageNodes.ArrayUtil.equals(a.pages,c.pages)&&PageNodes.ArrayUtil.equals(a.links,c.links)?(PageNodes.editorContainer.selectPages(c.pages),PageNodes.editorContainer.selectLinks(c.links),PageNodes.propertiesPanel.update()):
PageNodes.HistoryManager.addEditAction(c.pages.length>0||c.links.length>0?"select":"unselect",a,c,function(a){PageNodes.editorContainer.selectPages(a.pages);PageNodes.editorContainer.selectLinks(a.links);PageNodes.propertiesPanel.update()})},addSelectButtonAction:function(a,c){PageNodes.ArrayUtil.equals(a,c)?(PageNodes.editorContainer.selectButtons(c),PageNodes.propertiesPanel.update()):PageNodes.HistoryManager.addEditAction(c.length>0?"select":"unselect",a,c,function(a){PageNodes.editorContainer.selectButtons(a);
...
PageNodes.Clipboard.cut=function(){var a=PageNodes.editorContainer,b=a.getSelectedPages().concat(),c=a.getSelectedLinks().concat(),d=a.getSelectedButtons().concat();if(b.length>0||c.length>0||d.length>0){var e=this.targets.concat(),f=this.isCut,g=b.concat(),h=c.concat(),j=d.concat(),i=[];$.each(j,function(){i.push({page:this.page,btn:this,undo:function(){a.addButton(this.btn,this.page)},redo:function(){a.removeButton(this.btn)}})});$.each(b,function(){var b=a.findLinkWithPage(this);h=h.concat(b)});
$.each(d,function(){var b=a.findLinkFrom({page:this.page,btn:this});b!=void 0&&(h=h.concat([b]))});h=PageNodes.ArrayUtil.filterRepeat(h);PageNodes.HistoryManager.add("cut",function(){$.each(g,function(){a.add(this)});$.each(h,function(){a.addLink(this)});$.each(i,function(){this.undo()});a.selectPages(b.concat());a.selectLinks(c.concat());a.selectButtons(d.concat());PageNodes.propertiesPanel.update();PageNodes.Clipboard.targets=e;PageNodes.Clipboard.isCut=f},function(){$.each(g,function(){a.remove(this)});
$.each(h,function(){a.removeLink(this)});$.each(i,function(){this.redo()});a.selectPages([]);a.selectLinks([]);a.selectButtons([]);PageNodes.propertiesPanel.update();PageNodes.Clipboard.targets=b.concat(c).concat(i);PageNodes.Clipboard.isCut=!0})}};
PageNodes.Clipboard.paste=function(){if(this.getPasteAble()){var a=PageNodes.editorContainer,b=a.getPages(),c=a.getSelectedPages().concat(),d=a.getSelectedLinks().concat(),e=a.getSelectedButtons().concat();if(this.targets.length>0&&this.isCut){var f=PageNodes.Clipboard.targets.concat(),g,h,j;PageNodes.HistoryManager.add("paste",function(){$.each(g,function(){a.remove(this)});$.each(h,function(){a.removeLink(this)});$.each(j,function(){this.redo()});a.selectPages(c.concat());a.selectLinks(d.concat());
a.selectButtons(e.concat());PageNodes.propertiesPanel.update();PageNodes.Clipboard.targets=f;PageNodes.Clipboard.isCut=!0},function(){g=[];h=[];j=[];$.each(f,function(){var c=this instanceof PageNodes.NodeLink;this instanceof PageNodes.Page?(a.add(this),g.push(this)):c?b.indexOf(this.from.page)>-1&&b.indexOf(this.to)>-1&&(a.addLink(this),h.push(this)):this.undo!=void 0&&(this.undo(),j.push(this))});a.selectPages(g.concat());a.selectLinks(h.concat());a.selectButtons(function(){var a=[];$.each(j,function(){a.push(this.btn)});
return a}());PageNodes.propertiesPanel.update();PageNodes.Clipboard.targets=[];PageNodes.Clipboard.isCut=!1})}else if(this.targets.length>0&&!this.isCut){var i=[];PageNodes.HistoryManager.add("paste",function(){$.each(i,function(){this instanceof PageNodes.Page?a.remove(this):this instanceof PageNodes.Button&&a.removeButton(this)});a.selectPages(c.concat());a.selectLinks(d.concat());a.selectButtons(e.concat());PageNodes.propertiesPanel.update()},function(){i.length==0&&$.each(PageNodes.Clipboard.targets,
function(){if(!(this instanceof PageNodes.NodeLink)){var a=this.clone();if(this instanceof PageNodes.Button)a.page=this.page;i.push(a)}});$.each(i,function(){this instanceof PageNodes.Page?a.add(this):this instanceof PageNodes.Button&&a.addButton(this,this.page)});a.selectPages(function(){var a=[];$.each(i,function(){this instanceof PageNodes.Page&&a.push(this)});return a}());a.selectLinks([]);a.selectButtons(function(){var a=[];$.each(i,function(){this instanceof PageNodes.Button&&a.push(this)});
...
b.trigger("click");b.change(function(){var c=b.get(0).files[0];a(c)})},readText:function(a,b){$("#loadingMask").dimmer({closable:!1});$("#loadingMask").find(".ui.text.loader").text("\u6587\u4ef6\u8bfb\u53d6\u4e2d...");$("#loadingMask").dimmer("show");var c=new FileReader;c.onload=function(){$("#loadingMask").dimmer("hide");b(c.result)};c.readAsText(a)}};PageNodes.MainLayout=function(a){function b(){c.outerWidth(i);e.outerWidth(k);var a=$(window).width()-i-k-f.outerWidth()-g.outerWidth();d.outerWidth(a);var b=$(window).height()-$("#topMenu").outerHeight();c.outerHeight(b);e.outerHeight(b);d.outerHeight(b);d.css("left",i+f.outerWidth());e.css("left",i+a+f.outerWidth()+g.outerWidth());f.outerHeight(b);g.outerHeight(b);f.css("left",i);g.css("left",i+a+f.outerWidth());$(document).trigger(PageNodes.MainLayout.Event.RESIZE);a=b-q-10;l.outerHeight(a-p.outerHeight());
m.outerHeight(a)}this.view=$(a);var c=this.view.find("#leftBox"),d=this.view.find("#centerBox"),e=this.view.find("#rightBox"),a=this.view.find(".vDivide"),f=a.eq(0),g=a.eq(1),h=f.find(".handle"),j=g.find(".handle"),i=51,k=320;h.click(function(){i=i==51?0:51;b()});j.click(function(){k=k==320?0:320;b()});c.css("position","absolute");d.css("position","absolute");e.css("position","absolute");this.view.find(".menu.tabular .item").tab();var l=this.view.find("#propertiesPanel .segment");l.css("overflow",
"auto");var p=this.view.find("#propertiesPanel #header"),m=this.view.find("#historyPanel .segment");m.css("padding",5);m.css("overflow","auto");var q=this.view.find(".menu.tabular").outerHeight();$(window).resize(b);b();this.toggleLeft=function(){h.trigger("click")};this.toggleRight=function(){j.trigger("click")}};PageNodes.MainLayout.Event={RESIZE:"mainLayoutResizeEvent"};PageNodes.TopMenu=function(a){function b(){$.each(e,function(){this.update()})}function c(a){function b(){if(d!="")PageNodes.KeyboardManager.execute(d);else switch(c){case "\u5728\u7ebf\u6587\u4ef6":PageNodes.KeyboardManager.execute("onlineFile");break;case "\u5bfc\u51fa\u56fe\u7247":PageNodes.KeyboardManager.execute("export");break;case "\u952e\u76d8\u5feb\u6377\u952e":PageNodes.KeyboardManager.execute("showQuickKey");break;case "\u6240\u6709\u9875\u9762":PageNodes.KeyboardManager.execute("selectAllPages");
...
switch(b){case PageNodes.SelectMode.Global:var d=PageNodes.editorContainer.getPages(),a=PageNodes.editorContainer.getSelectedPages(),g=PageNodes.editorContainer.getLinks(),e=PageNodes.editorContainer.getSelectedLinks(),a=d.length>0&&(a.length<d.length||e.length<g.length);break;case PageNodes.SelectMode.Page:a=PageNodes.editorContainer.getAllButtons(),b=PageNodes.editorContainer.getSelectedButtons(),a=a.length>0&&b.length<a.length}break;case "\u6240\u6709\u9875\u9762":b=PageNodes.ToolManager.getTools()[0].selectMode;
d=PageNodes.editorContainer.getPages();a=PageNodes.editorContainer.getSelectedPages();a=b==PageNodes.SelectMode.Global&&d.length>0&&a.length<d.length;break;case "\u6240\u6709\u94fe\u63a5":b=PageNodes.ToolManager.getTools()[0].selectMode;g=PageNodes.editorContainer.getLinks();e=PageNodes.editorContainer.getSelectedLinks();a=b==PageNodes.SelectMode.Global&&g.length>0&&e.length<g.length;break;case "\u53cd\u9009":b=PageNodes.ToolManager.getTools()[0].selectMode;switch(b){case PageNodes.SelectMode.Global:d=
PageNodes.editorContainer.getPages();a=d.length>0;break;case PageNodes.SelectMode.Page:a=PageNodes.editorContainer.getAllButtons(),a=a.length>0}break;case "\u53d6\u6d88\u9009\u62e9":a=PageNodes.editorContainer.getSelectedPages();e=PageNodes.editorContainer.getSelectedLinks();b=PageNodes.editorContainer.getSelectedButtons();a=a.length>0||e.length>0||b.length>0;break;case "\u5c5e\u6027\u9762\u677f":a=PageNodes.topMenu.panelMenuController.getSelectedValue()!="properties";break;case "\u5386\u53f2\u8bb0\u5f55":a=
...
'"></i>');this.content=$('<div class="content"><div class="header">'+b[a.type].label+"</div></div>");this.icon.appendTo(this.view);this.content.appendTo(this.view);this.view.click(function(){PageNodes.HistoryManager.go(a)})};PageNodes.ToolPanel=function(){var a,b=$("#toolPanel").find("button");b.each(function(){$(this).click(function(){var a=b.index($(this));PageNodes.GeneralManager.switchToolIdx(a)})});this.selectIdx=function(c){c=b.eq(c);a!=void 0&&a.removeClass("basic violet active");a=c;a.addClass("basic violet active")};this.selectIdx(0)};PageNodes.SettingWin=function(a){function b(a,b){this.setDisplay=function(c){a.css("display",c?"block":"none");b.css("display",c?"block":"none")}}var c=this;this.view=$(a);var d=this.view.find(".ui.menu .item"),a=this.view.find(".content").eq(0).children(),e=this.view.find(".actions").eq(0).children(),f=[new function(a,c){b.call(this,a,c);var d=this,g=a.find("input").eq(0),e=c.find("button").eq(0);this.getMaxHistory=function(){return PageNodes.HistoryManager.maxLen};this.setMaxHistory=function(a){PageNodes.HistoryManager.maxLen=
a};this.initValues=function(){g.val(this.getMaxHistory())};this.initValues();e.click(function(){d.setMaxHistory(g.val())})}(a.eq(0),e.eq(0)),new function(a,c){b.call(this,a,c);var d='<table class="ui celled table">';d+=" <thead><tr>";d+="  <th>\u5feb\u6377\u952e</th>";d+="  <th>\u8bf4\u660e</th>";d+=" </tr></thead>";d+=" <tbody>";PageNodes.topMenu.getItems().each(function(){if($(this).find(".item").length==0){var a=$(this).find("span.text").text(),b=$(this).find("span.description").text();b!=""&&
(d+="<tr><td>"+b+"</td><td>"+a+"</td></tr>")}});d+=" </tbody>";d+="</table>";$(d).appendTo(a)}(a.eq(1),e.eq(1)),new function(a,c){b.call(this,a,c);var d=this,g=$("<audio>",{src:"assets/sounds/m01.m4a",loop:!0}),e=a.find(".icon.music");e.addClass("red");e.click(function(){e.toggleClass("red");e.hasClass("red")?d.playMusic():d.stopMusic()});var f=this.setDisplay;this.setDisplay=function(a){f.call(this,a);a?this.playMusic():this.stopMusic()};this.playMusic=function(){e.hasClass("red")&&g.get(0).play()};
this.stopMusic=function(){g.get(0).pause();g.get(0).currentTime=0};var m='<div style="color:#666666;text-align: center;">'+Base64.decode("Qmxhbms=")+"</div>";m+='<div style="color:#666666;text-align: center;">'+Base64.decode("aGVyb2JsYW5rQGdtYWlsLmNvbQ==")+"</div>";$(m).appendTo(a)}(a.eq(2),e.eq(2))],g=-1;d.each(function(a){$(this).click(function(){c.selectTabIdx(a)})});this.view.modal({onHide:function(){f[2].stopMusic()}});this.show=function(a){f[0].initValues();this.selectTabIdx(a);this.view.modal("show")};
this.selectTabIdx=function(a){g>-1&&(d.eq(g).removeClass("active blue"),f[g].setDisplay(!1));d.eq(a).addClass("active blue");g=a;f[a].setDisplay(!0);this.view.modal("refresh")}};PageNodes.ButtonGroupSwitcher=function(a,b){var c=this,d=a.find("button"),e=-1,f=[];d.each(function(a,b){$(b).click(function(){if(e!=a&&(c.selectIdx(a),c.onChange!=void 0))c.onChange(c.getValue())});f.push($(b).attr("data-value"))});this.selectIdx=function(a){e>-1&&d.eq(e).removeClass("active");e=a;d.eq(a).addClass("active")};this.setValue=function(a){this.selectIdx(f.indexOf(a))};this.getValue=function(){return f[e]};b!=void 0&&this.setValue(b)};PageNodes.ColorPicker=function(a,b){var c=this;this.view=b;if(this.view==void 0)this.view=$('<div class="colorPicker"><div class="box"></div></div>');var d=this.view.find(".box");this.view.colpick({flat:!1,layout:"hex",submit:1,onChange:function(a,b){var d;if(c.onChange!=void 0)c.onChange("#"+b)},onSubmit:function(a,b){var g="#"+b;d.css("background-color",g);if(c.onSubmit!=void 0)c.onSubmit(g)},color:a});d.css("background-color",a);this.setColor=function(a){d.css("background-color",a);this.view.colpickSetColor(a)}};PageNodes.Slider=function(a,b,c,d){var e=this,f=a.find(".ui.slider").get(0);noUiSlider.create(f,{start:[d],range:{min:[b],max:[c]}});var g=a.find("input").get(0);f.noUiSlider.on("update",function(a,b){g.value=a[b]});g.addEventListener("change",function(){f.noUiSlider.set(this.value);if(e.onChange!=void 0)e.onChange(this.value)});f.noUiSlider.on("change",function(){var a=e.getValue();if(e.onChange!=void 0)e.onChange(a)});this.getValue=function(){return f.noUiSlider.get()};this.setValue=function(a){f.noUiSlider.set(a)}};PageNodes.EditPageSizeWin=function(a){var b=$(a),c=b.find(".content p span").eq(0),d=b.find("input").eq(0),e=b.find("input").eq(1),f=b.find(".actions button").eq(0);f.click(function(){var a=PageNodes.Settings.pageSize;if(a.width!=d.val()||a.height!=e.val())a={width:Number(d.val()),height:Number(e.val())},PageNodes.GeneralManager.changePageSizeTo(a);f.addClass("disabled");b.modal("hide")});b.find(".content .ui.segment button").click(function(){var a=$(this).data("width"),b=$(this).data("height");d.val(a);
...
b.modal("show")}};PageNodes.Alert=function(){var a={},b=$("<div class='ui small modal'>");$("<div class='header'><i class='warning circle icon'></i><label>\u63d0\u793a</label></div>").appendTo(b);var c=$("<div class='content'>");c.appendTo(b);$("<div class='actions'>").appendTo(b);a.show=function(a){c.text(a);b.modal("show")};return a}();PageNodes.OnlineFileWin=function(a){function b(a){var b;b='<div class="ui image" style="border: solid 1px #E3E3E3;float: left;margin-left: 10px;margin-top: 10px;width:240px;height:180px;padding:1px;display:table;">';b+='<div class="ui dimmer">';b+='<div class="content">';b+='<div class="center">';b+='<h2 class="ui inverted header">'+a+"</h2>";b+='<div class="ui button">\u6253\u5f00\u6587\u4ef6</div>';b+="</div>";b+="</div>";b+="</div>";b+='<span style="display:table-cell;vertical-align:middle;"><img class="ui image" src="'+
("examples/"+a+"/"+a+".png")+'"></span>';b+="</div>";this.view=$(b);this.view.dimmer({on:"hover"});var d=this.view.find(".ui.dimmer .ui.button").eq(0);d.click(function(){c.openFile(a);d.addClass("disabled")});this.reset=function(){d.removeClass("disabled")}}var c=this,d=$(a),e=d.find(".content").eq(0),f=!1,g=[];this.show=function(){f?(this.reset(),d.modal("show")):($("#loadingMask").dimmer({closable:!1}),$("#loadingMask").find(".ui.text.loader").text("\u5217\u8868\u8bfb\u53d6\u4e2d..."),$("#loadingMask").dimmer("show"),
$.getJSON("examples/list.json",function(a){$("#loadingMask").dimmer("hide");for(var c=0;c<a.length;c++){var i=new b(a[c]);i.view.prependTo(e);g.push(i)}f=!0;d.modal("show")}))};this.reset=function(){for(var a=0;a<g.length;a++)g[a].reset()};this.openFile=function(a){d.modal("hide");a="examples/"+a+"/"+a+".pagenodes";$("#loadingMask").dimmer({closable:!1});$("#loadingMask").find(".ui.text.loader").text("\u6570\u636e\u8bfb\u53d6\u4e2d...");$("#loadingMask").dimmer("show");$.get(a,function(a){$("#loadingMask").dimmer("hide");
PageNodes.editorContainer.open(a)})}};PageNodes.FormViewManager={};PageNodes.FormViewManager.createPositionView=function(){return $('<div class="inline fields">\t<div class="eight wide field">\t\t<label>X</label>\t\t<input type="text" placeholder="">   </div>   <div class="eight wide field">\t\t<label>Y</label>\t\t<input type="text" placeholder="">\t</div></div>')};PageNodes.FormViewManager.createSizeView=function(){return $('<div class="inline fields">\t<div class="eight wide field">\t\t<label>\u5bbd</label>\t\t<input type="text" placeholder="">   </div>   <div class="eight wide field">\t\t<label>\u9ad8</label>\t\t<input type="text" placeholder="">\t</div></div>')};
...
PageNodes.FormViewManager.createHeaderView=function(a){return $('<div class="ui small header">'+a+"</div>")};PageNodes.FormViewManager.createColorPickerView=function(a){return $('<div class="inline fields">\t<div class="five wide field">\t\t<label>'+a+'</label>\t</div>\t<div class="eleven wide field">\t\t<div class="colorPicker">\t\t\t<div class="box"></div>\t\t</div>\t</div></div>')};
PageNodes.FormViewManager.createTextInputView=function(a){return $('<div class="inline fields">\t<div class="five wide field">\t\t<label>'+a+'</label>\t</div>\t<div class="eleven wide field">\t\t<input type="text" placeholder="">\t</div></div>')};
...
PageNodes.FormViewManager.createButtonGroupView=function(a,b){for(var c=$('<div class="inline fields">\t<div class="five wide field">\t\t<label>'+a+'</label>\t</div>\t<div class="eleven wide field">\t\t<div class="ui icon basic buttons"></div>\t</div></div>'),d=c.find(".buttons"),e=0;e<b.length;e++)$('<button class="ui button" data-value="'+b[e].value+'">'+b[e].label+"</button>").appendTo(d);return c};PageNodes.BasicDescriptor=function(a){var b=this;this.init=function(c){function d(b){var c=PageNodes.FormViewManager.createButtonGroupView(b.label,b.items);c.appendTo(k);var b=i(b.name),d=a.delegate[b.getStr],e=a.delegate[b.setStr],g=new PageNodes.ButtonGroupSwitcher(c,d());g.onChange=function(a){var b=d();PageNodes.HistoryManager.addEditAction("edit",b,a,function(a){e(a);g.setValue(a)})}}function e(b){var c=PageNodes.FormViewManager.createTextInputView(b.label);c.appendTo(k);var b=i(b.name),d=a.delegate[b.getStr],
e=a.delegate[b.setStr],g=c.find("input").eq(0);g.val(d());g.change(function(){var a=d(),b=g.val();PageNodes.HistoryManager.addEditAction("edit",a,b,function(a){e(a);g.val(a)})})}function f(c){var d=PageNodes.FormViewManager.createPositionView();d.appendTo(k);var c=i(c.name),e=a.delegate[c.getStr],g=a.delegate[c.setStr],d=d.find("input"),f=d.eq(0),h=d.eq(1);f.val(e().x);h.val(e().y);f.change(function(){var a=e(),b=e();b.x=Number(f.val());PageNodes.HistoryManager.addEditAction("edit",a,b,function(a){g(a);
f.val(a.x)})});h.change(function(){var a=e(),b=e();b.y=Number(h.val());PageNodes.HistoryManager.addEditAction("edit",a,b,function(a){g(a);h.val(a.y)})});b.updateItems.push({input:f,getFunc:function(){return e().x}});b.updateItems.push({input:h,getFunc:function(){return e().y}})}function g(c){var d=PageNodes.FormViewManager.createSizeView();d.appendTo(k);var c=i(c.name),e=a.delegate[c.getStr],g=a.delegate[c.setStr],d=d.find("input"),f=d.eq(0),h=d.eq(1);f.val(e().width);h.val(e().height);f.change(function(){var a=
e(),b=e();b.width=Number(f.val());PageNodes.HistoryManager.addEditAction("edit",a,b,function(a){g(a);f.val(a.width)})});h.change(function(){var a=e(),b=e();b.height=Number(h.val());PageNodes.HistoryManager.addEditAction("edit",a,b,function(a){g(a);h.val(a.height)})});b.updateItems.push({input:f,getFunc:function(){return e().width}});b.updateItems.push({input:h,getFunc:function(){return e().height}})}function h(b){var c=PageNodes.FormViewManager.createColorPickerView(b.label);c.appendTo(k);var b=i(b.name),
d=a.delegate[b.getStr],e=a.delegate[b.setStr],g=new PageNodes.ColorPicker(d(),c.find(".colorPicker"));g.onSubmit=function(a){var b=d();b!=a&&PageNodes.HistoryManager.addEditAction("edit",b,a,function(a){g.setColor(a);e(a)})}}function j(b){var c=PageNodes.FormViewManager.createSliderView(b.label);c.appendTo(k);var d=i(b.name),e=a.delegate[d.getStr],g=a.delegate[d.setStr],f=new PageNodes.Slider(c,b.min,b.max,e());f.onChange=function(a){var b=e();PageNodes.HistoryManager.addEditAction("edit",b,a,function(a){f.setValue(a);
g(a)})}}function i(a){var b=a.length,a=a.charAt(0).toUpperCase()+a.substr(1,b-1);return{getStr:"get"+a,setStr:"set"+a}}c.header.text(this.title);var k=c.form;this.container=k;this.updateItems=[];$.each(a.items,function(){switch(this.type){case "tabs":d(this);break;case "input":e(this);break;case "position":f(this);break;case "size":g(this);break;case "hline":PageNodes.FormViewManager.createHline().appendTo(k);break;case "color":h(this);break;case "slider":j(this);break;case "html":$(this.html).appendTo(k)}})};
this.update=function(){this.container!=void 0&&$.each(this.updateItems,function(){this.input.val(this.getFunc())})}};PageNodes.DescriptorDataModel=function(a){this.delegate=a;this.items=[];this.add=function(a){this.items.push(a)}};PageNodes.GroupDescriptor=function(a){var b=this;this.init=function(c){function d(b){var c=PageNodes.FormViewManager.createTextInputView(b.label);c.appendTo(i);var b=j(b.name),d=a.delegate[b.getStr],e=a.delegate[b.setStr],g=d().length,f=c.find("input").eq(0);f.val(PageNodes.ArrayUtil.getSameValue(d()));f.change(function(){var a=d(),b=PageNodes.ArrayUtil.repeatValue(f.val(),g);PageNodes.HistoryManager.addEditAction("edit",a,b,function(a){e(a);f.val(PageNodes.ArrayUtil.getSameValue(a))})})}function e(c){var d=
PageNodes.FormViewManager.createPositionView();d.appendTo(i);var c=j(c.name),e=a.delegate[c.getStr],g=a.delegate[c.setStr],f=e().x.length,d=d.find("input"),h=d.eq(0),o=d.eq(1);h.val(PageNodes.ArrayUtil.getSameValue(e().x));o.val(PageNodes.ArrayUtil.getSameValue(e().y));h.change(function(){var a=e(),b=e();b.x=PageNodes.ArrayUtil.repeatValue(Number(h.val()),f);PageNodes.HistoryManager.addEditAction("edit",a,b,function(a){g(a);h.val(PageNodes.ArrayUtil.getSameValue(a.x))})});o.change(function(){var a=
e(),b=e();b.y=PageNodes.ArrayUtil.repeatValue(Number(o.val()),f);PageNodes.HistoryManager.addEditAction("edit",a,b,function(a){g(a);o.val(PageNodes.ArrayUtil.getSameValue(a.y))})});b.updateItems.push({input:h,getFunc:function(){return PageNodes.ArrayUtil.getSameValue(e().x)}});b.updateItems.push({input:o,getFunc:function(){return PageNodes.ArrayUtil.getSameValue(e().y)}})}function f(c){var d=PageNodes.FormViewManager.createSizeView();d.appendTo(i);var c=j(c.name),e=a.delegate[c.getStr],g=a.delegate[c.setStr],
f=e().width.length,d=d.find("input"),h=d.eq(0),o=d.eq(1);h.val(PageNodes.ArrayUtil.getSameValue(e().width));o.val(PageNodes.ArrayUtil.getSameValue(e().height));h.change(function(){var a=e(),b=e();b.width=PageNodes.ArrayUtil.repeatValue(Number(h.val()),f);PageNodes.HistoryManager.addEditAction("edit",a,b,function(a){g(a);h.val(PageNodes.ArrayUtil.getSameValue(a.width))})});o.change(function(){var a=e(),b=e();b.height=PageNodes.ArrayUtil.repeatValue(Number(o.val()),f);PageNodes.HistoryManager.addEditAction("edit",
a,b,function(a){g(a);o.val(PageNodes.ArrayUtil.getSameValue(a.height))})});b.updateItems.push({input:h,getFunc:function(){return PageNodes.ArrayUtil.getSameValue(e().width)}});b.updateItems.push({input:o,getFunc:function(){return PageNodes.ArrayUtil.getSameValue(e().height)}})}function g(b){var c=PageNodes.FormViewManager.createColorPickerView(b.label);c.appendTo(i);var b=j(b.name),d=a.delegate[b.getStr],e=a.delegate[b.setStr],g=d().length,b=PageNodes.ArrayUtil.getSameValue(d()),f=new PageNodes.ColorPicker(b,
c.find(".colorPicker"));f.onSubmit=function(a){var b=d(),a=PageNodes.ArrayUtil.repeatValue(a,g);b!=a&&PageNodes.HistoryManager.addEditAction("edit",b,a,function(a){f.setColor(PageNodes.ArrayUtil.getSameValue(a));e(a)})}}function h(b){var c=PageNodes.FormViewManager.createSliderView(b.label);c.appendTo(i);var d=j(b.name),e=a.delegate[d.getStr],g=a.delegate[d.setStr],f=e().length,d=PageNodes.ArrayUtil.getSameValue(e()),h=new PageNodes.Slider(c,b.min,b.max,d);h.onChange=function(a){var b=e(),a=PageNodes.ArrayUtil.repeatValue(a,
f);PageNodes.HistoryManager.addEditAction("edit",b,a,function(a){h.setValue(PageNodes.ArrayUtil.getSameValue(a));g(a)})}}function j(a){var b=a.length,a=a.charAt(0).toUpperCase()+a.substr(1,b-1);return{getStr:"get"+a,setStr:"set"+a}}c.header.text(this.title);var i=c.form;this.container=i;this.updateItems=[];$.each(a.items,function(){switch(this.type){case "input":d(this);break;case "position":e(this);break;case "size":f(this);break;case "hline":PageNodes.FormViewManager.createHline().appendTo(i);break;
case "color":g(this);break;case "slider":h(this);break;case "html":$(this.html).appendTo(i)}})};this.update=function(){this.container!=void 0&&$.each(this.updateItems,function(){this.input.val(this.getFunc())})}};PageNodes.SelectToolDescriptor=function(a){this.title="\u9009\u62e9\u5de5\u5177";var b=new PageNodes.DescriptorDataModel(this);b.add({label:"\u9009\u62e9\u6a21\u5f0f",type:"tabs",items:[{label:"\u5168\u5c40",value:"globalMode"},{label:"\u9875\u9762",value:"pageMode"}],name:"selectMode"});PageNodes.BasicDescriptor.call(this,b);this.getSelectMode=function(){return a.selectMode};this.setSelectMode=function(b){a.selectMode=b}};PageNodes.DragToolDescriptor=function(){this.title="\u62d6\u52a8\u5de5\u5177";this.init=function(a){a.header.text(this.title);$("<div>\u5f53\u9009\u62e9\u5176\u5b83\u5de5\u5177\u65f6\uff0c\u6309\u4f4f<b>[Space]</b>\u952e\u53ef\u5207\u6362\u5230\u6b64\u5de5\u5177,\u677e\u5f00<b>[Space]</b>\u952e\u8fd4\u56de\u539f\u6765\u5de5\u5177.</div>").appendTo(a.form)}};PageNodes.PageToolDescriptor=function(){this.title="\u9875\u9762\u5de5\u5177";var a=new PageNodes.DescriptorDataModel(this);a.add({type:"html",html:"<div>\u70b9\u51fb\u521b\u5efa\u9875\u9762.</div>"});a.add({type:"hline"});var b=PageNodes.Settings.pageSize;a.add({type:"html",html:"<div>\u5f53\u524d\u9875\u9762\u5927\u5c0f : <b>"+b.width+"*"+b.height+"</b><div>"});PageNodes.BasicDescriptor.call(this,a)};PageNodes.ButtonToolDescriptor=function(){this.title="\u6309\u94ae\u5de5\u5177";this.init=function(a){a.header.text(this.title);$("<div>\u5728\u9875\u9762\u4e0a\u62d6\u52a8\u51fa\u77e9\u5f62\u6846\u521b\u5efa\u6309\u94ae.</div>").appendTo(a.form)}};PageNodes.ZoomToolDescriptor=function(){this.title="\u7f29\u653e\u5de5\u5177";this.init=function(a){a.header.text(this.title);$("<div>\u4efb\u610f\u5de5\u5177\u65f6,\u6309\u4f4f<b>[Ctrl]</b>\u952e\u7528\u6eda\u8f6e\u53ef\u7f29\u653e.\u9009\u4e2d\u6b64\u5de5\u5177\u65f6,\u6309\u4f4f<b>[Ctrl]</b>\u952e\u8fdb\u5165<b>\u7f29\u5c0f\u6a21\u5f0f</b>,\u677e\u5f00<b>[Ctrl]</b>\u952e\u8fd4\u56de<b>\u653e\u5927\u6a21\u5f0f</b>.</div>").appendTo(a.form)}};PageNodes.PageDescriptor=function(a){this.title="\u9875\u9762";var b=new PageNodes.DescriptorDataModel(this);b.add({type:"position",name:"position"});b.add({type:"hline"});b.add({label:"\u6807\u9898",name:"title",type:"input"});PageNodes.BasicDescriptor.call(this,b);this.getTitle=function(){return a.getTitle()};this.setTitle=function(b){a.setTitle(b)};this.getPosition=function(){return{x:a.content.x,y:a.content.y}};this.setPosition=function(b){a.content.x=b.x;a.content.y=b.y;PageNodes.editorContainer.update(a)}};PageNodes.ButtonDescriptor=function(a){this.title="\u6309\u94ae";var b=new PageNodes.DescriptorDataModel(this);b.add({type:"position",name:"position"});b.add({type:"size",name:"size"});b.add({type:"hline"});b.add({label:"\u6587\u672c",name:"label",type:"input"});PageNodes.BasicDescriptor.call(this,b);this.getLabel=function(){return a.getLabel()};this.setLabel=function(b){a.setLabel(b)};this.getPosition=function(){return{x:a.content.x,y:a.content.y}};this.setPosition=function(b){a.content.x=b.x;a.content.y=
...
this.getLineWidth=function(){return a.lineWidth};this.setLineWidth=function(b){a.lineWidth=b;a.lineStyle.width=a.lineWidth;a.update()}};PageNodes.MultipleSelectDescriptor=function(a){function b(b){var c=[];$.each(a,function(){c.push(b(this))});return c}var c=!0,d=!0,e=!0;$.each(a,function(){this instanceof PageNodes.Page?e=d=!1:this instanceof PageNodes.NodeLink?e=c=!1:this instanceof PageNodes.Button&&(d=c=!1)});var f=new PageNodes.DescriptorDataModel(this);c?(this.title="\u9009\u62e9\u591a\u4e2a\u9875\u9762",f.add({type:"position",name:"position"}),f.add({type:"hline"}),f.add({label:"\u6807\u9898",name:"title",type:"input"})):d?
(this.title="\u9009\u62e9\u591a\u4e2a\u94fe\u63a5",f.add({type:"color",name:"normalColor",label:"\u8fde\u7ebf\u989c\u8272"}),f.add({type:"slider",name:"lineWidth",min:1,max:10,label:"\u8fde\u7ebf\u5bbd\u5ea6"})):e?(this.title="\u9009\u62e9\u591a\u4e2a\u6309\u94ae",f.add({type:"position",name:"buttonPosition"}),f.add({type:"size",name:"size"}),f.add({type:"hline"}),f.add({label:"\u6587\u672c",name:"label",type:"input"})):(this.title="\u9009\u62e9\u591a\u4e2a\u5143\u7d20",f.add({type:"html",html:"<div>\u9009\u4e2d\u4e86<b>"+
a.length+"</b>\u4e2a\u4e0d\u540c\u7684\u5143\u7d20</div>"}));PageNodes.GroupDescriptor.call(this,f);this.getTitle=function(){return b(function(a){return a.getTitle()})};this.setTitle=function(b){$.each(a,function(a){this.setTitle(b[a])})};this.getPosition=function(){var a=b(function(a){return a.content.x}),c=b(function(a){return a.content.y});return{x:a,y:c}};this.setPosition=function(b){$.each(a,function(a){this.content.x=b.x[a];this.content.y=b.y[a];PageNodes.editorContainer.update(this)})};this.getNormalColor=
function(){return b(function(a){for(a=a.normalColor.toString(16);a.length<6;)a="0"+a;return"#"+a})};this.setNormalColor=function(b){$.each(a,function(a){a=b[a];a=a.substr(1,a.length);this.normalColor=eval("0x"+a);this.update()})};this.getLineWidth=function(){return b(function(a){return a.lineWidth})};this.setLineWidth=function(b){$.each(a,function(a){this.lineWidth=b[a];this.lineStyle.width=this.lineWidth;this.update()})};this.getLabel=function(){return b(function(a){return a.getLabel()})};this.setLabel=
function(b){$.each(a,function(a){this.setLabel(b[a])})};this.getButtonPosition=function(){var a=b(function(a){return a.content.x}),c=b(function(a){return a.content.y});return{x:a,y:c}};this.setButtonPosition=function(b){$.each(a,function(a){this.content.x=b.x[a];this.content.y=b.y[a];PageNodes.editorContainer.update(this)})};this.getSize=function(){var a=b(function(a){return a.content.width}),c=b(function(a){return a.content.height});return{width:a,height:c}};this.setSize=function(b){$.each(a,function(a){this.content.width=
b.width[a];this.content.height=b.height[a];PageNodes.editorContainer.update(this.page)})}};PageNodes.GlobalSelectMode=function(a){this.init=function(){var b=PageNodes.editorContainer,c=b.container,d=b.selectLayer,e=b.layerContainer;c.mousedown(function(f){function g(a){k=!0;a={x:a.clientX-l.x,y:a.clientY-l.y};j.clear();j.lineStyle(1,255,1);var b=l.x-c.offset().left,d=l.y-c.offset().top,b=b-c.outerWidth()*0.5-e.x,d=d-c.outerHeight()*0.5-e.y;j.drawRect(b,d,a.x,a.y)}function h(){var a={pages:b.getSelectedPages().concat(),links:b.getSelectedLinks().concat()};if(k){var f=j.getBounds(),l=[],
...
a.y);m.endFill()}function h(){$(window).off("mousemove",e);$(window).off("mouseup",h);if(q){var a=m.getBounds();if(!(a.width==0||a.height==0)){var c=a.x-k.outerWidth()*0.5-l.x,f=a.y-k.outerHeight()*0.5-l.y;c-=b.border.x;f-=b.border.y;var j=p.scale.x,u=b.size.width*j;j*=b.size.height;c+=u*0.5;f+=j*0.5;j=a.width;a=a.height;u/=b.originSize.width;c/=u;f/=u;j/=u;a/=u;c=new PageNodes.Button({label:"button",x:c,y:f,width:j,height:a});PageNodes.GeneralManager.addButtonToPage(c,b);m.clear();i.removeChild(m)}}}
if(a.selected){$(window).on("mousemove",e);$(window).on("mouseup",h);var j=PageNodes.editorContainer,i=j.selectLayer,k=j.container,l=j.layerContainer,p=j.contentLayer,m=new PIXI.Graphics;i.addChild(m);var q=!1,n={x:c.data.originalEvent.clientX,y:c.data.originalEvent.clientY}}else c.data.originalEvent.preventDefault()})}b instanceof PageNodes.Page&&c(b)}};PageNodes.ToolManager=function(){var a={},b=-1,c=[new PageNodes.SelectTool,new PageNodes.DragTool,new PageNodes.PageTool,new PageNodes.ButtonTool,new PageNodes.ZoomTool];a.init=function(){$.each(c,function(){this.init()});this.selectToolIdx(0)};a.getSelectedIdx=function(){return b};a.getTools=function(){return c};a.selectToolIdx=function(a){var e;b>-1&&(e=c[b],e.setSelected(!1));e=c[a];e.setSelected(!0);b=a;PageNodes.propertiesPanel.update()};a.initObj=function(a){$.each(c,function(){this.initObj(a)})};
a.clearObj=function(a){function b(a){a.content.interactive=!1;a.content.off("mousedown")}function c(a){a.content.interactive=!1;a.content.off("mouseover");a.content.off("mouseout");a.content.off("mousedown")}a instanceof PageNodes.Page&&b(a);a instanceof PageNodes.Button&&c(a)};return a}();PageNodes.EditorContainer=function(a){function b(){d.render();requestAnimationFrame(b)}function c(){var b=a.outerWidth(),c=a.outerHeight();s.resize(b,c);l.x=b*0.5;l.y=c*0.5}var d=this,e=[0.06,0.12,0.25,0.5,0.66,1,2,3,4,8,16,32,64],f=5,g=[],h=[],j=[],i=[],k=[],l,p,m,q,n,o,r,t=new PIXI.Container,s=new PIXI.autoDetectRenderer;s.backgroundColor=16777215;$(s.view).appendTo(a);this.getSelectedPages=function(){return h};this.getPages=function(){return g};this.zoomToLevel=function(a,b){a!=f&&(this.zoom({to:e[a],
