...
b.modal("show")}};PageNodes.Alert=function(){var a={},b=$("<div class='ui small modal'>");$("<div class='header'><i class='warning circle icon'></i><label>\u63d0\u793a</label></div>").appendTo(b);var c=$("<div class='content'>");c.appendTo(b);$("<div class='actions'>").appendTo(b);a.show=function(a){c.text(a);b.modal("show")};return a}();PageNodes.OnlineFileWin=function(a){function b(a){var b;b='<div class="ui image" style="border: solid 1px #E3E3E3;float: left;margin-left: 10px;margin-top: 10px;width:240px;height:180px;padding:1px;">';b+='<div class="ui dimmer">';b+='<div class="content">';b+='<div class="center">';b+='<h2 class="ui inverted header">'+a+"</h2>";b+='<div class="ui button">\u6253\u5f00\u6587\u4ef6</div>';b+="</div>";b+="</div>";b+="</div>";b+='<div style="width:100%;height:100%;background-image:url('+("examples/"+
