...
a.loading!=void 0&&ZML.Preloader.loading.setColor(a.loading);ZML.Preloader.loading.view.appendTo(this.view);this.scaleStyle=a.scaleStyle==void 0?"transform":a.scaleStyle;$(window).resize(b);b(null)};ZML.ImageAsset=function(){function a(){this.image=this.url=this.data=null;a.list.push(this)}a.list=[];a.prototype.construct=function(b){var a=this;this.data=b;this.url=ZML.CoreURL.app+this.data.attr("url");ZML.AssetsManager.appendToLoad(this.url,function(b){a.image=b})};a.getImageById=function(b){for(var c=null,d=a.list.length,e=0;e<d;e++){var f=a.list[e];if(f.data.attr("id")==b){c=f;break}}return c};return a}();ZML.BasicCanvas=function(){function a(b){if(b==void 0)this.view=$("<div />"),this.view.css("position","absolute"),this.data=null;else return a.select(b)}a.CONSTRUCT_COMPLETE="basicCanvasCreationComplete";ZML.find=a;a.list=[];a.select=function(b){b.indexOf("#")==0?(b=b.slice(1,b.length),b=a.selectCanvasById(b)):b=a.selectCanvasByTag(b);return b};a.selectCanvasById=function(b){for(var c,d=a.list.length;d--;){var e=a.list[d];if(e.data.attr("id")==b){c=e;break}}return c};a.selectCanvasByTag=function(b){function c(b,
a){for(var d=[],f=e[b].split(":"),k=a.length;k--;){var l=a[k],m=l.data.attr(f[0]);m!=void 0&&m==f[1]&&d.push(l)}d.length>0&&b+1<e.length&&(d=c(b+1,d));return d}for(var d=[],e=b.split(","),b=a.list.length;b--;){var f=a.list[b];f.data.prop("nodeName").toUpperCase()==e[0].toUpperCase()&&d.push(f)}e.length>1&&(d=c(1,d));return d};a.prototype.construct=function(b){a.list.push(this);this.data=b;this.mappingCss(this.data);this.initEvents();this.createChildren()};a.prototype.initEvents=function(){var b=this;
ZML.BroadcastCenter.addEventListener(ZML.CanvasEvent.prototype.type,function(a,d){if(!($(d).attr("id")==void 0||$(d).attr("id")!=b.data.attr("id"))){var e=$(d).attr("action");e!=void 0&&e=="set"&&b.mappingCss($(d))}})};a.prototype.mappingCss=function(b){for(var b=b.prop("attributes"),a=b.length,d=0;d<a;d++){var e=b[d].nodeName,f=b[d].value;this.handleSpecialNode(e,f)||this.view.css(e,f)}};a.prototype.handleSpecialNode=function(b,a){var d=!1;switch(b.toLowerCase()){case "id":this.view.attr(b,a);d=
!0;break;case "class":this.view.toggleClass(a);d=!0;break;case "x":this.view.css("left",a+"px");d=!0;break;case "y":this.view.css("top",a+"px");d=!0;break;case "width":this.view.width(a);break;case "height":this.view.height(a);break;case "action":d=!0;break;case "scalex":this.scaleX(a);d=!0;break;case "scaley":this.scaleY(a);d=!0;break;case "rotate":this.rotate(a);d=!0;break;case "alpha":this.alpha(a);d=!0;break;case "visible":this.visible(a),d=!0}return d};a.prototype.createChildren=function(){function b(b){if(b==
e)d.constructComplete();else{var h=d.data.children()[b],g=h.nodeName.toUpperCase(),g=ZML.FactoryMap[g];if(g==void 0)c(b);else{var i=new g;i.view!=void 0&&i.view.bind(a.CONSTRUCT_COMPLETE,function(){i.view.appendTo(d.view);c(b)});i.construct($(h));i.view==void 0&&c(b)}}}function c(a){a++;b(a)}var d=this,e=this.data.children().length;e>0?b(0):d.constructComplete()};a.prototype.constructComplete=function(){ZML.BroadcastCenter.sendEvent(this.data.children("Ready").prop("outerHTML"));this.view.trigger(a.CONSTRUCT_COMPLETE)};
a.prototype.buttonMode=function(b){this.view.css("cursor",b?"pointer":"auto")};a.prototype.visible=function(b){this.view[b=="true"?"show":"hide"]()};a.prototype.scaleX=function(){};a.prototype.scaleY=function(){};a.prototype.rotate=function(){};a.prototype.alpha=function(){};return a}();ZML.BasicMovieClip=function(){function a(){this.view=this.view.clone();this.currentFrame=0;this.interval=null;this.frameRate=60}a.prototype=new ZML.BasicCanvas;a.prototype.constructComplete=function(){this.init();ZML.BasicCanvas.prototype.constructComplete.call(this)};a.prototype.init=function(){var b=this;if(this.data.attr("frameRate")!=void 0)this.frameRate=Number(this.data.attr("frameRate"));this.children=this.view.children().toArray();for(var a=this.children.length,d=0;d<a;d++)$(this.children[d]).detach();
...
function(a){b.addImage($(a))}):this.addImage($("<img>",{src:a}))}ZML.BasicCanvas.prototype.constructComplete.call(this)};a.prototype.addImage=function(a){this.__image.view=a;a.css("position","absolute");var c=this.data.attr("img");if(c!=void 0)for(var c=c.split(","),d=c.length,e=0;e<d;e++){var f=c[e].split(":");ZML.BasicCanvas.prototype.handleSpecialNode.call(this.__image,f[0],f[1])||a.css(f[0],f[1])}a.prependTo(this.view)};return a}();ZML.Button=function(){function a(){this.view=this.view.clone();this.effectInstance=null}a.prototype=new ZML.BasicCanvas;a.prototype.constructComplete=function(){this.init();ZML.BasicCanvas.prototype.constructComplete.call(this)};a.prototype.init=function(){this.buttonMode(!0);var a=this.data.attr("effect");a!=void 0&&this.effect(a);this.bindEvents();this.data.attr("enabled")!=void 0&&this.enabled(this.data.attr("enabled")=="true"?!0:!1)};a.prototype.initEvents=function(){ZML.BasicCanvas.prototype.initEvents.call(this);
this.initSelfEvents()};a.prototype.initSelfEvents=function(){var a=this;ZML.BroadcastCenter.addEventListener(ZML.CanvasEvent.prototype.type,function(c,d){if(!($(d).attr("id")==void 0||$(d).attr("id")!=a.data.attr("id"))){var e=$(d).attr("action");e!=void 0&&e=="set"&&$(d).attr("enabled")!=void 0&&a.enabled($(d).attr("enabled")=="true"?!0:!1)}})};a.prototype.bindEvents=function(){var a=this;this.view.bind("click",function(){a.clickHandler()})};a.prototype.unbindEvents=function(){this.view.unbind("click")};
a.prototype.effect=function(a){if(a!=null){if(a=ZML.ButtonEffectMap[a],a!=void 0&&this.effectInstance==null)this.effectInstance=new a(this)}else if(this.effectInstance!=null)this.effectInstance.dispose(),this.effectInstance=null};a.prototype.clickHandler=function(){var a=this.data.children("Click").prop("outerHTML");ZML.BroadcastCenter.sendEvent(a)};a.prototype.enabled=function(a){this.buttonMode(a);this.alpha(a?1:0.5);a?(this.bindEvents(),this.data.attr("effect")!=void 0&&this.effect(this.data.attr("effect"))):
(this.unbindEvents(),this.effect(null))};return a}();ZML.ImageButton=function(){function a(){this.view=this.view.clone()}a.prototype=new ZML.ImageCanvas;a.prototype.constructComplete=function(){a.prototype.clickHandler=ZML.Button.prototype.clickHandler;a.prototype.bindEvents=ZML.Button.prototype.bindEvents;a.prototype.effect=ZML.Button.prototype.effect;a.prototype.enabled=ZML.Button.prototype.enabled;a.prototype.unbindEvents=ZML.Button.prototype.unbindEvents;ZML.Button.prototype.init.call(this);ZML.Button.prototype.initSelfEvents.call(this);ZML.ImageCanvas.prototype.constructComplete.call(this)};
return a}();ZML.Label=function(){function a(){this.view=this.view.clone()}a.prototype=new ZML.BasicCanvas;a.prototype.construct=function(a){ZML.BasicCanvas.list.push(this);this.data=a;ZML.BasicCanvas.prototype.mappingCss.call(this,a);this.initEvents();this.text(this.data.attr("text"));ZML.BasicCanvas.prototype.constructComplete.call(this)};a.prototype.initEvents=function(){ZML.BasicCanvas.prototype.initEvents.call(this);var a=this;ZML.BroadcastCenter.addEventListener(ZML.CanvasEvent.prototype.type,function(c,
...
(e="none");e=ZML.TransitionMap[e];if(e==void 0)e=ZML.TransitionMap.none;if(this.transtionInstance!=null)this.transtionInstance.dispose(),this.transtionInstance=null;this.transtionInstance=new e(this,this.children[d],this.children[a],function(){ZML.BroadcastCenter.sendEvent($(c.eventData).children("onComplete").prop("outerHTML"))});this.controller.defaultIdx=a}};return a}();ZML.BasicNavigationManager=function(){function a(a){this.ct=null;this.init(a)}a.prototype=new ZML.NavigationManagerBase;a.prototype.init=function(a){ZML.NavigationManagerBase.prototype.init.call(this,a);a=this.children.length;this.ct=$("<div>");this.ct.appendTo(this.controller.view);this.ct.css("position","absolute");for(var c=0;c<a;c++){var d=$(this.children[c]),e=this.controller.data.attr("width")*c;d.css("left",e+"px");d.appendTo(this.ct)}};a.prototype.pre=function(){var a=this.controller.defaultIdx;
a--;a>-1&&this.showIdx(a)};a.prototype.next=function(){var a=this.controller.defaultIdx;a++;a<this.children.length&&this.showIdx(a)};a.prototype.showIdx=function(a){var c=-this.controller.data.attr("width")*a;try{TweenLite.to(this.ct,0.5,{x:c,ease:Expo.easeInOut})}catch(d){this.ct.animate({left:c},500)}this.controller.defaultIdx=a};return a}();ZML.NavigationManagerMap={DefaultNavigationManager:ZML.DefaultNavigationManager,BasicNavigationManager:ZML.BasicNavigationManager};ZML.NavigationController=function(){function a(){this.view=this.view.clone();this.view.css("overflow","hidden");this.defaultIdx=0;this.manager="DefaultNavigationManager";this.managerInstance=null}a.prototype=new ZML.BasicCanvas;a.prototype.constructComplete=function(){this.init();ZML.BasicCanvas.prototype.constructComplete.call(this)};a.prototype.init=function(){if(this.data.attr("defaultIdx")!=void 0)this.defaultIdx=Number(this.data.attr("defaultIdx"));if(this.data.attr("manager")!=void 0)this.manager=
